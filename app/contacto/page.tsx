...
export default function ContactoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        isEs
          ? '¡Mensaje enviado con éxito! Gracias por tu retroalimentación.'
          : 'Message sent successfully! Thanks for your feedback.',
      );
    } catch (err: unknown) {
      const msg =
        err instanceof Error ? err.message : isEs ? 'Error de conexión' : 'Connection error';
      toast.error(msg);
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight mb-4 leading-tight font-sans">
            {isEs
              ? '¿Tienes dudas, sugerencias o reportes de errores?'
            ...
            <form onSubmit={handleSubmit} className="space-y-6 font-mono text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={
                    isEs
                      ? 'Escribe aquí tus comentarios, errores detectados o funciones que desees ver...'
                      : 'Write your feedback, bugs found or feature requests...'
                  }
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-black hover:bg-zinc-200 px-6 py-2.5 rounded-full font-sans font-semibold text-xs transition-all shadow-md cursor-pointer disabled:opacity-50"
                >
