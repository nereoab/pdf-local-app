...
import JpgPdfConverter from '../../../components/JpgPdfConverter';
import { useLanguage } from '../../../context/LanguageContext';
import { Image as ImageIcon, ShieldCheck, RefreshCw, Lock } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
          ...
          <div>
            <div className="flex items-center gap-2 font-mono">
              ...
              <span className="text-white text-xs font-bold">{isEs ? 'JPG a PDF / PDF a JPG (2 en 1)' : 'JPG to PDF / PDF to JPG (2 in 1)'}</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">
              {isEs ? 'CONVERTIR IMAGEN Y PDF (CONVERSOR DUAL 2 EN 1)' : 'CONVERT IMAGE & PDF (2-IN-1 DUAL CONVERTER)'}
            </h1>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-white tracking-tight">
                  {isEs ? '¿Qué sucede durante la conversión entre imágenes JPG/PNG y documentos PDF?' : 'What happens during conversion between JPG/PNG images and PDF documents?'}
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs sm:text-sm text-zinc-400 leading-relaxed mt-4">
              <div className="bg-zinc-900/60 p-5 rounded-xl border border-white/5 space-y-2">
                <strong className="text-white font-bold text-sm block flex items-center gap-2">
                  ...
                  {isEs ? '1. Conversión de JPG/PNG a PDF' : '1. JPG/PNG to PDF Conversion'}
                </strong>
                <p>
                  {isEs 
              ...
              <div className="bg-zinc-900/60 p-5 rounded-xl border border-white/5 space-y-2">
                <strong className="text-white font-bold text-sm block flex items-center gap-2">
                  ...
                  {isEs ? '2. Conversión de PDF a JPG' : '2. PDF to JPG Conversion'}
                </strong>
                <p>
                  {isEs 
