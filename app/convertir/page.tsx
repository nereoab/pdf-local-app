...
function ConvertirContent() {
  ...
  const conversionTools = [
    { 
      id: 'pdf-word', 
      tagEs: '001 / PDF ↔ WORD', tagEn: '001 / PDF ↔ WORD', 
    ...
    { 
      id: 'pdf-excel', 
      tagEs: '002 / PDF ↔ EXCEL', tagEn: '002 / PDF ↔ EXCEL', 
    ...
    { 
      id: 'pdf-powerpoint', 
      tagEs: '003 / PDF ↔ POWERPOINT', tagEn: '003 / PDF ↔ POWERPOINT', 
    ...
    { 
      id: 'pdf-jpg', 
      tagEs: '004 / PDF ↔ JPG', tagEn: '004 / PDF ↔ JPG', 
    ...
    { 
      id: 'pdf-html', 
      tagEs: '005 / PDF ↔ HTML', tagEn: '005 / PDF ↔ HTML', 
    ...
    { 
      id: 'pdf-texto', 
      tagEs: '006 / PDF ↔ TEXTO', tagEn: '006 / PDF ↔ TEXT', 
              ...
              <div className="w-full mt-12 pt-10 border-t border-white/10 flex flex-col items-center font-mono">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                  ...
                  <div className="flex flex-col items-start p-6 bg-[#09090b] border border-white/10 rounded-2xl hover:border-white/30 transition-all group font-mono">
                    ...
                    <p className="text-xs text-zinc-400 font-sans leading-relaxed">
                      {isEs ? "En la página especializada, elige la función exacta (PDF a Word, Excel, JPG, etc.)." : "In the specialized page, select the exact function (PDF to Word, Excel, JPG, etc.)."}
                    </p>
                  </div>
