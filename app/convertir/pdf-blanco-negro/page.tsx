...
const PdfBlackWhiteConverter = dynamic(() => import('@/components/PdfBlackWhiteConverter'), {
  ...
  loading: () => (
    <div className="flex flex-col items-center justify-center min-h-[500px] gap-4 font-mono">
      ...
      <p className="text-zinc-400 font-mono text-xs">Cargando conversor PDF a Blanco y Negro...</p>
    </div>
  ),
});

export default function PdfBlancoNegroPage() {
  const seoData = CONVERTER_SEO_DATA['pdf-blanco-negro'];
