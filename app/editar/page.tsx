              ...
              <div className="w-full mt-12 pt-10 border-t border-white/10 flex flex-col items-center font-mono">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                  ...
                  <SpotlightCard className="flex flex-col items-start p-6 bg-[#09090b] border border-white/10 rounded-2xl hover:border-white/30 transition-all group font-mono">
                    ...
                    <p className="text-xs text-zinc-400 font-sans leading-relaxed">
                      {isEs
                        ? 'En la página especializada, elige la función exacta (Texto, Foliar, Firma, etc.).'
                        : 'In the specialized page, select the exact function (Text, Folio, Signature, etc.).'}
                    </p>
                  </SpotlightCard>
                    ...
                    <table className="w-full text-left text-xs font-mono whitespace-nowrap">
                      <thead>
                        <tr className="border-b border-white/10">
                          <th className="pb-3 font-semibold text-zinc-400 uppercase tracking-wider pl-2">
                            {isEs ? 'NOMBRE DEL ARCHIVO' : 'FILE NAME'}
                          </th>
                          <th className="pb-3 font-semibold text-zinc-400 uppercase tracking-wider">
                            {isEs ? 'TAMAÑO' : 'SIZE'}
                          </th>
                          <th className="pb-3 font-semibold text-zinc-400 uppercase tracking-wider">
                          ...
                          <th className="pb-3 font-semibold text-zinc-400 uppercase tracking-wider text-right pr-2">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
        <AnimatePresence>
          {isAiOpen && (
            <motion.div
              ...
              className="mb-4 w-80 sm:w-96 bg-[#09090b] border border-white/10 rounded-2xl shadow-2xl overflow-hidden font-mono"
            >
              ...
              <div className="p-3 border-t border-white/10 bg-zinc-900">
                <input
                  ...
                  className="w-full bg-[#09090b] border border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-white placeholder-zinc-500 focus:outline-none focus:border-white/30"
                />
              </div>
            </motion.div>
          )}
        ...
        <div className="relative group">
          ...
          <motion.button
            ...
            className="bg-white text-black hover:bg-zinc-200 p-3.5 rounded-full shadow-2xl transition-all cursor-pointer border border-white/20"
          >
