    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 pb-12 pt-8 flex flex-col items-center justify-start relative min-h-[calc(100vh-80px)] bg-[#09090b]">
      <div className="w-full max-w-7xl relative z-10">
        ...
        >
          ...
          {/* SECCIÓN: 3 PASOS PARA OPTIMIZAR PDF */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
              ...
              <SpotlightCard className="flex flex-col items-start p-6 sm:p-7 bg-gradient-to-b from-[#18181f] via-[#111116] to-[#0a0a0d] border border-zinc-600 hover:border-zinc-300 rounded-3xl transition-all shadow-xl font-mono">
                ...
                <h4 className="text-sm font-bold text-white mb-2 font-sans">
                  {isEs ? '1. Selecciona la función' : '1. Select the function'}
                </h4>
                <p className="text-xs text-zinc-300 font-sans leading-relaxed font-normal">
                  {isEs
                    ? 'Elige la optimización que necesitas: Comprimir, Reparar, Desproteger, Cifrar, Censurar o Comparar.'
                    : 'Choose the optimization you need: Compress, Repair, Unlock, Protect, Redact, or Compare.'}
                </p>
              </SpotlightCard>
              ...
              <SpotlightCard className="flex flex-col items-start p-6 sm:p-7 bg-gradient-to-b from-[#18181f] via-[#111116] to-[#0a0a0d] border border-zinc-600 hover:border-zinc-300 rounded-3xl transition-all shadow-xl font-mono">
                ...
                <h4 className="text-sm font-bold text-white mb-2 font-sans">
                  {isEs ? '2. Procesa en memoria' : '2. In-memory processing'}
                </h4>
                <p className="text-xs text-zinc-300 font-sans leading-relaxed font-normal">
                  {isEs
                    ? 'Aplica compresión, cifrado o remoción de datos sensibles con algoritmos de alta velocidad en RAM.'
                    : 'Apply compression, encryption, or redaction using high-speed in-browser RAM algorithms.'}
                </p>
              </SpotlightCard>
              ...
              <SpotlightCard className="flex flex-col items-start p-6 sm:p-7 bg-gradient-to-b from-[#18181f] via-[#111116] to-[#0a0a0d] border border-zinc-600 hover:border-zinc-300 rounded-3xl transition-all shadow-xl font-mono">
                ...
                <h4 className="text-sm font-bold text-white mb-2 font-sans">
                  {isEs ? '3. Descarga optimizada' : '3. Optimized download'}
                </h4>
                <p className="text-xs text-zinc-300 font-sans leading-relaxed font-normal">
                  {isEs
                    ? 'Obtén tu archivo protegido o reducido al instante sin dejar rastro en ningún servidor.'
                    : 'Get your protected or compressed file instantly leaving zero trace on any server.'}
                </p>
              </SpotlightCard>
            </div>
          </div>
