        ...
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <Link href="/optimizar" className="text-xs font-bold text-slate-400 hover:text-emerald-400 transition-colors">
                {isEs ? 'Optimizar PDF' : 'Optimize PDF'}
              </Link>
              <span className="text-slate-600 text-xs">/</span>
              <span className="text-emerald-400 text-xs font-bold">{isEs ? 'Proteger PDF' : 'Protect PDF'}</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
              {isEs ? 'PROTEGER ARCHIVO PDF' : 'PROTECT PDF FILE'}
            </h1>
          </div>
        </div>
