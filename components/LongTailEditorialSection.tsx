...
import { LongTailSolution, LONG_TAIL_SOLUTIONS } from '@/lib/long-tail-registry';

interface Props {
  solution: LongTailSolution;
}

export default function LongTailEditorialSection({ solution }: Props) {
  ...
  return (
    <section className="mt-16 w-full max-w-5xl mx-auto px-4 pb-20 text-neutral-800 dark:text-neutral-200">
      ...
      {/* ─── TABLA DE ESPECIFICACIONES TÉCNICAS / REQUISITOS ─── */}
      ...
      {/* ─── BOX DE SEGURIDAD Y PRIVACIDAD TÉCNICA (WASM) ─── */}
          ...
          <div>
            ...
            <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed mb-4">
              ...
              <strong className="font-semibold text-neutral-900 dark:text-white">
                PDFBlack procesa los documentos directamente en la memoria de tu navegador mediante
                WebAssembly y Web Workers
              </strong>
              . Tus archivos nunca salen de tu ordenador o teléfono móvil, cumpliendo de forma
              estricta las normativas de secreto profesional, secreto bancario y protección de datos
              (GDPR).
            </p>
      ...
      {/* ─── TOPIC CLUSTER: ENLACES RELACIONADOS Y RETORNO A HERRAMIENTA MADRE ─── */}
      <div className="border-t border-neutral-200 dark:border-neutral-800 pt-8 mt-12">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          >
            <span>Ir a {solution.parentName}</span>
