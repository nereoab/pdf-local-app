...
export default function PdfCompressor() {
  ...
  // Control de cabecera fija y posicionamiento superior absoluto
  useEffect(() => {
    if (completedResult) {
      ...
      {files.length === 0 ? (
        ...
        <div ref={successContainerRef} className="w-full">
          <FoliarSuccessView
            ...
            modeText={
              isEs
                ? 'Motor de Compresión y Reducción de Tamaño'
                : 'PDF Compression & Size Reduction Engine'
            }
            toolName={isEs ? 'Comprimir PDF' : 'Compress PDF'}
            badgeText={isEs ? 'Compresión Completada' : 'Compression Completed'}
            successTitle={
