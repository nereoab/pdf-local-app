        ...
        {completedResult ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              title={isEs ? 'Recortar otro PDF' : 'Crop another PDF'}
            >
      ...
      {completedResult ? (
        <div ref={successContainerRef} className="w-full">
          <FoliarSuccessView
            ...
            modeText={isEs ? 'Recorte Box Vectorial Nativo' : 'Native Vector Box Crop'}
            toolName={isEs ? 'Recortar PDF' : 'Crop PDF'}
            badgeText={isEs ? 'Recorte Completado' : 'Crop Completed'}
            successTitle={
          ...
          <div className="w-full bg-gradient-to-b from-[#18181f] via-[#111116] to-[#0a0a0d] border border-zinc-700/80 hover:border-zinc-500 rounded-3xl p-6 shadow-2xl flex flex-col h-[580px] lg:h-[660px] overflow-hidden relative">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3 pb-3 border-b border-zinc-800 font-mono text-xs text-zinc-400 font-bold shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* PAGINADOR */}
                <div className="flex items-center gap-1 bg-zinc-900 border border-zinc-700 px-3 py-1 rounded-xl text-xs font-mono shadow-sm">
                  <button
                    type="button"
