        ...
        {completedResult ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              title={isEs ? 'Rotar otro PDF' : 'Rotate another PDF'}
            >
      ...
      {completedResult ? (
        <div ref={successContainerRef} className="w-full">
          <FoliarSuccessView
            ...
            modeText={isEs ? 'Rotación Vectorial Sin Pérdida' : 'Lossless Vector Rotation'}
            toolName={isEs ? 'Rotar PDF' : 'Rotate PDF'}
            badgeText={isEs ? 'Rotación Completada' : 'Rotation Completed'}
            successTitle={isEs ? '¡Documento Rotado con Éxito!' : 'Document Rotated Successfully!'}
            downloadButtonText={isEs ? 'Descargar PDF Rotado' : 'Download Rotated PDF'}
            shareSubject={isEs ? 'documento rotado' : 'rotated document'}
            fallbackUrl="https://pdf-black.com/organizar/rotar"
            metricBadge={
              <span className="px-2 py-0.5 bg-blue-500/10 border border-blue-500/30 text-blue-300 rounded font-bold font-mono">
                ...
                {completedResult.rotatedPagesCount === 1
                  ? isEs
                    ? 'página rotada'
                    : 'page rotated'
                  : isEs
                    ? 'páginas rotadas'
                    : 'pages rotated'}{' '}
                / {completedResult.totalPages} {isEs ? 'totales' : 'total'}
              </span>
            }
            onReset={removeFile}
          />
