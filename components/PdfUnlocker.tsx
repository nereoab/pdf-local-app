      ...
      {files.length === 0 ? (
        ...
        >
          ...
          <p className="text-zinc-400 text-xs sm:text-sm font-mono mb-8 max-w-md">
            {isEs
              ? 'Elimina contraseñas y restricciones de edición, copia o impresión de tus archivos PDF de forma 100% confidencial y local.'
              : 'Remove passwords and permissions restrictions from PDF files 100% locally.'}
          </p>
          ...
          >
            ...
            {isEs ? 'Seleccionar PDFs Protegidos' : 'Select Protected PDFs'}
          </button>
