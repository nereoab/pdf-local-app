  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold text-white tracking-tight flex items-center gap-2.5 font-sans uppercase">
              <TextIcon className="w-6 h-6 rounded-sm flex-shrink-0" />
              {mode === 'text-to-pdf'
                ? isEs
      ...
      {completedResult ? (
        ...
        >
          {/* BANNER DE ÉXITO */}
          <div className="bg-[#09090b] border border-cyan-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden font-mono">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
              <div className="flex items-center gap-3.5">
                <div className="p-3 bg-cyan-600 text-white rounded-2xl shadow-lg border border-cyan-400/30">
                  <TextIcon className="w-6 h-6 text-white rounded-sm" />
                </div>
                <div>
                  ...
                  <p className="text-zinc-400 text-xs font-mono mt-0.5">
                    {mode === 'text-to-pdf'
                      ? isEs
                        ? 'Texto plano compilado en documento PDF vectorial listo para descargar.'
                        : 'Plain text compiled into vector PDF document ready for download.'
                      : isEs
                        ? `${completedResult.itemCount} páginas extraídas a texto plano UTF-8 (.txt) limpio.`
                        : `${completedResult.itemCount} pages extracted to clean UTF-8 plain text (.txt).`}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-zinc-900 border border-white/10 rounded-xl text-xs text-cyan-400">
        ...
        <>
          ...
          <div className="flex items-center justify-center mb-6 font-mono">
            <div className="bg-[#09090b] border border-white/20 p-1.5 rounded-full flex items-center gap-2 shadow-2xl">
              ...
              >
                <TextIcon className="w-4 h-4 rounded-sm" />
            ...
            >
              ...
              <div className="lg:col-span-6 bg-[#09090b] border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col lg:h-[780px] lg:max-h-[780px]">
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-white/10 font-mono text-xs text-zinc-400 font-bold">
                  ...
                  <div className="flex items-center gap-2 px-3 py-1 bg-zinc-900 border border-white/10 rounded-full text-cyan-400 text-[11px]">
                          ...
                          <div
                            ...
                            className={`w-full bg-zinc-900 border rounded-lg p-1.5 flex flex-col items-center relative transition-all cursor-pointer group ${
                              isActive
                                ...
                                : isIncluded
                                  ? 'border-cyan-500/50 hover:border-cyan-400 bg-zinc-900'
                  ...
                  {mode === 'pdf-to-text' && (
                    <div className="bg-zinc-950 p-4 rounded-xl border border-white/10 space-y-3 font-mono text-xs">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[11px] font-bold px-2 py-0.5 bg-cyan-500/20 border border-cyan-500/40 text-cyan-400 rounded-md">
