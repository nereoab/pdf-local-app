  ...
  Ef = (t, e, r, n) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let o of Cf(e))
        !Af.call(t, o) &&
          o !== r &&
          Fn(t, o, { get: () => e[o], enumerable: !(n = If(e, o)) || n.enumerable });
    return t;
  };
    ...
    ((Tr = new Map()),
      ...
      (Ba = async (t) => {
        let e = t.executionProviders || [],
          r = e.map((d) => (typeof d == 'string' ? d : d.name)),
          n = r.length === 0 ? kt : r,
          o,
          i = [],
          a = new Set();
        ...
        if (!o)
          throw new Error(
            `no available backend found. ERR: ${i.map((d) => `[${d.name}] ${d.err}`).join(', ')}`,
          );
        ...
        return [
          o,
          new Proxy(t, { get: (d, c) => (c === 'executionProviders' ? u : Reflect.get(d, c)) }),
        ];
      }));
  });
var Ma = V(() => {
    ...
    ((La = (t, e) => {
      ...
      if (n != null) {
        ...
        e?.tensorLayout !== void 0 && e.tensorLayout === 'NHWC'
          ? ((o = t.dims[2]), (i = t.dims[3]))
          : ((o = t.dims[3]), (i = t.dims[2]));
        ...
        for (let _ = 0; _ < i; _++)
          for (let S = 0; S < o; S++) {
            let x = (t.data[m++] - c[0]) * d[0],
              v = (t.data[g++] - c[1]) * d[1],
              T = (t.data[y++] - c[2]) * d[2],
              I = b === -1 ? 255 : (t.data[b++] - c[3]) * d[3];
            ((n.fillStyle = 'rgba(' + x + ',' + v + ',' + T + ',' + I + ')'),
              n.fillRect(S, _, 1, 1));
          }
      ...
      (Wa = (t, e) => {
        ...
        if (r != null) {
          let o, i, a;
          e?.tensorLayout !== void 0 && e.tensorLayout === 'NHWC'
            ? ((o = t.dims[2]), (i = t.dims[1]), (a = t.dims[3]))
            : ((o = t.dims[3]), (i = t.dims[2]), (a = t.dims[1]));
          let u = e !== void 0 && e.format !== void 0 ? e.format : 'RGB',
            d = e?.norm,
            c,
            p;
          (d === void 0 || d.mean === void 0
            ...
            d === void 0 || d.bias === void 0
              ...
              : typeof d.bias == 'number'
                ? (p = [d.bias, d.bias, d.bias, d.bias])
                : ((p = [d.bias[0], d.bias[1], d.bias[2], 0]),
          ...
          (u === 'RGBA'
            ...
            : u === 'RGB'
              ? ((x = 0), (v = m), (T = m * 2))
              : u === 'RBG' && ((x = 0), (T = m), (v = m * 2)),
            (n = r.createImageData(o, i)));
          for (let E = 0; E < i * o; y += g, b += g, _ += g, S += g, E++)
            ((n.data[y] = (t.data[x++] - p[0]) * c[0]),
              (n.data[b] = (t.data[v++] - p[1]) * c[1]),
              (n.data[_] = (t.data[T++] - p[2]) * c[2]),
              (n.data[S] = I === -1 ? 255 : (t.data[I++] - p[3]) * c[3]));
        } else throw new Error('Can not access image data');
        return n;
      }));
  });
var Zn,
  ...
  Za = V(() => {
    ...
    ((Zn = (t, e) => {
      ...
      let u = e.format !== void 0 ? e.format : 'RGBA',
        d = e.tensorFormat !== void 0 && e.tensorFormat !== void 0 ? e.tensorFormat : 'RGB',
        c = r * n,
        p = d === 'RGBA' ? new Float32Array(c * 4) : new Float32Array(c * 3),
        m = 4,
        g = 0,
        y = 1,
        b = 2,
        ...
        v = c * 2,
        T = -1;
      (u === 'RGB' && ((m = 3), (g = 0), (y = 1), (b = 2), (_ = -1)),
        d === 'RGBA'
          ? (T = c * 3)
          : d === 'RBG'
            ? ((S = 0), (v = c), (x = c * 2))
            : d === 'BGR' && ((v = 0), (x = c), (S = c * 2)));
      for (let E = 0; E < c; E++, g += m, b += m, y += m, _ += m)
        ((p[S++] = (t[g] + a[0]) / i[0]),
          (p[x++] = (t[y] + a[1]) / i[1]),
          (p[v++] = (t[b] + a[2]) / i[2]),
          T !== -1 && _ !== -1 && (p[T++] = (t[_] + a[3]) / i[3]));
      ...
      (Ha = async (t, e) => {
        let r = typeof HTMLImageElement < 'u' && t instanceof HTMLImageElement,
          ...
          o = typeof ImageBitmap < 'u' && t instanceof ImageBitmap,
          i = typeof t == 'string',
          a,
          u = e ?? {},
          d = () => {
        ...
        if (r) {
          ...
          if (m != null) {
            ...
            if (
              (e !== void 0 &&
                ...
                ((g = e.resizedHeight), (y = e.resizedWidth)),
              e !== void 0)
            ) {
          ...
          if (
            (e !== void 0 && e.resizedWidth !== void 0 && e.resizedHeight !== void 0
              ? ((p = e.resizedHeight), (m = e.resizedWidth))
              : ((p = t.height), (m = t.width)),
            e !== void 0 && (u = e),
            (u.format = 'RGBA'),
            (u.height = p),
            (u.width = m),
          ...
          if (m != null) {
            let g = t.height,
              y = t.width;
            return (
              m.drawImage(t, 0, 0, y, g),
              (a = m.getImageData(0, 0, y, g).data),
              (u.height = g),
              (u.width = y),
              Zn(a, u)
            );
            ...
            return new Promise((p, m) => {
              ...
              ((b.crossOrigin = 'Anonymous'),
                ...
                (b.onload = () => {
                  ((g.width = b.width),
                    (g.height = b.height),
                    y.drawImage(b, 0, 0, g.width, g.height));
      ...
      (ja = (t, e, r) =>
        new Be({ location: 'cpu-pinned', type: t, data: e, dims: r ?? [e.length] })));
  });
var Ot,
  tr,
  Qa,
      ...
      (Xa = () => {
        if (!Qa) {
          ...
          let t = typeof BigInt64Array < 'u' && BigInt64Array.from,
            ...
            n = typeof r < 'u' && r.from;
          (t && (Ot.set('int64', BigInt64Array), tr.set(BigInt64Array, 'int64')),
            e && (Ot.set('uint64', BigUint64Array), tr.set(BigUint64Array, 'uint64')),
            n ? (Ot.set('float16', r), tr.set(r, 'float16')) : Ot.set('float16', Uint16Array));
        }
      }));
  });
var Ja,
    ...
    Be = class {
      constructor(e, r, n) {
            ...
            if (((o = e), (d = n), e === 'string')) {
              ...
              if (Array.isArray(r)) {
                if ((e === 'float16' && c === Uint16Array) || e === 'uint4' || e === 'int4')
                  throw new TypeError(
                    `Creating a ${e} tensor from number array is not supported. Please use ${c.name} as data.`,
                  );
        ...
        if (
          ...
          !((o === 'uint4' || o === 'int4') && Math.ceil(a / 2) === this.cpuData.length)
        )
          throw new Error(
  ...
  ns = V(() => {
    ...
    Ar = class t {
      ...
      async run(e, r, n) {
        ...
        let o = {},
          i = {};
        if (typeof e != 'object' || e === null || e instanceof je || Array.isArray(e))
          throw new TypeError(
        ...
        if (typeof r == 'object') {
          ...
          if (Array.isArray(r)) {
            ...
            let c = !1,
              p = Object.getOwnPropertyNames(r);
        ...
        for (let c of this.inputNames)
          if (typeof e[c] > 'u') throw new Error(`input '${c}' is missing in 'feeds'.`);
        if (a) for (let c of this.outputNames) o[c] = null;
        let u = await this.handler.run(e, o, i),
          d = {};
        for (let c in u)
      ...
      static async create(e, r, n, o) {
        ...
        let [u, d] = await Ba(a),
          c = await u.createInferenceSessionHandler(i, d);
        ...
        try {
          switch (e) {
            ...
            case 'run': {
              ...
              Mr(n, o, i, a, new Array(a.length).fill(null), u).then(
                (d) => {
                  d.some((c) => c[3] !== 'cpu')
                    ? postMessage({
                        type: e,
                    ...
                    : postMessage({ type: e, out: d }, Ur([...i, ...d]));
                },
                (d) => {
...
async function fs(t = {}) {
  var e = t,
    ...
    o = n && self.name?.startsWith('em-pthread');
  ((e.mountExternalData = (s, l) => {
    (s.startsWith('./') && (s = s.substring(2)), (e.Yc || (e.Yc = new Map())).set(s, l));
  }),
...
`),
  ...
  e.jsepInit = (s, l) => {
    if (s === 'webgpu') {
      ...
      let h = e.dd;
      ((e.jsepRegisterBuffer = (f, $, C, P) => h.registerBuffer(f, $, C, P)),
        (e.jsepGetBuffer = (f) => h.getBuffer(f)),
        (e.jsepCreateDownloader = (f, $, C) => h.createDownloader(f, $, C)),
        (e.jsepOnCreateSession = (f) => {
          h.onCreateSession(f);
        }),
        (e.jsepOnReleaseSession = (f) => {
          h.onReleaseSession(f);
        }),
        (e.jsepOnRunStart = (f) => h.onRunStart(f)),
        (e.Id = (f, $) => {
          h.upload(f, $);
        }));
    } else if (s === 'webnn') {
      ...
      (([
        ...
        (e.webnnReleaseTensorId = e.sd),
        (e.webnnUploadTensor = e.td),
        (e.webnnRegisterMLContext = e.Rd),
        (e.webnnOnRunStart = (f) => h.onRunStart(f)),
        (e.webnnOnRunEnd = h.onRunEnd.bind(h)),
        (e.webnnOnReleaseSession = (f) => {
          h.onReleaseSession(f);
        }),
        (e.webnnCreateMLTensorDownloader = (f, $) => h.createMLTensorDownloader(f, $)),
        (e.webnnRegisterMLTensor = (f, $, C, P) => h.registerMLTensor(f, $, C, P)),
        (e.webnnCreateMLContext = (f) => h.createMLContext(f)),
        (e.webnnRegisterGraphInput = h.registerGraphInput.bind(h)),
        (e.webnnIsGraphInput = h.isGraphInput.bind(h)),
        (e.webnnRegisterGraphOutput = h.registerGraphOutput.bind(h)),
        (e.webnnIsGraphOutput = h.isGraphOutput.bind(h)),
        (e.webnnCreateTemporaryTensor = h.createTemporaryTensor.bind(h)),
        (e.webnnIsGraphInputOutputTypeSupported = h.isGraphInputOutputTypeSupported.bind(h)));
    }
  };
  let a = () => {
    let s =
    ...
    ((() => {
      ...
      i !== void 0 &&
        ((e._OrtRun = i(e._OrtRun)), (e._OrtRunWithBinding = i(e._OrtRunWithBinding))),
      (a = void 0));
  };
  e.asyncInit = () => {
    a?.();
    ...
    let s = function (l) {
      try {
        ...
        if (f === 'load') {
          ...
          h.target !== 'setimmediate' &&
            (f === 'checkMailbox'
              ? U && br()
              : f && (E(`worker: received unknown command ${f}`), E(h)));
      } catch ($) {
        throw (Vi(), $);
      }
    };
  ...
  function Me() {
    var s = ht.buffer;
    ((e.HEAP8 = N = new Int8Array(s)),
      (q = new Int16Array(s)),
      (e.HEAPU8 = F = new Uint8Array(s)),
      (Y = new Uint16Array(s)),
      (e.HEAP32 = z = new Int32Array(s)),
      (e.HEAPU32 = L = new Uint32Array(s)),
      (Q = new Float32Array(s)),
      (X = new Float64Array(s)),
      (Z = new BigInt64Array(s)),
      (ne = new BigUint64Array(s)));
  }
  function $e() {
    ((le = !0), o ? x() : ct.sb());
  }
  function M(s) {
    throw (
      E((s = 'Aborted(' + s + ')')),
      (A = !0),
      (s = new WebAssembly.RuntimeError(s + '. Build with -sASSERTIONS for more info.')),
      S?.(s),
      s
    );
  }
  ...
  async function be() {
    function s(f, $) {
      ...
      for (let [P, B] of Object.entries(C))
        typeof B == 'function' ? ((C = Xp(B)), (f[P] = C)) : (f[P] = B);
      return (
        (ct = f),
        (ct = (function () {
          var P = ct,
        ...
        (Ni = f.ub),
        (e._OrtInit = f.vb),
        (e._OrtGetLastError = f.wb),
        (e._OrtCreateSessionOptions = f.xb),
        (e._OrtAppendExecutionProvider = f.yb),
        (e._OrtAddFreeDimensionOverride = f.zb),
        (e._OrtAddSessionConfigEntry = f.Ab),
        (e._OrtReleaseSessionOptions = f.Bb),
        (e._OrtCreateSession = f.Cb),
        (e._OrtReleaseSession = f.Db),
        (e._OrtGetInputOutputCount = f.Eb),
        (e._OrtGetInputOutputMetadata = f.Fb),
        (e._OrtFree = f.Gb),
        (e._OrtCreateTensor = f.Hb),
        (e._OrtGetTensorData = f.Ib),
        (e._OrtReleaseTensor = f.Jb),
        (e._OrtCreateRunOptions = f.Kb),
        (e._OrtAddRunConfigEntry = f.Lb),
        (e._OrtReleaseRunOptions = f.Mb),
        (e._OrtCreateBinding = f.Nb),
        (e._OrtBindInput = f.Ob),
        (e._OrtBindOutput = f.Pb),
        (e._OrtClearBoundOutputs = f.Qb),
        (e._OrtReleaseBinding = f.Rb),
        (e._OrtRunWithBinding = f.Sb),
        (e._OrtRun = f.Tb),
        (e._OrtEndProfiling = f.Ub),
        (e._JsepOutput = f.Vb),
        (e._JsepGetNodeName = f.Wb),
        (xr = f.Xb),
        (tt = e._free = f.Yb),
        (Yt = e._malloc = f.Zb),
        (Rn = f.ac),
    ...
    return e.instantiateWasm
      ...
      : o
        ? s(new WebAssembly.Instance(y, G()), y)
        : ((ie ??= e.locateFile
            ? e.locateFile
              ? e.locateFile('ort-wasm-simd-threaded.jsep.wasm', m)
              : m + 'ort-wasm-simd-threaded.jsep.wasm'
            : new URL('ort-wasm-simd-threaded.jsep.wasm', import.meta.url).href),
          (l = await (async function (f) {
            var $ = ie;
            if (!g && !D($))
              try {
  ...
  var ve = (s) => {
    ...
    Se = (s, l, ...h) => {
      ...
      for (f of h)
        typeof f == 'bigint'
          ? (((w(), Z)[B++ >>> 0] = 1n), ((w(), Z)[B++ >>> 0] = f))
          : (((w(), Z)[B++ >>> 0] = 0n), ((w(), X)[B++ >>> 0] = f));
    ...
    new Promise((l) => {
      ((s.onmessage = ($) => {
        ...
        if ((($ = C.Sc), C.Zc && C.Zc != xr())) {
          var P = Ct[C.Zc];
          P
            ? P.postMessage(C, C.jd)
            : E(
                `Internal error! Worker sent a message "${$}" to target pthread ${C.Zc}, but that thread no longer exists!`,
              );
        } else
          $ === 'checkMailbox'
            ? br()
                ...
                : $ === 'loaded'
                  ...
                  : C.target === 'setimmediate'
                    ...
                    : $ === 'uncaughtException'
                      ...
                      : $ === 'callHandler'
                        ? e[C.vd](...C.args)
                        : $ && E(`worker sent an unknown command ${$}`);
      }),
        (s.onerror = ($) => {
  ...
  var $p = () => {
    ...
    var l = s.cd;
    throw (
      (w(), N)[(s.Tc + 13) >>> 0] == 0 && (mr.push(s), Qo(s, !0), Zo(s, !1), fr++),
      Vn(l),
      (Vt = l)
    );
  };
  ...
  var Jo = globalThis.TextDecoder && new TextDecoder(),
    ei = (s, l, h, f) => {
      if (((h = l + h), f)) return h;
      for (; s[l] && !(l >= h);) ++l;
      return l;
    ...
    ti = (s, l = 0, h, f) => {
      if (16 < (h = ei(s, (l >>>= 0), h, f)) - l && s.buffer && Jo)
        return Jo.decode(s.buffer instanceof ArrayBuffer ? s.subarray(l, h) : s.slice(l, h));
      for (f = ''; l < h;) {
        var $ = s[l++];
        if (128 & $) {
          var C = 63 & s[l++];
          if ((224 & $) == 192) f += String.fromCharCode(((31 & $) << 6) | C);
            ...
            ($ =
              (240 & $) == 224
                ? ((15 & $) << 12) | (C << 6) | P
                : ((7 & $) << 18) | (C << 12) | (P << 6) | (63 & s[l++]))
              ? (f += String.fromCharCode($))
              : (($ -= 65536), (f += String.fromCharCode(55296 | ($ >> 10), 56320 | (1023 & $))));
          }
  ...
  function lt(s, l, h = {}) {
    return (function (f, $, C = {}) {
      ...
      ((In[f] = $),
        delete Ip[f],
        Tn.hasOwnProperty(f) && (($ = Tn[f]), delete Tn[f], $.forEach((B) => B())));
    })(s, l, h);
  }
  var hi = (s, l, h) => {
    switch (l) {
  ...
  function zp(s, l, h) {
    ...
    lt((s >>>= 0), { name: (h = Je(h >>> 0)), Oc: f, Uc: f }, { yd: !0 });
  }
  var gt = (s, l, h) => {
      var f = (w(), F);
      if (((l >>>= 0), 0 < h)) {
  ...
  function Bp(s, l) {
    lt((s >>>= 0), {
      ...
      Vc(h, f) {
        ...
        var $ = typeof f == 'string';
        if (!($ || (ArrayBuffer.isView(f) && f.BYTES_PER_ELEMENT == 1)))
          throw new Lt('Cannot pass non-string to std::string');
        var C = $ ? hr(f) : f.length,
          P = Yt(4 + C + 1),
          B = P + 4;
        return (
          ((w(), L)[(P >>> 2) >>> 0] = C),
          $ ? gt(f, B, C + 1) : (w(), F).set(f, B >>> 0),
          h !== null && h.push(tt, P),
          P
        );
      },
  ...
  var bi = globalThis.TextDecoder ? new TextDecoder('utf-16le') : void 0,
    Mp = (s, l, h) => {
      if (((s >>>= 1), 16 < (l = ei((w(), Y), s, l / 2, h)) - s && bi))
        return bi.decode((w(), Y).slice(s, l));
      for (h = ''; s < l; ++s) {
        var f = (w(), Y)[s >>> 0];
  ...
  function Gp(s, l) {
    lt((s >>>= 0), { zd: !0, name: (l = Je(l >>> 0)), Oc: () => {}, Vc: () => {} });
  }
  function Hp(s) {
  ...
  function En(s) {
    ((s >>>= 0),
      Fp ||
        (Atomics.waitAsync((w(), z), s >>> 2, s).value.then(br),
        (s += 128),
        Atomics.store((w(), z), s >>> 2, 1)));
  }
  var br = () =>
    gr(() => {
      var s = xr();
  ...
  function qp(s, l) {
    (s >>>= 0) == l >>> 0
      ? setTimeout(br)
      : o
        ? postMessage({ Zc: s, Sc: 'checkMailbox' })
      ...
      try {
        ...
        A ||
          ...
          et &&
            bt === 1 &&
            _r.length === 0 &&
            ((bt = 0), (Ne += 1), yr(Oa), typeof Fibers < 'u' && Fibers.be()));
      }
    };
    return (wi.set(s, l), l);
  }
          ...
          if (bt === 0) {
            ...
            (l(($ = 0) => {
              if (!A && ((yi = $), (h = !0), f)) {
                ((bt = 2),
                  yr(() => Da(et)),
                  typeof MainLoop < 'u' && MainLoop.ud && MainLoop.resume(),
                  ($ = !1));
                try {
                  var C = (function () {
                    var H = (w(), z)[((et + 8) >>> 2) >>> 0];
            ...
            bt === 2
              ? ((bt = 0), yr(za), tt(et), (et = null), Jp.forEach(gr))
              : M(`invalid state: ${bt}`);
          return yi;
        }
      })((l) => {
  ...
  function im(s, l, h) {
    ...
    return (
      ...
      f.zd ||
        ((P.toReturnWire = l),
        (P.emval_returnValue = nm),
        (B = `return emval_returnValue(toReturnWire, destructorsRef, ${B})`)),
      (B = `return function (handle, methodName, destructorsRef, args) {
  ${B}
  }`),
      (h = new Function(Object.keys(P), B)(...Object.values(P))),
      (B = `methodCaller<(${$.map((H) => H.name)}) => ${f.name}>`),
      tm(Object.defineProperty(h, 'name', { value: B }))
    );
  }
  function am(s, l) {
  ...
  function ym(s, l) {
    ((s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s)),
      (l >>>= 0),
      (s = new Date(1e3 * s)),
      ((w(), z)[(l >>> 2) >>> 0] = s.getUTCSeconds()),
      ((w(), z)[((l + 4) >>> 2) >>> 0] = s.getUTCMinutes()),
      ((w(), z)[((l + 8) >>> 2) >>> 0] = s.getUTCHours()),
      ((w(), z)[((l + 12) >>> 2) >>> 0] = s.getUTCDate()),
      ((w(), z)[((l + 16) >>> 2) >>> 0] = s.getUTCMonth()),
      ((w(), z)[((l + 20) >>> 2) >>> 0] = s.getUTCFullYear() - 1900),
      ((w(), z)[((l + 24) >>> 2) >>> 0] = s.getUTCDay()),
      (s = ((s.getTime() - Date.UTC(s.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) | 0),
      ((w(), z)[((l + 28) >>> 2) >>> 0] = s));
  }
  var xi = (s) => s % 4 == 0 && (s % 100 != 0 || s % 400 == 0),
    Si = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
    Ti = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
  function _m(s, l) {
    ((s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s)),
      (l >>>= 0),
      (s = new Date(1e3 * s)),
      ((w(), z)[(l >>> 2) >>> 0] = s.getSeconds()),
      ((w(), z)[((l + 4) >>> 2) >>> 0] = s.getMinutes()),
      ((w(), z)[((l + 8) >>> 2) >>> 0] = s.getHours()),
      ((w(), z)[((l + 12) >>> 2) >>> 0] = s.getDate()),
      ((w(), z)[((l + 16) >>> 2) >>> 0] = s.getMonth()),
      ((w(), z)[((l + 20) >>> 2) >>> 0] = s.getFullYear() - 1900),
      ((w(), z)[((l + 24) >>> 2) >>> 0] = s.getDay()));
    var h = ((xi(s.getFullYear()) ? Si : Ti)[s.getMonth()] + s.getDate() - 1) | 0;
    (((w(), z)[((l + 28) >>> 2) >>> 0] = h),
      ((w(), z)[((l + 36) >>> 2) >>> 0] = -60 * s.getTimezoneOffset()),
      (h = new Date(s.getFullYear(), 6, 1).getTimezoneOffset()));
    var f = new Date(s.getFullYear(), 0, 1).getTimezoneOffset();
    ((s = 0 | (h != f && s.getTimezoneOffset() == Math.min(f, h))),
      ((w(), z)[((l + 32) >>> 2) >>> 0] = s));
  }
  function wm(s) {
    s >>>= 0;
    ...
    return (
      0 > h
        ? ((w(), z)[((s + 32) >>> 2) >>> 0] = +($ != C && P == f))
        : 0 < h != (P == f) &&
          (($ = Math.max(C, $)), l.setTime(l.getTime() + 6e4 * ((0 < h ? P : $) - f))),
      ((w(), z)[((s + 24) >>> 2) >>> 0] = l.getDay()),
      (h = ((xi(l.getFullYear()) ? Si : Ti)[l.getMonth()] + l.getDate() - 1) | 0),
      ((w(), z)[((s + 28) >>> 2) >>> 0] = h),
      ((w(), z)[(s >>> 2) >>> 0] = l.getSeconds()),
      ((w(), z)[((s + 4) >>> 2) >>> 0] = l.getMinutes()),
      ((w(), z)[((s + 8) >>> 2) >>> 0] = l.getHours()),
      ((w(), z)[((s + 12) >>> 2) >>> 0] = l.getDate()),
      ((w(), z)[((s + 16) >>> 2) >>> 0] = l.getMonth()),
      ((w(), z)[((s + 20) >>> 2) >>> 0] = l.getYear()),
      (s = l.getTime()),
      BigInt(isNaN(s) ? -1 : s / 1e3)
    );
  }
  ...
  function vm(s, l, h, f) {
    ...
    (((w(), L)[(s >>> 2) >>> 0] = 60 * P),
      ...
      (l = l($)),
      $ < C ? (gt(s, h, 17), gt(l, f, 17)) : (gt(s, f, 17), gt(l, h, 17)));
  }
  var xm = () => Date.now(),
    Sm = 1;
  function Tm(s, l, h) {
  ...
  var Om = () => navigator.hardwareConcurrency,
    Et = {},
    $r = (s) => {
      var l;
      return (l = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(s))
        ? +l[1]
        : (l = /:(\d+):\d+(?:\)|$)/.exec(s))
          ? 2147483648 | +l[1]
          : 0;
...
`);
  ...
  function zm(s) {
    ...
    for (var h = 1; 4 >= h; h *= 2) {
      ...
      e: {
        f =
          ((Math.min(4294901760, 65536 * Math.ceil(Math.max(s, f) / 65536)) -
...
`))[0] == 'Error' && f.shift(),
  ...
  (o ||
    ...
    o || ((ht = new WebAssembly.Memory({ initial: 256, maximum: 65536, shared: !0 })), Me()),
    e.wasmBinary && (g = e.wasmBinary),
    (e.stackSave = () => de()),
    (e.stackRestore = (s) => ue(s)),
    (e.stackAlloc = (s) => Nn(s)),
    (e.setValue = function (s, l, h = 'i8') {
  ...
  var Ui,
    ...
    Wn = {
      1055492: (s, l, h, f, $) => {
        ...
        if (
          ((s = Ee(Number(s >>> 0))).startsWith('./') && (s = s.substring(2)), !(s = e.Yc.get(s)))
        )
          return 2;
        if (
          ((l = Number(l >>> 0)),
      ...
      1060941: (s, l, h) => {
        e.$b('Transpose', s, {
          perm: l ? Array.from((w(), z).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [],
        });
      },
      1061065: (s, l, h, f) => {
      ...
      1061423: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt) => {
        e.$b('ConvTranspose', s, {
          ...
          wIsConst: () => !!(w(), N)[K >>> 0],
          outputPadding: ae
            ? Array.from((w(), z).subarray(Number(ae) >>> 0, Number(pe) >>> 0))
            : [],
      ...
      1061856: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
        e.$b('ConvTranspose', s, {
          ...
          kernelShape: Array.from(
            (w(), z).subarray(Number($) >>> 0, ((Number($) >>> 0) + 2) >>> 0),
          ),
      ...
      1068944: (s, l, h, f, $, C, P, B, H) => {
        e.$b('Attention', s, {
          ...
          doRotary: C,
          qkvHiddenSizes: P
            ? Array.from((w(), z).subarray(Number(B) >>> 0, (Number(B) + P) >>> 0))
            : [],
      ...
      1069388: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt, Gn) => {
        e.$b('Conv', s, {
          ...
          activation: Ee(Ie),
          activation_params: yt
            ? Array.from((w(), Q).subarray(Number(yt) >>> 0, Number(Gn) >>> 0))
            : [],
        });
      },
      1069972: (s) => {
...
var _s,
  ...
  kr = V(() => {
    'use strict';
    Er();
    ((_s = typeof location > 'u' ? void 0 : location.origin),
      (to = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (Bf = () => {
        if (!!1) {
          if (to) {
            let t = URL;
      ...
      (Uf = async (t) => (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ t)).default),
      (bs = (ms(), er(ps)).default),
      (vs = async () => {
        if (!We)
    ...
    ((Ge = (t, e) => {
      ...
      (me = (t) => {
        ...
        try {
          ...
          let i = Number(e.getValue(o, n === 4 ? 'i32' : 'i64')),
            a = e.getValue(o + n, '*'),
            u = a ? e.UTF8ToString(a) : '';
  ...
  Is = V(() => {
    ...
    Ts = (t) => {
      ...
      try {
        ...
        let i = 0;
        return (
          t?.tag !== void 0 && (i = Ge(t.tag, n)),
          (r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i)),
          r === 0 && me("Can't create run options."),
          t?.extra !== void 0 &&
            nr(t.extra, '', new WeakSet(), (a, u) => {
              let d = Ge(a, n),
                c = Ge(u, n);
              e._OrtAddRunConfigEntry(r, d, c) !== 0 &&
                me(`Can't set a run config entry: ${a} - ${u}.`);
            }),
          [r, n]
        );
      } catch (i) {
  ...
  As = V(() => {
    ...
    ((Wf = (t) => {
      ...
      (Gt = (t, e, r, n) => {
        let o = Ge(e, n),
          i = Ge(r, n);
        ye()._OrtAddSessionConfigEntry(t, o, i) !== 0 &&
          me(`Can't set a session config entry: ${e} - ${r}.`);
      }),
      (Ff = async (t, e, r) => {
        let n = e.executionProviders;
        for (let o of n) {
          let i = typeof o == 'string' ? o : o.name,
            a = [];
          switch (i) {
            case 'webnn':
              if (
                ((i = 'WEBNN'),
                Gt(t, 'session.disable_quant_qdq', '1', r),
                Gt(t, 'session.disable_qdq_constant_folding', '1', r),
                typeof o != 'string')
              ) {
                let g = o?.deviceType;
          ...
          let u = Ge(i, r),
            ...
            p = 0;
          if (d > 0) {
            ((c = ye()._malloc(d * ye().PTR_SIZE)),
              r.push(c),
              (p = ye()._malloc(d * ye().PTR_SIZE)),
              r.push(p));
            for (let m = 0; m < d; m++)
              (ye().setValue(c + m * ye().PTR_SIZE, a[m][0], '*'),
                ye().setValue(p + m * ye().PTR_SIZE, a[m][1], '*'));
          }
          (await ye()._OrtAppendExecutionProvider(t, u, c, p, d)) !== 0 &&
            me(`Can't append execution provider: ${i}.`);
        }
      }),
      (Cs = async (t) => {
        let e = ye(),
        ...
        Hf(o);
        try {
          let i = Wf(o.graphOptimizationLevel ?? 'all'),
            a = Gf(o.executionMode ?? 'sequential'),
            u = typeof o.logId == 'string' ? Ge(o.logId, n) : 0,
          ...
          if (
            ...
            r === 0 && me("Can't create session options."),
            o.executionProviders && (await Ff(r, o, n)),
          ...
          if (o.freeDimensionOverrides)
            for (let [m, g] of Object.entries(o.freeDimensionOverrides)) {
              ...
              let y = Ge(m, n);
              e._OrtAddFreeDimensionOverride(r, y, g) !== 0 &&
                me(`Can't set a free dimension override: ${m} - ${g}.`);
            }
          return (
            o.extra !== void 0 &&
              nr(o.extra, '', new WeakSet(), (m, g) => {
                Gt(r, m, g, n);
              }),
            [r, n]
          );
          ...
          throw (
            r !== 0 && e._OrtReleaseSessionOptions(r) !== 0 && me("Can't release session options."),
            n.forEach((a) => e._free(a)),
            i
          );
        }
      }));
    ...
    ((vt = (t) => {
      ...
      (xt = (t, e) => {
        let r = [-1, 4, 1, 1, 2, 2, 4, 8, -1, 1, 2, 8, 4, 8, -1, -1, -1, -1, -1, -1, -1, 0.5, 0.5][
          ...
          n = typeof e == 'number' ? e : e.reduce((o, i) => o * i, 1);
        ...
        if (!1)
          try {
            ...
            if (e.code === 'ERR_FS_FILE_TOO_LARGE') {
              let { createReadStream: r } = qn('node:fs'),
                n = r(t),
                o = [];
...
var qf,
  ...
  nt = V(() => {
    ...
    ((qf = ['V', 'I', 'W', 'E', 'F']),
      (Kf = (t, e) => {
        console.log(`[${qf[t]},${new Date().toISOString()}]${e}`);
      }),
      (Gr = (t, e) => {
        ((Es = t), (ks = e));
      }),
    ...
    ((ao = class {
      ...
      (ot = class {
        static calcShape(e, r, n = !1) {
          ...
          if (o === 0) return r;
          if (i === 0) return e;
          let a = Math.max(e.length, r.length),
            u = new Array(a);
          if (n) {
            if (o < 2 || i < 2) return;
      ...
      (k = class t {
        ...
        static sizeFromDimension(e, r) {
          if (r < 0 || r > e.length)
            throw new Error(
              `invalid dimension of ${r} for sizeFromDimension as Tensor has ${e.length} dimensions.`,
            );
        ...
        static sizeToDimension(e, r) {
          if (r < 0 || r > e.length)
            throw new Error(
              `invalid dimension of ${r} for sizeToDimension as Tensor has ${e.length} dimensions.`,
            );
        ...
        static computeShapeHelper(e, r, n, o, i, a, u, d, c = 0) {
          if (e) for (let p = 0; p < r.length - 2; p++) n.push(1);
            ...
            for (let p = 0; p < r.length - 2; p++)
              n.push(
                t.adjustPadAndReturnShape(r[p + 2], o[p], i[p], a[p], u, p, p + r.length - 2, d, c),
              );
        }
            ...
            switch (d) {
              ...
              case 'SAME_UPPER':
                if (n !== 1) throw new Error('Dilation not supported for SAME_UPPER or SAME_LOWER');
                {
                  ...
                  return (
                    (i[a] = Math.floor(d === 'SAME_LOWER' ? (g + 1) / 2 : g / 2)),
                    (i[u] = g - i[a]),
                    t.computeOutputSize(e + i[a] + i[u] - p, r, e, i[a], c)
                  );
                }
              default:
      ...
      (Hr = class {
        static getShapeOfGemmResult(e, r, n, o, i) {
          ...
          if (i && !ot.isValidBroadcast(i, [a, d]))
            throw new Error('gemm: invalid bias shape for broadcast');
          return [a, d, u];
        }
      }),
      (Ps = -34028234663852886e22),
    ...
    ((zs = new Map([
      ...
      (Zf = (t, e) => {
        ...
        let o = t.byteLength / n,
          i = new (Ht(e))(t.buffer, t.byteOffset, o);
        switch (e) {
          case 'int64':
          case 'uint64': {
      ...
      (Bs = (t, e) => {
        ...
        let r = t.byteLength / 4,
          n = new Int32Array(t.buffer, t.byteOffset, r);
        switch (e) {
          case 'int64': {
      ...
      (qr = class {
        ...
        async read(e) {
          if (this.fallbackDataType) {
            let r = await this.mlContext.readTensor(this.mlTensor),
              n = Bs(new Uint8Array(r), this.dataType);
            if (e) {
              (e instanceof ArrayBuffer
                ? new Uint8Array(e)
        ...
        canReuseTensor(e, r, n) {
          return (
            ...
            this.tensorShape.every((o, i) => o === n[i])
          );
        }
      ...
      (Kr = class {
        ...
        async ensureTensor(e, r, n, o) {
          ...
          if (!a?.input.dataTypes.includes(r)) {
            if (((u = Xf.get(r)), !u || a?.input.dataTypes.includes(u)))
              throw new Error(`WebNN backend does not support data type: ${r}`);
            se(
              'verbose',
              () => `[WebNN] TensorIdTracker.ensureTensor: fallback dataType from ${r} to ${u}`,
            );
          }
          if (this.wrapper) {
            if (this.wrapper.canReuseTensor(i, r, n)) return this.wrapper.tensor;
            if (o) {
              if (this.wrapper.byteLength !== Ms(r, n))
          ...
          return (
            (this.wrapper = await this.tensorManager.getCachedTensor(e, r, n, d, !0, !0, u)),
            o &&
              this.activeUpload &&
          ...
          if (this.wrapper) {
            if (this.wrapper.fallbackType)
              if (this.wrapper.fallbackType === 'int32')
                ((r = Zf(e, this.wrapper.type)), this.wrapper.setIsDataConverted(!0));
            ...
            if (e.byteLength === this.wrapper.byteLength) {
              ...
              (se('verbose', () => 'Data size does not match tensor size. Releasing tensor.'),
                this.releaseTensor());
          }
        ...
        async download(e) {
          if (this.activeUpload) {
            let r = this.wrapper?.isDataConverted
              ? Bs(this.activeUpload, this.wrapper?.type)
              : this.activeUpload;
            if (e) {
              e instanceof ArrayBuffer
      ...
      (uo = class {
        ...
        async ensureTensor(e, r, n, o, i) {
          se(
            'verbose',
            () =>
              `[WebNN] TensorManager.ensureTensor {tensorId: ${r}, dataType: ${n}, shape: ${o}, copyOld: ${i}}`,
          );
        ...
        registerTensor(e, r, n, o) {
          let i = this.getMLContext(e),
            a = Ds(),
            u = new qr({ sessionId: e, context: i, tensor: r, dataType: n, shape: o });
        ...
        async getCachedTensor(e, r, n, o, i, a, u) {
          ...
          for (let [p, m] of this.freeTensors.entries())
            if (m.canReuseTensor(d, r, n)) {
              se(
                'verbose',
                () =>
                  `[WebNN] Reusing tensor {dataType: ${r}, ${u ? `fallbackDataType: ${u},` : ''} shape: ${n}`,
              );
          ...
          se(
            'verbose',
            () =>
              `[WebNN] MLContext.createTensor {dataType: ${r}, ${u ? `fallbackDataType: ${u},` : ''} shape: ${n}}`,
          );
    ...
    ((jr = new Map([
      ...
      (Zr = class {
        ...
        onRunEnd(e) {
          ...
          if (r) {
            for (let n of r)
              (se('verbose', () => `[WebNN] releasing temporary tensor {tensorId: ${n}}`),
        ...
        registerMLContext(e, r) {
          ...
          (n || ((n = new Set()), this.sessionIdsByMLContext.set(r, n)),
            n.add(e),
        ...
        releaseTensorId(e) {
          (se('verbose', () => `[WebNN] releaseTensorId {tensorId: ${e}}`),
        ...
        uploadTensor(e, r) {
          if (!ye().shouldTransferToMLTensor)
            throw new Error(
              'Trying to upload to a MLTensor while shouldTransferToMLTensor is false',
            );
          (se('verbose', () => `[WebNN] uploadTensor {tensorId: ${e}, data: ${r.byteLength}}`),
        ...
        registerMLTensor(e, r, n, o) {
          ...
          return (
            se(
              'verbose',
              () =>
                `[WebNN] registerMLTensor {tensor: ${r}, dataType: ${i}, dimensions: ${o}} -> {tensorId: ${a}}`,
            ),
            a
          );
        }
        ...
        isGraphInputOutputTypeSupported(e, r, n = !0) {
          ...
          return typeof o > 'u'
            ? !1
            : n
              ? !!i?.input.dataTypes.includes(o)
              : !!i?.output.dataTypes.includes(o);
        }
        flush() {}
      }));
  });
    ...
    ((Vs = new Map([
      ...
      (mo = async (t, e, r, n) => {
        ...
        try {
          ...
          (t.endComputePass(),
            a.copyBufferToBuffer(e, 0, i, 0, o),
            t.flush(),
      ...
      (po = class {
        constructor(e) {
          ...
          for (let [r] of Vs)
            (lo.push(r), this.freeBuffers.set(r, []), this.freeUniformBuffers.set(r, []));
          this.sessionCount = 0;
        }
        upload(e, r) {
          let n = r.buffer,
            ...
            i = r.byteLength,
            a = co(i),
            u = this.storageCache.get(e);
          if (!u) throw new Error('gpu data for uploading does not exist');
          if (Number(u.originalSize) !== i)
            throw new Error(
              `inconsistent data size. gpu data size=${u.originalSize}, data size=${i}`,
            );
          if (a === i && o % 4 === 0)
            this.backend.device.queue.writeBuffer(u.gpuData.buffer, 0, n, o, i);
          else {
        ...
        memcpy(e, r) {
          ...
          let i = co(n.originalSize),
            a = this.backend.getCommandEncoder();
          (this.backend.endComputePass(),
            a.copyBufferToBuffer(n.gpuData.buffer, 0, o.gpuData.buffer, 0, i));
        }
        registerExternalBuffer(e, r, n) {
            ...
            if (((o = n[0]), e === n[1]))
              return (
                se(
                  'verbose',
                  () =>
                    `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${o}, buffer is the same, skip.`,
                ),
                o
              );
          ...
          return (
            this.storageCache.set(o, { gpuData: { id: o, type: 0, buffer: e }, originalSize: r }),
            se(
              'verbose',
              () =>
                `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${o}, registered.`,
            ),
            o
          );
        }
        unregisterExternalBuffer(e) {
          e !== void 0 &&
            ...
            se('verbose', () => `[WebGPU] GpuDataManager.unregisterExternalBuffer() => id=${e}`));
        }
        create(e, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
          let n = Jf(e),
            o,
            i = (r & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE,
          ...
          return (
            this.storageCache.set(u.id, { gpuData: u, originalSize: Number(e) }),
            se('verbose', () => `[WebGPU] GpuDataManager.create(size=${e}) => id=${u.id}`),
            u
          );
        }
        get(e) {
        ...
        release(e) {
          let r = typeof e == 'bigint' ? Number(e) : e,
            n = this.storageCache.get(r);
          if (!n) {
          ...
          return (
            se(
              'verbose',
              () => `[WebGPU] GpuDataManager.release(id=${r}), gpuDataId=${n.gpuData.id}`,
            ),
        ...
        onReleaseSession(e) {
          ...
          (r &&
            ...
            (this.sessionCount -= 1),
            this.sessionCount === 0 &&
              (se('warning', () => '[WebGPU] Clearing webgpu buffer cache'),
              this.storageCache.forEach((n) => {
...
var Bt,
    ...
    ((Bt = 64),
      ...
      (W = (...t) => {
        ...
        return (
          t.forEach((r) => {
            r.length !== 0 &&
              e.push({ type: 12, data: r }, { type: 12, data: k.computeStrides(r) });
          }),
          e
        );
      }),
      (fe = (t) => (t % 4 === 0 ? 4 : t % 2 === 0 ? 2 : 1)),
      (bo = (t = 'f32', e, r = '0') => (!e || e === 1 ? `${t}(${r})` : `vec${e}<${t}>(${r})`)),
      (Mt = (t, e, r) => (t === 'f32' ? r : e === 1 ? `f32(${r})` : `vec${e}<f32>(${r})`)),
      (Ze = (t, e) =>
        e === 4
          ? `(${t}.x + ${t}.y + ${t}.z + ${t}.w)`
          : e === 2
            ...
            : e === 3
              ...
              : t),
      (j = (t, e, r, n) =>
        t.startsWith('uniforms.') && r > 4
          ? typeof e == 'string'
            ? n === 'f16'
              ? `${t}[(${e}) / 8][(${e}) % 8 / 4][(${e}) % 8 % 4]`
              : `${t}[(${e}) / 4][(${e}) % 4]`
            : n === 'f16'
              ? `${t}[${Math.floor(e / 8)}][${Math.floor((e % 8) / 4)}][${(e % 8) % 4}]`
              : `${t}[${Math.floor(e / 4)}][${e % 4}]`
          : r > 1
            ? `${t}[${e}]`
            : t),
      (Xr = (t, e, r, n, o) => {
        let i = typeof r == 'number',
          a = i ? r : r.length,
          u = [...new Array(a).keys()],
          d = a < 2 ? 'u32' : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`,
          c = go(e, o),
          p = typeof c == 'string' ? c : c[1],
          m = typeof c == 'string' ? c : c[0],
          g = { indices: d, value: p, storage: m, tensor: e },
          y = (M) => (typeof M == 'string' ? M : `${M}u`),
          b = {
            offsetToIndices: !1,
            indicesToOffset: !1,
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    return indices;
          ...
          I = (M) => ((b.offsetToIndices = !0), a < 2 ? M : `o2i_${t}(${M})`),
          E = [];
  ...
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join('+')};
          ...
          D = (M) => ((b.indicesToOffset = !0), a < 2 ? M : `i2o_${t}(${M})`),
          w = (...M) => (a === 0 ? '0u' : `${g.indices}(${M.map(y).join(',')})`),
          U = (M, G) => (a < 2 ? `${M}` : `${j(M, G, a)}`),
          N = (M, G, be) => (a < 2 ? `${M}=${be};` : `${j(M, G, a)}=${be};`),
          F = {},
          q = (M, G) => {
            ...
            return (
              (F[be] = `fn ${be}(outputIndices: ${G.type.indices}) -> u32 {
          ...
          Y = (M, G) =>
            (() => {
              ...
              if (g.storage === 'vec2<u32>' && g.value === 'i32')
                return `${t}[${M}]=vec2<u32>(u32(${G}), select(0u, 0xFFFFFFFFu, ${G} < 0));`;
              if (g.storage === 'vec2<u32>' && g.value === 'u32')
                return `${t}[${M}]=vec2<u32>(u32(${G}), 0u);`;
              if (g.storage === 'u32' && g.value === 'vec4<bool>')
                return `${t}[${M}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${G}));`;
              throw new Error(
          ...
          z = (M) =>
            (() => {
              ...
              if (g.storage === 'u32' && g.value === 'vec4<bool>')
                return `vec4<bool>(bool(${t}[${M}] & 0xFFu), bool(${t}[${M}] & 0xFF00u), bool(${t}[${M}] & 0xFF0000u), bool(${t}[${M}] & 0xFF000000u))`;
              throw new Error(
                `not supported combination of storage type ${g.storage} and value type ${g.value} yet`,
              );
            })(),
    ...
    return ${z(`i2o_${t}(indices)`)};
          ...
          Q =
            a < 2
              ? ''
              : (() => {
                  let M = u.map((be) => `d${be}: u32`).join(', '),
                    G = u.map((be) => `d${be}`).join(', ');
                  return `
  fn get_${t}(${M}) -> ${p} {
    return get_${t}ByIndices(${w(G)});
          ...
          X = (...M) => {
            ...
            return a === 0
              ...
              : a === 1
                ? z(G[0])
                : ((b.get = !0), (b.getByIndices = !0), (b.indicesToOffset = !0), `get_${t}(${G})`);
          },
          Z = (M) =>
            a < 2
              ? z(M)
              : ((b.getByIndices = !0), (b.indicesToOffset = !0), `get_${t}ByIndices(${M})`),
          ne =
            a < 2
              ? ''
              : `
        ...
        return {
          impl: () => {
            let M = [],
              G = !1;
            return (
              b.offsetToIndices && (M.push(T), (G = !0)),
              b.indicesToOffset && (M.push(A), (G = !0)),
              b.broadcastedIndicesToOffset &&
                (Object.values(F).forEach((be) => M.push(be)), (G = !0)),
              b.set && (M.push(ie), (G = !0)),
              b.setByIndices && (M.push(ne), (G = !0)),
              b.get && (M.push(Q), (G = !0)),
              b.getByIndices && (M.push(L), (G = !0)),
              !i &&
                G &&
                M.unshift(
                  `const ${S} = ${g.indices}(${r.join(',')});`,
                  `const ${x} = ${g.indices}(${k.computeStrides(r).join(',')});`,
                ),
              M.join(`
`)
            );
          ...
          setByIndices: (M, G) =>
            a < 2
              ? Y(M, G)
              : ((b.setByIndices = !0), (b.indicesToOffset = !0), `set_${t}ByIndices(${M}, ${G});`),
          get: X,
          getByOffset: z,
          getByIndices: Z,
          usage: n,
      ...
      (O = (t, e, r, n = 1) => Xr(t, e, r, 'input', n)),
      (R = (t, e, r, n = 1) => Xr(t, e, r, 'output', n)),
      (Fs = (t, e, r) => Xr(t, e, r, 'atomicOutput', 1)),
      (Yr = (t, e, r, n = 1) => Xr(t, e, r, 'internal', n)),
      (ho = class {
        constructor(e, r) {
        ...
        mainStart(e = Bt) {
          let r = typeof e == 'number' ? e : e[0],
            n = typeof e == 'number' ? 1 : e[1],
            o = typeof e == 'number' ? 1 : e[2];
          if (
            ...
            throw new Error(
              `workgroup size [${r}, ${n}, ${o}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`,
            );
          if (r * n * o > this.limits.maxComputeInvocationsPerWorkgroup)
            throw new Error(
              `workgroup size [${r}, ${n}, ${o}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`,
            );
  ...
  `;
        ...
        declareVariable(e, r) {
          ...
          let n = e.usage === 'input' ? 'read' : 'read_write',
            o = e.usage === 'atomicOutput' ? 'atomic<i32>' : e.type.storage;
...
`);
        ...
        uniformDeclaration() {
          ...
          for (let { name: r, type: n, length: o } of this.uniforms)
            if (o && o > 4)
              n === 'f16'
                ? e.push(`@align(16) ${r}:array<mat2x4<${n}>, ${Math.ceil(o / 8)}>`)
                : e.push(`${r}:array<vec4<${n}>, ${Math.ceil(o / 4)}>`);
            else {
      ...
      @group(0) @binding(${this.variableIndex}) var<uniform> uniforms: Uniforms;`;
        ...
        get additionalImplementations() {
          return (
            ...
            this.variables.map((e) => e.impl()).join(`
`) +
...
var th,
  ...
  pt = V(() => {
    ...
    ((th = (t, e) => {
      ...
      (Ks = (t, e) => (e.length !== 0 ? e : [...new Array(t).keys()].reverse())),
      (rh = (t, e) => k.sortBasedOnPerm(t, Ks(t.length, e))),
      (nh = (t, e, r, n) => {
            ...
            }),
            {
              ...
              getRunData: () => {
                ...
                return {
                  ...
                  programUniforms: [{ type: 12, data: Math.ceil(_ / 4) }],
                };
              },
              getShaderSource: c,
            }
          );
        let { newShape: p, newPerm: m } = oh(t.dims, o),
          g = k.areEqual(m, [2, 3, 1]),
          y = k.areEqual(m, [3, 1, 2]);
        if (p.length === 2 || g || y) {
          ((a = g ? [p[0], p[1] * p[2]] : y ? [p[0] * p[1], p[2]] : p), (u = [a[1], a[0]]));
          let _ = 16;
          return (
            (c = (S) => {
              let x = O('a', r, a.length),
                v = R('output', r, u.length);
              return `
      ...
      ${v.setByIndices(`${v.type.indices}(output_row, output_col)`, 'tile[local_id.x][local_id.y]')}
            ...
            }),
            {
              ...
              getRunData: () => {
                ...
                return {
                  outputs: [{ dims: i, dataType: t.dataType }],
                  dispatchGroup: { x: Math.ceil(u[1] / _), y: Math.ceil(u[0] / _) },
                  programUniforms: [{ type: 12, data: S }, ...W(a, u)],
                };
              },
              getShaderSource: c,
            }
        ...
        return (
          (c = (_) => {
            let S = O('a', r, a.length),
              x = R('output', r, u.length);
            return `
  ${_.registerUniform('output_size', 'u32').declareVariables(S, x)}
  ...
  ${_.mainStart()}
    ...
    ${x.setByOffset('global_idx', S.getByIndices('aIndices'))}
          ...
          {
            name: 'Transpose',
            shaderCache: { hint: `${e}`, inputDependencies: ['rank'] },
            getRunData: () => {
              let _ = k.size(i);
              return {
                outputs: [{ dims: i, dataType: t.dataType }],
                dispatchGroup: { x: Math.ceil(_ / 64) },
                programUniforms: [{ type: 12, data: _ }, ...W(a, u)],
              };
            },
            getShaderSource: c,
          }
    ...
    ((ah = {
      ...
      (hh = (t, e, r, n, o, i, a) => {
       ...
       `,
        ...
        return {
          name: t,
          shaderCache: { hint: `${e};${g}`, inputDependencies: ['type'] },
          getShaderSource: b,
          getRunData: () => ({
      ...
      (it = (t, e, r, n) => {
        let o = t.inputs.length === 1 ? r : yo(t.inputs, r),
          i = o.axes;
        i.length === 0 && !o.noopWithEmptyAxes && (i = t.inputs[0].dims.map((y, b) => b));
        let a = k.normalizeAxes(i, t.inputs[0].dims.length),
          u = a,
          d = t.inputs[0],
          c = fh(u, t.inputs[0].dims.length);
        c.length > 0 &&
          ((d = t.compute(ze(t.inputs[0], c), { inputs: [0], outputs: [-1] })[0]),
          (u = lh(u.length, d.dims.length)));
        let [p, m] = ch(d.dims, u),
          g = p;
        (o.keepDims && (g = ph(p, a)),
          t.compute(hh(e, o.cacheKey, [d], n, t.inputs[0].dataType, g, m), { inputs: [d] }));
      }),
      (Qs = (t, e) => {
...
var at,
  ...
  Jr = V(() => {
    ...
    ((at = (t) => {
      ...
      (gh = (t) => ['', '', `var value = ${t.getByIndices('input_indices')};`, '']),
      (en = (t, e, r, n, o, i, a = !1, u = !1) => {
        let d = [],
          c = r[0].dims,
          p = c.length,
          m = k.normalizeAxes(o, p),
          g = !u && m.length === 0;
        c.forEach((S, x) => {
        ...
        return {
          ...
          getShaderSource: (S) => {
            let x = [],
              v = O('_A', r[0].dataType, p),
              T = R('output', i, y),
              I = n(v, T, m),
              E = I[2];
            for (let A = 0, D = 0; A < p; A++)
              g || m.indexOf(A) >= 0
                ? (a && D++,
                  (E = `for(var j${A}: u32 = 0; j${A} < ${c[A]}; j${A}++) {
                  ${I[2].includes('last_index') ? `let last_index = j${A};` : ''}
                  ${v.indicesSet('input_indices', A, `j${A}`)}
                  ${E}
                }`))
                : (x.push(
                    `${v.indicesSet('input_indices', A, T.indicesGet('output_indices', D))};`,
                  ),
                  D++);
            return `
...
`)
      ...
      (yo = (t, e) => {
        let r = [];
        return (
          t[1].dims[0] > 0 && t[1].getBigInt64Array().forEach((n) => r.push(Number(n))),
          J({ axes: r, keepDims: e.keepDims, noopWithEmptyAxes: e.noopWithEmptyAxes })
        );
      }),
      (st = (t, e, r, n) => {
        let o = t.inputs,
          i = o.length === 1 ? r : yo(o, r);
        t.compute(
          en(
            e,
            { hint: i.cacheKey, inputDependencies: ['rank'] },
            [o[0]],
            i.noopWithEmptyAxes && i.axes.length === 0 ? gh : n,
            i.axes,
            o[0].dataType,
            i.keepDims,
            i.noopWithEmptyAxes,
      ...
      ($h = (t, e) => {
        (at(t.inputs),
          st(t, 'ReduceMax', e, (n, o, i) => {
            let a = [];
            for (let u = 0; u < n.rank; u++)
              (i.indexOf(u) >= 0 || i.length === 0) && a.push(n.indicesSet('input_indices', u, 0));
            return [
              `${a.join(`
`)}`,
      ...
      (vh = (t, e) => {
        (at(t.inputs),
          st(t, 'ReduceMean', e, (n, o, i) => {
            let a = 1;
            for (let u = 0; u < n.rank; u++)
              (i.indexOf(u) >= 0 || i.length === 0) && (a *= t.inputs[0].dims[u]);
            return [
              'var sum = f32(0);',
              '',
      ...
      (xh = (t, e) => {
        (at(t.inputs),
          st(t, 'ReduceMin', e, (n, o, i) => {
            let a = [];
            for (let u = 0; u < n.rank; u++)
              (i.indexOf(u) >= 0 || i.length === 0) && a.push(`input_indices[${u}] = 0;`);
            return [
              `${a.join(`
`)}`,
              `var value = ${n.getByIndices('input_indices')};`,
...
var best_index : i32 = 0;`,
        ...
        t.compute(
          en(
            'ArgMin',
            { hint: e.cacheKey, inputDependencies: ['rank'] },
            [t.inputs[0]],
            r,
            [e.axis],
            7,
  ...
  tn = V(() => {
    ...
    ((Ch = (t, e) => {
      ...
      if (a) {
        ...
        if (a.dims[2] !== e.numHeads)
          throw new Error('Input "past" third dimension must be num_heads');
        if (a.dims[4] !== g / e.numHeads)
    ...
    `),
      (Ah = (t, e, r, n, o, i, a, u) => {
        ...
        let S = (x) => {
          let v = R('x', t.dataType, t.dims, d),
            T = [v],
            I = a ? O('seq_lens', a.dataType, a.dims) : void 0;
          I && T.push(I);
    ...
    if (sum == 0) {
      ...
      ${
        ...
        return {
          ...
          shaderCache: { hint: `${c};${y};${d}`, inputDependencies: _ },
          getShaderSource: S,
          getRunData: () => ({
            outputs: [],
            dispatchGroup: { x: 1, y: o, z: e * r },
            programUniforms: g,
          }),
        };
      }),
      (Eh = (t, e, r, n, o, i, a, u, d) => {
        let c = a + i.kvSequenceLength,
          p = [i.batchSize, i.numHeads, i.sequenceLength, c],
          m = t > 1 && n,
          g = i.kvNumHeads ? i.kvNumHeads : i.numHeads,
          y = m ? [i.batchSize, g, c, i.headSize] : void 0,
          b = i.nReps ? i.nReps : 1,
          _ = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale,
          S = fe(i.headSize),
          x = i.headSize / S,
          v = 12,
          T = {
        ...
        let w = (U) => {
          let N = O('q', e.dataType, e.dims, S),
            F = O('key', r.dataType, r.dims, S),
            q = [N, F];
          if (E) {
  ...
  ${U.mainStart([v, v, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        return {
          name: 'AttentionProbs',
          shaderCache: { hint: `${S};${o !== void 0};${n !== void 0};${t}`, inputDependencies: A },
          getRunData: () => ({ outputs: D, dispatchGroup: T, programUniforms: I }),
          getShaderSource: w,
        };
      }),
      (kh = (t, e, r, n, o, i, a = void 0, u = void 0) => {
        let d = i + o.kvSequenceLength,
          c = o.nReps ? o.nReps : 1,
          p = o.vHiddenSize * c,
          m = t > 1 && n,
          g = o.kvNumHeads ? o.kvNumHeads : o.numHeads,
          y = m ? [o.batchSize, g, d, o.headSize] : void 0,
          b = [o.batchSize, o.sequenceLength, p],
          _ = 12,
          S = {
        ...
        let E = (A) => {
          let D = O('probs', e.dataType, e.dims),
            w = O('v', r.dataType, r.dims),
            U = [D, w];
  ...
  ${A.mainStart([_, _, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        return {
          name: 'AttentionScore',
          shaderCache: { hint: `${n !== void 0};${t}`, inputDependencies: T },
          getRunData: () => ({ outputs: I, dispatchGroup: S, programUniforms: x }),
          getShaderSource: E,
        };
      }),
      (Ft = (t, e, r, n, o, i, a, u, d, c, p = void 0, m = void 0) => {
        let g = Math.min(t.outputCount, 1 + (a ? 1 : 0) + (u ? 1 : 0)),
          y = g > 1 ? a : void 0,
          b = g > 1 ? u : void 0,
          _ = g > 1 ? c.pastSequenceLength : 0,
          S = _ + c.kvSequenceLength,
          x = d && k.size(d.dims) > 0 ? d : void 0,
          v = [e, r];
        ...
        let I = [T, n];
        (b && k.size(b.dims) > 0 && I.push(b),
          p && I.push(p),
          m && I.push(m),
          t.compute(kh(g, T, n, b, c, _, p, m), { inputs: I, outputs: g > 1 ? [0, 2] : [0] }));
      }),
      (Ph = (t, e) => {
        let r = [e.batchSize, e.numHeads, e.sequenceLength, e.headSize],
          n = e.sequenceLength,
          o = e.inputHiddenSize,
          i = e.headSize,
          a = 12,
          ...
          d = [t.inputs[0], t.inputs[1], t.inputs[2]],
          c = [
            { type: 12, data: n },
            { type: 12, data: o },
            { type: 12, data: i },
            { type: 12, data: e.numHeads },
            { type: 12, data: e.headSize },
            { type: 12, data: e.hiddenSize },
            { type: 12, data: e.hiddenSize + e.hiddenSize + e.vHiddenSize },
          ],
          p = (m) => {
            let g = R('output_q', d[0].dataType, r),
              y = R('output_k', d[0].dataType, r),
              b = R('output_v', d[0].dataType, r),
              _ = O('input', d[0].dataType, d[0].dims),
              S = O('weight', d[1].dataType, d[1].dims),
              x = O('bias', d[2].dataType, d[2].dims),
              v = _.type.storage,
              T = [
                { name: 'M', type: 'u32' },
                { name: 'K', type: 'u32' },
        ...
        return t.compute(
          {
            ...
            getRunData: () => ({
              outputs: [
                { dims: r, dataType: t.inputs[0].dataType, gpuDataType: 0 },
                { dims: r, dataType: t.inputs[0].dataType, gpuDataType: 0 },
                { dims: r, dataType: t.inputs[0].dataType, gpuDataType: 0 },
              ],
              dispatchGroup: u,
      ...
      if (t[0].dims.length > 1) {
        let n =
          e.format === 'NHWC'
            ? e.spatial
              ? t[0].dims.slice(-1)
              : t[0].dims.slice(-1).concat(t[0].dims.slice(1, t[0].dims.length - 1))
            : t[0].dims.slice(1, e.spatial ? 2 : void 0);
        (r(t[1].dims, n, 'Invalid input scale'),
          r(t[2].dims, n, 'Invalid input B'),
          r(t[3].dims, n, 'Invalid input mean'),
          r(t[4].dims, n, 'Invalid input var'));
      } else
        (r(t[1].dims, [1], 'Invalid input scale'),
          r(t[2].dims, [1], 'Invalid input B'),
          r(t[3].dims, [1], 'Invalid input mean'),
          r(t[4].dims, [1], 'Invalid input var'));
    }),
      (Dh = (t, e) => {
        let { epsilon: r, spatial: n, format: o } = e,
          i = t[0].dims,
          a = n ? fe(i[i.length - 1]) : 1,
          u = o === 'NHWC' && i.length > 1 ? a : 1,
          d = k.size(i) / a,
          c = n,
          p = c ? i.length : i,
          m = O('x', t[0].dataType, t[0].dims, a),
          g = O('scale', t[1].dataType, t[1].dims, u),
          y = O('bias', t[2].dataType, t[2].dims, u),
          b = O('inputMean', t[3].dataType, t[3].dims, u),
          _ = O('inputVar', t[4].dataType, t[4].dims, u),
          S = R('y', t[0].dataType, p, a),
          x = () => {
            let T = '';
            if (n)
              T = `let cOffset = ${i.length === 1 ? '0u' : o === 'NHWC' ? `outputIndices[${i.length - 1}] / ${a}` : 'outputIndices[1]'};`;
            else if (o === 'NCHW')
              T = `
    ...
    ${S.setByOffset('global_idx', 'value')}
        ...
        return {
          ...
          shaderCache: {
            ...
            inputDependencies: c ? ['rank', 'type', 'type', 'type', 'type'] : void 0,
          },
          getShaderSource: v,
          getRunData: () => ({
            outputs: [{ dims: t[0].dims, dataType: t[0].dataType }],
            dispatchGroup: { x: Math.ceil(d / 64) },
            programUniforms: c ? [{ type: 12, data: d }, ...W(i)] : [{ type: 12, data: d }],
          }),
        };
      }),
      (zh = (t) => J(t)),
      (vu = (t, e) => {
        let { inputs: r, outputCount: n } = t,
          o = zh({ ...e, outputCount: n });
        if ((_e.webgpu.validateInputContent && Oh(r, o), e.trainingMode))
    ...
    ((Bh = (t) => {
      ...
      (Mh = (t) => {
        ...
        return {
          name: 'BiasAdd',
          getRunData: () => ({
            outputs: [{ dims: e, dataType: t[0].dataType }],
...
var Rh,
  ...
  nn = V(() => {
    ...
    ((Rh = (t, e, r, n, o, i, a) => {
      ...
      let c = O('inputData', r, [u], 4),
        p = R('outputData', n, [u], 4),
        m = [{ name: 'vec_size', type: 'u32' }];
      return (
        a && m.push(...a),
        `
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset('global_idx', d)}
      ...
      (he = (t, e, r, n, o, i = t.dataType, a, u) => {
        ...
        return (
          a && d.push(...a),
          {
            ...
            getRunData: (c) => ({
              outputs: [{ dims: t.dims, dataType: i }],
        ...
        switch (e.to) {
          ...
          default:
            throw new RangeError(
              `not supported type (specified in attribute 'to' from 'Cast' operator): ${e.to}`,
            );
        }
      ...
      (Uh = (t) => {
        let e,
          r,
          n = t.length >= 2 && t[1].data !== 0,
          o = t.length >= 3 && t[2].data !== 0;
        switch (t[0].dataType) {
          case 1:
            ((e = n ? t[1].getFloat32Array()[0] : -34028234663852886e22),
              (r = o ? t[2].getFloat32Array()[0] : 34028234663852886e22));
            break;
          case 10:
            ((e = n ? t[1].getUint16Array()[0] : 64511),
              (r = o ? t[2].getUint16Array()[0] : 31743));
            break;
          default:
      ...
      (Bu = (t, e) => {
        let r = e || Uh(t.inputs),
          n = Ae(t.inputs[0].dataType);
        t.compute(
          he(
            t.inputs[0],
            'Clip',
            (o) => `clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,
            void 0,
            r.cacheKey,
            void 0,
            [
              { type: t.inputs[0].dataType, data: r.min },
              { type: t.inputs[0].dataType, data: r.max },
            ],
            [
              { name: 'min', type: n },
              { name: 'max', type: n },
...
fn erf_vf32(v: vec4<${t}>) -> vec4<${t}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      (Hu = (t, e) => {
        ...
        t.compute(
          he(
            t.inputs[0],
            'LeakyRelu',
            (n) => `select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,
            `const leaky_relu_alpha_ = ${r}(${e.alpha});`,
            e.cacheKey,
          ),
        );
      }),
      ...
      (ju = (t) => {
        let e = Ae(t.inputs[0].dataType);
        t.compute(
          he(t.inputs[0], 'Relu', (r) => `select(vec4<${e}>(0.0), ${r}, ${r} > vec4<${e}>(0.0))`),
        );
      }),
      (Zu = (t) => {
      ...
      (Xu = (t, e) => {
        ...
        t.compute(
          he(
            ...
            'HardSigmoid',
            (n) =>
              `max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${e.alpha} * ${n} + vec4<${r}>(${e.beta})))`,
            void 0,
            e.cacheKey,
          ),
        );
      ...
      (Yu = (t) => {
        ...
        t.compute(
          he(
            ...
            'HardSwish',
            (r) =>
              `${r} * max(vec4<${e}>(0.0), min(vec4<${e}>(1.0), vec4<${e}>(${e}(1.0 / 6.0)) * ${r} + vec4<${e}>(0.5)))`,
          ),
        );
      }),
      (Ju = (t) => {
      ...
      (nd = (t) => `sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`),
      (od = (t) => {
...
`),
      (vo = (t) =>
        `(fast_gelu_a + fast_gelu_a * tanh_v(${t} * (fast_gelu_c * ${t} * ${t} + fast_gelu_b))) * ${t}`),
      (id = (t) => {
        let e = Ae(t.inputs[0].dataType);
        ...
        return (
          t.compute(
            he(
              t.inputs[0],
              'ThresholdedRelu',
              (n) => `select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,
              `const thresholded_relu_alpha_ = vec4<${r}>(${e.alpha});`,
              e.cacheKey,
            ),
          ),
          0
...
`),
      (Vh = (t) => `quick_gelu_impl(${t})`),
      (ud = (t, e) => {
        let r = Ae(t.inputs[0].dataType);
        t.compute(
          he(t.inputs[0], 'QuickGelu', Vh, Nh(r, e.alpha), e.cacheKey, t.inputs[0].dataType),
        );
      }));
  });
var Lh,
  ...
  cd = V(() => {
    ...
    ((Lh = (t) => {
      ...
      (Wh = (t) => {
        ...
        e[2] = e[2] / 2;
        let r = O('input', t[0].dataType, t[0].dims, 4),
          n = O('bias', t[0].dataType, [t[0].dims[2]], 4),
          o = R('output', t[0].dataType, e, 4),
          i = k.size(e) / 4,
          a = we(t[0].dataType);
        return {
          name: 'BiasSplitGelu',
  ...
  vd = V(() => {
    ...
    ((Gh = (t, e, r, n, o, i, a, u, d, c, p, m) => {
      ...
      typeof u == 'string'
        ...
        : typeof u == 'function'
          ? (g = y = u)
          : ((g = u.scalar), (y = u.vector));
      let b = R('outputData', p, n.length, 4),
        _ = O('aData', d, e.length, 4),
        S = O('bData', c, r.length, 4),
        x;
      if (o)
        if (i) {
          let v = k.size(e) === 1,
            T = k.size(r) === 1,
            I = e.length > 0 && e[e.length - 1] % 4 === 0,
            E = r.length > 0 && r[r.length - 1] % 4 === 0;
          v || T
            ? (x = b.setByOffset(
                'global_idx',
                y(
                  v ? `${_.type.value}(${_.getByOffset('0')}.x)` : _.getByOffset('global_idx'),
                  T ? `${S.type.value}(${S.getByOffset('0')}.x)` : S.getByOffset('global_idx'),
                ),
              ))
            : (x = `
          ...
          x = b.setByOffset(
            'global_idx',
            y(_.getByOffset('global_idx'), S.getByOffset('global_idx')),
          );
      else {
        if (!i)
          throw new Error(
        ...
        let v = (T, I, E = '') => {
          let A = `aData[indexA${I}][componentA${I}]`,
            D = `bData[indexB${I}][componentB${I}]`;
          return `
      ...
      (Hh = (t, e, r, n, o, i, a = r.dataType) => {
        ...
        return (
          b.push(g),
          {
            ...
            getRunData: () => ({
              outputs: [{ dims: p, dataType: a }],
              dispatchGroup: { x: Math.ceil(m / 64 / 4) },
              programUniforms: [{ type: 12, data: Math.ceil(k.size(p) / 4) }, ...W(u, d, p)],
            }),
          }
        );
      }),
      ...
      (fd = (t) => {
        dt(
          t,
          'Equal',
          { scalar: (e, r) => `u32(${e}==${r})`, vector: (e, r) => `vec4<u32>(${e}==${r})` },
          void 0,
          void 0,
          9,
        );
      ...
      (jh = (t, e) => {
        ...
        for (let o = 0; o < r; ++o) {
          ...
          r === 1
            ? n.push(i)
            : o === 0
              ? n.push(`if (inputIndex == ${o}u) { ${i} }`)
              : o === r - 1
                ? n.push(`else { ${i} }`)
                : n.push(`else if (inputIndex == ${o}) { ${i} }`);
        }
        return n.join(`
`);
      }),
      (Zh = (t, e, r, n) => {
        ...
        for (let _ = 0; _ < t.length; ++_)
          ((u += t[_].dims[e]),
            (i[_] = u),
            c.push(t[_].dims.length),
            (a[_] = O(`input${_}`, n, c[_])),
            d.push('rank'),
            p.push({ type: 12, data: i[_] }));
        for (let _ = 0; _ < t.length; ++_) p.push(...W(t[_].dims));
        p.push(...W(r));
        let m = R('output', n, r.length),
          g = m.indicesGet('indices', e),
          y = Array.from(Array(i.length).keys())
            .map((_) => `uniforms.sizeInConcatAxis${_}`)
            .join(','),
          b = (_) => `
  ...
  ${_.mainStart()}
    ...
    ${jh(a, m)}
        ...
        return {
          name: 'Concat',
          shaderCache: { hint: `${e}`, inputDependencies: d },
          getRunData: () => ({
      ...
      (xd = (t, e) => {
        let r = t.inputs,
          n = r[0].dims,
          o = k.normalizeAxis(e.axis, n.length);
        qh(r, o);
        let i = n.slice();
...
var Qe,
  ...
  St = V(() => {
    ...
    ((Qe = (t, e, r = 'f32') => {
      ...
      (Xe = (t, e) => {
        t.activation === 'Clip'
          ? e.push({ type: 1, data: t.clipMax }, { type: 1, data: t.clipMin })
          : t.activation === 'HardSigmoid'
            ? e.push({ type: 1, data: t.alpha }, { type: 1, data: t.beta })
            : t.activation === 'LeakyRelu' && e.push({ type: 1, data: t.alpha });
      }),
      (Ye = (t, e) => {
        t.activation === 'Clip'
          ? e.push({ name: 'clip_max', type: 'f32' }, { name: 'clip_min', type: 'f32' })
          : t.activation === 'HardSigmoid'
            ? e.push({ name: 'alpha', type: 'f32' }, { name: 'beta', type: 'f32' })
            : t.activation === 'LeakyRelu' && e.push({ name: 'alpha', type: 'f32' });
      }),
      (on = (t) => {
        let e = t?.activation || '';
        if (e === 'HardSigmoid') {
...
`;
      ...
      (sn = (t, e, r, n, o = !1, i) => {
        ...
        let I = (E) => {
          let A = Yr('batch_dims', t[0].dataType, S.length),
            D = O('a', t[0].dataType, a.length, g),
            w = O('b', t[1].dataType, u.length, m),
            U = R('output', t[0].dataType, v.length, m),
            N = we(U.type.tensor),
            F = Qe(e, U.type.value, N),
            q = [D, w],
            Y = '';
          if (_) {
            let Q = o ? m : 1;
            (q.push(O('bias', t[2].dataType, t[2].dims.length, Q)),
              (Y = `${o ? `value += bias[col / ${Q}];` : `value += ${U.type.value}(bias[row + i]);`}`));
          }
          let z = [
...
`;
          ...
          return `
  ${E.registerUniforms(z)
    .registerInternalVariables(A)
  ...
  `;
        ...
        return {
          ...
          shaderCache: {
            ...
            inputDependencies: _ ? ['rank', 'rank', 'rank'] : ['rank', 'rank'],
          },
          getRunData: () => ({
            outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }],
            dispatchGroup: { x: Math.ceil(b / 64) },
            programUniforms: T,
          }),
          getShaderSource: I,
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      (So = (t, e, r = 'f32', n, o = !1, i = 32, a = !1, u = 32, d = !1) => {
        let c = t[1] * e[1],
          p = t[0] * e[0],
          m = o ? c : i,
          g = o ? i : c;
        if (!(g % e[1] === 0 && m % e[0] === 0 && i % e[1] === 0))
          throw new Error(
            `tileAHight ${g} must be divisible by workgroupSize[1]${e[1]}, tileAWidth ${m} must be divisible by workgroupSize[0]${e[0]}, tileInner ${i} must be divisible by workgroupSize[1]${e[1]}`,
          );
        let y = g / e[1],
          b = m / e[0],
          _ = i / e[1],
...
`;
    ...
    `;
      ...
      (ur = (t, e, r, n, o = !1, i) => {
        let a = t[0].dims,
          ...
          S = g <= 8 ? [4, 1, 1] : [4, 4, 1],
          x = [8, 8, 1],
          v = [Math.ceil(b / x[0] / S[0]), Math.ceil(g / x[1] / S[1]), Math.ceil(m / x[2] / S[2])],
          T = _ ? 4 : 1,
          I = [...d, g, y / T],
          E = I.length,
          A = [...c, y, b / T],
        ...
        let q = (Y) => {
          let z = p.length,
            L = Yr('batchDims', t[0].dataType, z, 1),
            Q = we(t[0].dataType),
            X = O('a', t[0].dataType, E, T),
            Z = O('b', t[1].dataType, D, T),
            ne = R('result', t[0].dataType, w.length, T),
            ie = [X, Z];
          if (F) {
            let G = o ? T : 1;
          ...
          Ye(e, le);
          let Me = we(ne.type.tensor),
            $e = Qe(e, ne.type.value, Me),
            M = Jh(T, F, $e, [L, X, Z, ne], o);
          return `
  ${Y.registerUniforms(le)
    .registerInternalVariables(L)
    .declareVariables(...ie, ne)}
  ${M}
  ${_ ? xo(S, x, Q, L) : So(S, x, Q, L)}
        ...
        return {
          name: 'MatMul',
          shaderCache: { hint: `${S};${e.activation};${_};${o}`, inputDependencies: N },
          getRunData: () => ({
            outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }],
...
var eg,
  ...
  Pd = V(() => {
    ...
    let coords = vec4<i32>(
      ...
      col % outWidth);
    `,
        b = t ? 'i32(uniforms.x_shape[1])' : 'i32(uniforms.x_shape[2])',
        _ = t ? 'i32(uniforms.x_shape[2])' : 'i32(uniforms.x_shape[3])',
        S = t ? 'row' : 'col',
        x = t ? 'col' : 'row',
        v = `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      (kd = (t, e, r, n, o, i, a, u, d) => {
        let c = e.format === 'NHWC',
          p = c ? t[0].dims[3] : t[0].dims[1],
          m = r[0],
          g = c ? r[2] : r[3],
          y = c ? r[1] : r[2],
          b = c ? r[3] : r[1],
          _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0,
          S = c ? b : g * y,
          x = c ? g * y : b,
          v = [8, 8, 1],
          T = n <= 8 ? [4, 1, 1] : [4, 4, 1],
          I = [Math.ceil(S / v[0] / T[0]), Math.ceil(x / v[1] / T[1]), Math.ceil(m / v[2] / T[2])];
        se('verbose', () => `[conv2d_mm_webgpu] dispatch = ${I}`);
        let E = _ ? (c && p % 4 !== 0 ? 3 : 4) : 1,
          A = v[1] * T[1],
          D = v[0] * T[0],
          w = Math.max(v[0] * E, v[1]),
          U = n % A === 0,
          N = o % D === 0,
          F = i % w === 0,
          q = _ ? [E, 4, 4] : [1, 1, 1],
          Y = [
            ...
            { type: 6, data: o },
            { type: 6, data: i },
            { type: 6, data: [e.pads[0], e.pads[1]] },
            { type: 6, data: e.strides },
            { type: 6, data: e.dilations },
          ];
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${ne}>` : ne}) {
        ...
        setOutputAtIndex(flatIndex ${_ ? '/ 4' : ''}, value);
            ...
            le = O('x', t[0].dataType, t[0].dims.length, E === 3 ? 1 : E),
            Me = O('w', t[1].dataType, t[1].dims.length, Z),
            $e = [le, Me],
            M = R('result', t[0].dataType, r.length, Z);
          if (a) {
        ...
        return {
          ...
          getRunData: () => ({
            outputs: [{ dims: d ? d(r) : r, dataType: t[0].dataType }],
            dispatchGroup: { x: I[0], y: I[1], z: I[2] },
            programUniforms: Y,
          }),
          getShaderSource: L,
        };
...
var tg,
  ...
  Md = V(() => {
    ...
    ((tg = (t) => {
      ...
      (Od = (t) => (typeof t == 'number' ? [t, t, t] : t)),
      (ln = (t, e) => (e <= 1 ? t : t + (t - 1) * (e - 1))),
      (rg = (t, e, r, n = 1) => {
        let o = ln(e, n);
      ...
      (Dd = (t, e, r, n, o) => {
        ...
        let i = [0, 0, 0, r];
        for (let a = 0; a < 3; a++)
          t[a] + 2 * o >= e[a] && (i[a] = Math.trunc((t[a] - e[a] + 2 * o) / n[a] + 1));
        return i;
      }),
      ...
      (zd = (t, e, r, n, o, i = !1, a = 'channelsLast') => {
        ...
        let [g, , y, b, _] = e,
          ...
          D = ln(b, I),
          w = ln(_, E),
          { padInfo: U, outDepth: N, outHeight: F, outWidth: q } = ng(o, d, c, p, S, x, v, A, D, w),
          Y = i ? g * m : g,
          z = [0, 0, 0, 0, 0];
        return (
          a === 'channelsFirst'
            ? (z = [u, Y, N, F, q])
            : a === 'channelsLast' && (z = [u, N, F, q, Y]),
          {
            batchSize: u,
            dataFormat: a,
            inDepth: d,
      ...
      (Bd = (t, e, r, n, o, i) => {
        let a = i === 'channelsLast',
          u = a ? t[0].dims[3] : t[0].dims[1],
          d = !1,
          c = [64, 1, 1],
          p = { x: r.map((v, T) => T) },
          m = [Math.ceil(tg(p.x.map((v) => r[v])) / c[0]), 1, 1];
        se('verbose', () => `[conv3d_naive_webgpu] dispatch = ${m}`);
        let g = d ? (a && u % 4 !== 0 ? 3 : 4) : 1,
          y = k.size(r),
          b = [
            { type: 12, data: y },
            { type: 12, data: n },
            { type: 12, data: o },
            { type: 12, data: e.strides },
            { type: 12, data: e.dilations },
          ];
        ...
        let x = (v) => {
          let T = [
            { name: 'output_size', type: 'u32' },
            { name: 'filter_dims', type: 'u32', length: n.length },
            { name: 'pads', type: 'u32', length: o.length },
            { name: 'strides', type: 'u32', length: e.strides.length },
            { name: 'dilations', type: 'u32', length: e.dilations.length },
          ];
          Ye(e, T);
          let I = d ? 4 : 1,
            E = we(t[0].dataType),
            A = O('x', t[0].dataType, t[0].dims.length, g === 3 ? 1 : g),
            D = O('W', t[1].dataType, t[1].dims.length, I),
            w = [A, D],
            U = R('result', t[0].dataType, r.length, I),
            N = '';
          if (S) {
        ...
        return {
          name: 'Conv3DNaive',
          shaderCache: { hint: `${e.cacheKey};${a};${g};${S}`, inputDependencies: _ },
          getRunData: () => ({
            outputs: [{ dims: r, dataType: t[0].dataType }],
            dispatchGroup: { x: m[0], y: m[1], z: m[2] },
            programUniforms: b,
          }),
          getShaderSource: x,
        };
...
var Rd,
    ...
    ((Rd = (t, e, r, n) => {
      let o = t.length > 2,
        ...
        y = [
          { type: 12, data: g },
          { type: 12, data: e.dilations },
          { type: 12, data: [e.strides[0], e.strides[1]] },
          { type: 12, data: [e.pads[0], e.pads[1]] },
          { type: 12, data: p },
        ];
      ...
      let _ = (S) => {
        let x = R('output', t[0].dataType, r.length, m),
          v = we(x.type.tensor),
          T = Qe(e, x.type.value, v),
          I = O('x', t[0].dataType, a.length),
          E = O('w', t[1].dataType, u.length, m),
          A = [I, E];
  ...
  ${S.mainStart()}
    ...
    ${x.setByOffset('global_idx', 'value')}
      ...
      return {
        name: 'GroupedConv',
        shaderCache: { hint: `${e.cacheKey}_${m}`, inputDependencies: b },
        getRunData: () => ({
          outputs: [{ dims: n ? n(r) : r, dataType: t[0].dataType }],
      ...
      (Ud = (t, e, r, n) => {
        let o = t.length > 2,
          ...
          a = fe(r[2]),
          u = k.size(r) / i / a,
          d = [t[0].dims[0], t[0].dims[1], t[0].dims[2], t[0].dims[3] / i],
          c = [t[1].dims[0], t[1].dims[1], t[1].dims[2], t[1].dims[3] / i],
          p = [r[0], r[1], r[2], r[3] / i],
          m = [
            { type: 12, data: u },
            { type: 6, data: [e.strides[0], e.strides[1]] },
            { type: 6, data: [e.pads[0], e.pads[1]] },
          ];
        (Xe(e, m), m.push(...W(d, c, p)));
        let g = (a - 1) * e.strides[1] + c[1],
          y = (b) => {
            let _ = R('output', t[0].dataType, p.length, i),
              S = we(_.type.tensor),
              x = Qe(e, _.type.value, S),
              v = O('x', t[0].dataType, d.length, i),
              T = O('w', t[1].dataType, c.length, i),
              I = [v, T];
            o && I.push(O('b', t[2].dataType, t[2].dims, i));
            let E = o ? 'value += b[output_channel];' : '',
              A = [
                { name: 'output_size', type: 'u32' },
...
var og,
  ...
  Ld = V(() => {
    ...
    ((og = (t, e, r, n, o, i) => {
      let a = t[0],
        u = t.slice(i ? 1 : 2, i ? 3 : 4),
        d = u.length,
        c = e[0],
        m = e.slice(2).map((b, _) => b + (b - 1) * (r[_] - 1)),
        y = u
          .map((b, _) => b + n[_] + n[_ + d])
          .map((b, _) => Math.floor((b - m[_] + o[_]) / o[_]));
      ...
      (ig = (t, e) => {
        ...
        let r = t[0].dims[e.format === 'NHWC' ? t[0].dims.length - 1 : 1],
          n = t[1].dims[1] * e.group;
      ...
      (Io = (t, e) => {
        ...
        r.length < e[1].dims.length - 2 &&
          r.push(...Array(e[1].dims.length - 2 - r.length).fill(0));
        for (let i = 2; i < e[1].dims.length; ++i) r[i - 2] === 0 && (r[i - 2] = e[1].dims[i]);
        let n = t.pads.slice();
        zt.adjustPadsBasedOnAutoPad(
          e[0].dims,
          t.strides,
          t.dilations,
          r,
      ...
      (Co = (t) => {
        let e = on(t),
          r = t.format,
          n = ['NOTSET', 'VALID', 'SAME_UPPER', 'SAME_LOWER'][t.auto_pad],
          o = t.dilations,
          i = t.group,
          a = t.kernel_shape,
          u = t.pads,
      ...
      (Vd = (t, e, r, n) => {
        let o = r.format === 'NHWC',
          i = og(e[0].dims, e[1].dims, r.dilations, r.pads, r.strides, o);
        if (r.group !== 1) {
          let A = [e[0]];
          if (o) {
            let w =
              t.kernelCustomData.wT ??
              t.compute(ze(e[1], To), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
            (r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = w), A.push(w));
          } else A.push(e[1]);
          (e.length === 3 && A.push(e[2]),
            !t.adapterInfo.isArchitecture('ampere') &&
            o &&
            e[1].dims[0] === r.group &&
            e[1].dims[1] === 1 &&
            r.dilations[0] === 1 &&
            r.dilations[1] === 1
              ? t.compute(Ud(A, r, i, n), { inputs: A })
              : t.compute(Rd(A, r, i, n), { inputs: A }));
          return;
        }
        let a = e.length === 3,
          u = e[0].dims[o ? 1 : 2],
          ...
          y = i[o ? 2 : 3],
          b = i[o ? 3 : 1],
          _ = o && p === u && m === d && r.pads[0] === 0 && r.pads[1] === 0;
        if (
          _ ||
          (p === 1 &&
            m === 1 &&
          ...
          if (o) {
            ...
            if ((r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = Y), _)) {
              ...
              ((D = e[0].reshape([A, u * d, c])), (w = Y.reshape([1, c, b])), (U = [A, g * y, b]));
            (N.push(D), N.push(w));
          } else
            ((D = e[0].reshape([A, c, u * d])),
              (w = e[1].reshape([1, b, c])),
              (U = [A, b, g * y]),
              N.push(w),
              N.push(D));
          a && N.push(e[2]);
          let F = U[2],
            q = N[0].dims[N[0].dims.length - 1];
          F < 8 && q < 8
            ? t.compute(sn(N, r, i, U, o, n), { inputs: N })
            : t.compute(ur(N, r, i, U, o, n), { inputs: N });
          return;
        }
        let S = !0,
          x =
      ...
      (ag = (t, e) => {
        let r = e.format === 'NHWC',
          n = [
            t.inputs[0].reshape(
              r
                ? [t.inputs[0].dims[0], 1, t.inputs[0].dims[1], t.inputs[0].dims[2]]
                : [t.inputs[0].dims[0], t.inputs[0].dims[1], 1, t.inputs[0].dims[2]],
            ),
            t.inputs[1].reshape([t.inputs[1].dims[0], t.inputs[1].dims[1], 1, t.inputs[1].dims[2]]),
          ];
        t.inputs.length === 3 && n.push(t.inputs[2]);
        let o = [0, e.pads[0], 0, e.pads[1]],
          i = [1].concat(e.strides),
          a = [1].concat(e.dilations),
          u = [1].concat(e.kernelShape),
          d = Io({ ...e, pads: o, strides: i, dilations: a, kernelShape: u }, n);
        Vd(t, n, d, (c) => (r ? [c[0], c[2], c[3]] : [c[0], c[1], c[3]]));
      }),
      (sg = (t, e, r) => {
        let n = r.format === 'NHWC' ? 'channelsLast' : 'channelsFirst',
          o = Io(r, e),
          i = r.autoPad === 'NOTSET' ? r.pads : r.autoPad,
          a = zd(e[0].dims, e[1].dims, r.strides, r.dilations, i, !1, n);
        t.compute(
          Bd(
            e,
            o,
            a.outShape,
            [a.filterDepth, a.filterHeight, a.filterWidth],
            [a.padInfo.front, a.padInfo.top, a.padInfo.left],
            n,
          ),
        );
      }),
  ...
  Gd = V(() => {
    ...
    Wd = (t, e, r) => {
      let n = t.length > 2,
        ...
        p = i ? fe(d) : 1,
        m = i && c === 1 && d >= 4,
        g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p,
        y = d - g,
        b = i ? fe(c) : 1,
        _ = i ? (c === 1 ? p : b) : 1,
        S = k.size(o) / b,
        x = [Math.ceil(S / 64), 1, 1];
      se('verbose', () => `[conv2d_backprop_webgpu] dispatch = ${x}`);
      let v = ['rank', 'rank'],
        T = [e.strides[0], e.strides[1]],
        I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]],
        E = [e.dilations[0], e.dilations[1]],
        A = [
      ...
      let U = (N) => {
        let F = [
            ...
            { name: 'filter_dims', type: 'u32', length: I.length },
            { name: 'dilations', type: 'u32', length: I.length },
            { name: 'effective_filter_dims', type: 'u32', length: A.length },
            { name: 'pads', type: 'i32', length: D.length },
          ...
          z = i ? 2 : 3,
          L = i ? 3 : 1,
          Q = O('W', t[1].dataType, t[1].dims.length, _),
          X = O('Dy', t[0].dataType, t[0].dims.length, p),
          Z = [X, Q];
        n && Z.push(O('bias', t[2].dataType, [o[L]].length, b));
        let ne = R('result', t[0].dataType, o.length, b),
          ie = () => {
            let $e = '';
            if (m)
              p === 4
    ...
    ${Me}}`;
      ...
      return {
        ...
        shaderCache: { hint: `${e.cacheKey};${p}${_}${b}${m}${y}`, inputDependencies: v },
        getRunData: () => ({
          dispatchGroup: { x: x[0], y: x[1], z: x[2] },
          outputs: [{ dims: r ? r(o) : o, dataType: t[0].dataType }],
          programUniforms: w,
        }),
        getShaderSource: U,
      };
...
var ug,
  ...
  jd = V(() => {
    ...
    St();
    pt();
    ((ug = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i),
      (dg = (t, e, r, n, o) => {
        let i = Math.floor(t / 2);
        e === 'SAME_UPPER'
          ? ((r[n] = i), (r[o] = t - i))
          : e === 'SAME_LOWER' && ((r[n] = t - i), (r[o] = i));
      }),
      (lg = (t, e, r, n, o, i, a, u, d, c) => {
        ...
        for (let b = 0, _ = t.length - p - (u ? 1 : 0); b < p; ++b, ++_) {
          let S = t[_],
            x = m ? S * a[b] : c[b],
            v = ug(S, a[b], i[b], e[_], r[b], x);
          (dg(v, n, i, b, b + p),
            m && c.push(a[b] * (S - 1) + d[b] + (e[_] - 1) * r[b] + 1 - i[b] - i[b + p]));
        }
      ...
      (Fd = (t) => {
        let e = on(t),
          ...
          n = ['NOTSET', 'VALID', 'SAME_UPPER', 'SAME_LOWER'][
            typeof t.autoPad > 'u' ? 0 : t.autoPad
          ],
          o = t.dilations,
          i = t.group ?? 1,
          a = t.kernelShape,
      ...
      (cg = (t, e) => {
        ...
        if (
          e.kernelShape.reduce((p, m) => p + m, 0) > 0 &&
          e.kernelShape.length !== 0 &&
          e.kernelShape.length !== t[1].dims.length - 2
        )
          throw new Error('invalid kernel shape');
      ...
      (qd = (t, e, r, n) => {
        let o =
          t.kernelCustomData.wT ??
          t.compute(ze(e[1], [2, 3, 0, 1]), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
      ...
      (pg = (t, e) => {
        ...
        d = [0].concat(d);
        let c = Hd(
          { ...e, pads: u, strides: a, dilations: i, kernelShape: o, outputPadding: d },
          n,
        );
  ...
  Xd = V(() => {
    ...
    ((mg = (t, e, r, n) => {
      let o = k.size(e),
        ...
        a = O('input', t, i),
        u = R('output', t, i),
        d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]),
        c = k.normalizeAxis(d, i),
        p = (m) => {
          let g = ` i32(${a.indicesGet('inputIndices', 'uniforms.axis')}) `,
            y = j('uniforms.input_shape', 'uniforms.axis', i),
            b = n.reverse ? g + (n.exclusive ? ' + 1' : '') : '0',
            _ = n.reverse ? y : g + (n.exclusive ? '' : ' + 1');
          return `
      ...
      return {
        ...
        getRunData: () => ({
          outputs: [{ dims: e, dataType: t }],
          dispatchGroup: { x: Math.ceil(o / 64) },
          programUniforms: [{ type: 12, data: o }, { type: 12, data: c }, ...W(e, e)],
        }),
        getShaderSource: p,
      };
    }),
      (Zd = (t, e) => {
        let r = t.inputs[0].dims,
          n = t.inputs[0].dataType,
          o = t.inputs[1];
...
`)
      ...
      (gg = (t, e) => {
        ...
        d
          ? (([r, n, o, i] = t.dims),
            (a = p ? [r, n, o, c, c, i / c ** 2] : [r, n, o, i / c ** 2, c, c]),
            (u = p ? [0, 1, 3, 2, 4, 5] : [0, 1, 4, 2, 5, 3]))
          : (([r, n, o, i] = [t.dims[0], t.dims[2], t.dims[3], t.dims[1]]),
            (a = p ? [r, c, c, i / c ** 2, n, o] : [r, i / c ** 2, c, c, n, o]),
            (u = p ? [0, 3, 4, 1, 5, 2] : [0, 1, 4, 2, 5, 3]));
        let m = t.reshape(a),
          g = m.dims.length,
          y = t.dataType,
          b = O('a', y, g),
  ...
  ${x.mainStart()}
    ...
    ${_.setByOffset('global_idx', b.getByIndices('aIndices'))}
        ...
        return {
          name: 'DepthToSpace',
          shaderCache: { hint: `${t.dims};${e.blocksize};${e.mode}`, inputDependencies: ['rank'] },
          getRunData: (x) => {
            let v = d ? [r, n * c, o * c, i / c ** 2] : [r, i / c ** 2, n * c, o * c],
              T = k.size(v),
              I = m.dims,
              E = k.sortBasedOnPerm(I, u);
            return {
              outputs: [{ dims: v, dataType: x[0].dataType }],
              dispatchGroup: { x: Math.ceil(T / 64) },
              programUniforms: [{ type: 12, data: T }, ...W(I, E)],
            };
          },
          getShaderSource: S,
        };
  ...
  ul = V(() => {
    ...
    ((Tt = 256),
      ...
      (bg = (t, e, r, n, o) => {
        let i = r / t,
          a = cn - n,
          u = (c) => `smem[${a}u + base + ${c * e}u]`,
          d = `  for (var t = local_idx; t < ${i}u; t += ${Tt}u) {
`;
...
`;
        ...
        if (
          ((d += `    let base = (t / ${e}u) * ${e * t}u + twiddleIndex;
`),
          t === 2)
        )
          d += `    ${u(0)} = leg[0] + leg[1];
          ...
          for (let c = 0; c < t; c++) {
            ...
            for (let m = 1; m < t; m++) {
              let g = (o * Eo * (m * c)) / t,
                ...
                b = Rt(Math.sin(g));
              p.push(
                `vec2<f32>(leg[${m}].x*${y} - leg[${m}].y*${b}, leg[${m}].x*${b} + leg[${m}].y*${y})`,
              );
            }
            d += `    ${u(c)} = ${p.join(' + ')};
`;
...
`;
      ...
      (nl = (t, e) =>
        [e, t.length, t.inputComponents, t.outputComponents, t.inverse, t.onesided].join(';')),
      (ol = (t) => [
        { type: 12, data: t.batch },
        { type: 12, data: t.signalLength },
        { type: 12, data: t.inner },
        { type: 12, data: t.outputLength },
      ]),
      (il = (t, e, r) =>
        t
            ...
            let y = O('x', e, [1]),
              ...
              _ = (E) => {
                let A = `inBase + (${E}) * uniforms.inner * ${n}u`,
                  D = `f32(${y.getByOffset(A)})`,
                  w = n === 2 ? `f32(${y.getByOffset(`${A} + 1u`)})` : '0.0';
                return `vec2<f32>(${D}, ${w})`;
              },
              S;
            if (i && a) {
              let E = Math.floor(r / 2) + 1,
                A = r % 2 === 0 ? `select(provided, provided - 1u, provided == ${E}u)` : 'provided';
              S = `
    ...
    workgroupBarrier();`;
            let { code: x, resultOffset: v } = yg(p, r, d),
              T = c === 1 ? `smem[${v}u + i]` : `smem[${v}u + i] * ${Rt(c)}`,
              I = o === 2 ? b.setByOffset('off + 1u', `${u}(v.y)`) : '';
            return `
  ${il(g, y, b)}
...
${x}    for (var i = local_idx; i < uniforms.outputLength; i += ${Tt}u) {
      ...
      ${I}
        ...
        return {
          name: 'DFT',
          shaderCache: { hint: nl(t, 'fft'), inputDependencies: ['type'] },
          getShaderSource: m,
          getRunData: () => ({
            outputs: [{ dims: t.outputDims, dataType: e }],
            ...
            let g = O('x', e, [1]),
              ...
              b = (T) => {
                let I = `inBase + (${T}) * uniforms.inner * ${n}u`,
                  E = `f32(${g.getByOffset(I)})`,
                  A = n === 2 ? `f32(${g.getByOffset(`${I} + 1u`)})` : '0.0';
                return `vec2<f32>(${E}, ${A})`;
              },
              _ =
                i && a
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      knMod += k;
      if (knMod >= ${r}u) { knMod -= ${r}u; }`,
              x = o === 2 ? y.setByOffset('off + 1u', `${u}(v.y)`) : '',
              v = c === 1 ? 'acc' : `acc * ${Rt(c)}`;
            return `
  ${il(m, g, y)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
  ...
  ${m.mainStart(Tt)}
    ...
    for (var k = local_idx; k < uniforms.outputLength; k += ${Tt}u) {
      ...
      ${x}
        ...
        return {
          name: 'DFT',
          shaderCache: { hint: nl(t, 'direct'), inputDependencies: ['type'] },
          getShaderSource: p,
          getRunData: () => ({
            outputs: [{ dims: t.outputDims, dataType: e }],
            programUniforms: ol(t),
...
var ko,
  ...
  ml = V(() => {
    ...
    ((ko = '[a-zA-Z]|\\.\\.\\.'),
          ...
          return (
            c?.forEach((m, g) => {
              if (m === '...') {
                ...
                (p.addSymbol(m, g + (this.hasEllipsis ? this.ellipsisDims.length - 1 : 0)),
                  this.addSymbol(m, n[d++], o));
            }),
            p
          );
        }
      ...
      (ll = (t) => t + '_max'),
      (Tg = (t, e, r, n) => {
        let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)),
          a = k.size(n),
          u = R('output', e, n.length),
          d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)),
          c = (p) => {
            let m = [],
              g = 'var prod = 1.0;',
              y = 'var sum = 0.0;',
              ...
              x = [],
              v = [],
              T = r.symbolToInfo.size === r.rhs.symbolToIndices.size;
            r.symbolToInfo.forEach((E, A) => {
              if (r.rhs.symbolToIndices.has(A)) {
                ...
                D !== void 0 &&
                  r.lhs.forEach((w, U) => {
                    if (E.inputIndices.includes(U)) {
                      ...
                      N.forEach((F) => {
                        m.push(
                          `${i[U].indicesSet(`input${U}Indices`, F, u.indicesGet('outputIndices', D))}`,
                        );
                      });
                    }
                  });
                ...
                (r.lhs.forEach((D, w) => {
                  ...
                  S.push(`for(var ${A}: u32 = 0; ${A} < uniforms.${ll(A)}; ${A}++) {`),
                  x.push('}'));
            });
            let I = T
              ? [
            ...
            return `
            ${p
              .registerUniforms(d.map((E) => ({ name: `${ll(E)}`, type: 'u32' })))
              .registerUniform('outputSize', 'u32')
              .declareVariables(...i, u)}
...
`)};
        ...
        return {
          name: 'Einsum',
          shaderCache: { hint: r.equation, inputDependencies: t.map(() => 'rank') },
          getRunData: () => {
            let p = d
              .filter((g) => r.symbolToInfo.has(g))
              .map((g) => ({ type: 12, data: r.symbolToInfo.get(g)?.dimValue || 0 }));
            p.push({ type: 12, data: a });
            let m = t.map((g, y) => [...W(g)]).reduce((g, y) => g.concat(y), p);
            return (
              m.push(...W(n)),
              {
                outputs: [{ dims: n, dataType: e }],
      ...
      (cl = (t, e) => {
        let r = new Oo(t.inputs, e.equation),
          n = r.outputDims,
          o = t.inputs.map((i, a) => i.dims);
...
var Ig,
  ...
  gl = V(() => {
    ...
    ((Ig = (t) => {
      ...
      let e = t[0].dims,
        r = Array.from(t[1].getBigInt64Array(), Number),
        n = r.length < e.length ? 0 : r.length - e.length,
        o = e.length < r.length ? 0 : e.length - r.length;
      ...
      (Cg = (t, e) => (t.length > e.length ? fl(t, e) : fl(e, t))),
      (Ag = (t) => {
        let e = t[0].dims,
          r = Array.from(t[1].getBigInt64Array(), Number),
          n = Cg(e, r),
          o = t[0].dataType,
          i = o === 9 || k.size(e) === 1,
          a = o === 9 || (e.length > 0 && e[e.length - 1] % 4 === 0) ? 4 : 1,
          u = i || (n.length > 0 && n[n.length - 1] % 4 === 0) ? 4 : 1,
          d = Math.ceil(k.size(n) / u),
          c = (m) => {
            let g = O('input', o, e.length, a),
              y = R('output', o, n.length, u),
              b;
            if (o === 9) {
              let _ = (S, x, v = '') => `
    ...
    ${b}`;
        ...
        return {
          name: 'Expand',
          shaderCache: { hint: `${n.length};${a}${u}`, inputDependencies: ['rank'] },
          getShaderSource: c,
          getRunData: () => ({
            outputs: [{ dims: n, dataType: t[0].dataType }],
            dispatchGroup: { x: Math.ceil(d / 64) },
            programUniforms: p,
          }),
        };
...
var Eg,
  ...
  yl = V(() => {
    ...
    ((Eg = (t) => {
      ...
      let bias${y} = ${d.getByOffset(`bias${y}_offset / 4`)}[bias${y}_offset % 4];`,
            g = o
              ? `
    ...
    ((kg = (t) => {
      ...
      (Pg = (t, e) => {
        let r = t[0].dims,
          n = t[1].dims,
          o = r.length,
          i = k.normalizeAxis(e.axis, o),
          a = r.slice(0);
        a.splice(i, 1, ...n);
        let u = r[i],
          d = t[0].dataType === 9 ? 4 : 1,
          c = Math.ceil(k.size(a) / d),
          p = [
            { type: 12, data: c },
            { type: 6, data: u },
            { type: 12, data: i },
          ...
          m = (g) => {
            let y = O('data', t[0].dataType, t[0].dims.length, d),
              b = O('inputIndices', t[1].dataType, t[1].dims.length),
              _ = R('output', t[0].dataType, a.length, d),
              S = (v) => {
                let T = n.length,
                  I = `var indicesIndices${v}  = ${b.type.indices}(0);`;
                for (let E = 0; E < T; E++)
                  I += `${T > 1 ? `indicesIndices${v}[${E}]` : `indicesIndices${v}`} = ${a.length > 1 ? `outputIndices${v}[uniforms.axis + ${E}]` : `outputIndices${v}`};`;
                I += `
        ...
        `;
                for (let E = 0, A = 0; E < o; E++)
                  E === i
                    ? ((I += `${o > 1 ? `dataIndices${v}[${E}]` : `dataIndices${v}`} = u32(idx${v});`),
                      (A += T))
                    : ((I += `${o > 1 ? `dataIndices${v}[${E}]` : `dataIndices${v}`} = ${a.length > 1 ? `outputIndices${v}[${A}]` : `outputIndices${v}`};`),
                      A++);
                return I;
              },
              x;
      ...
      ${g.mainStart()}
        ...
        return {
          name: 'Gather',
          shaderCache: { hint: e.cacheKey, inputDependencies: ['rank', 'rank'] },
          getRunData: () => ({
            outputs: [{ dims: a, dataType: t[0].dataType }],
...
var Og,
  ...
  Sl = V(() => {
    ...
    ((Og = (t, e, r, n, o, i, a, u, d) => {
      ...
      c.push(...W(e.dims, p));
      let m = (g) => {
        let y = O('indices_data', e.dataType, e.dims.length),
          b = R('input_slice_offsets_data', 12, 1, 1),
          _ = [y, b],
          S = [
            { name: 'output_size', type: 'u32' },
            { name: 'batch_dims', type: 'u32' },
            { name: 'input_dims', type: 'u32', length: o.length },
            { name: 'sizes_from_slice_dims_data', type: 'u32', length: r.length },
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      return t.compute(
        {
          ...
          shaderCache: { hint: `${o.length}_${r.length}`, inputDependencies: ['rank'] },
          getRunData: () => ({
            outputs: [{ dims: p, dataType: t.inputs[1].dataType }],
            dispatchGroup: { x: Math.ceil(i / 64) },
            programUniforms: c,
          }),
          getShaderSource: m,
      ...
      (vl = (t, e) => {
        let r = t.inputs,
          ...
          i = r[1].dims,
          a = i[i.length - 1],
          u = k.sizeToDimension(i, i.length - 1),
          d = k.sizeFromDimension(n, e.batchDims + a),
          c = k.sizeToDimension(n, e.batchDims),
          p = k.sizeFromDimension(n, e.batchDims),
          m = u / c,
          g = new Array(a),
          y = d;
        for (let I = 0; I < a; ++I) ((g[a - 1 - I] = y), (y *= n[e.batchDims + a - 1 - I]));
        let b = Og(t, r[1], g, e.batchDims, n, u, m, p, a),
          _ = e.batchDims + a;
        if (_ > n.length)
          throw new Error('last dimension of indices must not be larger than rank of input tensor');
        let S = i.slice(0, -1).concat(n.slice(_)),
          x = k.size(S),
          v = [{ type: 12, data: x }, { type: 12, data: d }, ...W(r[0].dims, b.dims, S)],
          T = (I) => {
            let E = O('data', r[0].dataType, r[0].dims.length),
              A = O('slice_offsets', 12, b.dims.length),
              D = R('output', r[0].dataType, S.length);
            return `
...
var Dg,
  ...
  Cl = V(() => {
    ...
    ((Dg = (t, e) => {
      ...
      let r = k.normalizeAxis(e.quantizeAxis, t[0].dims.length),
        n = e.blockSize,
        o = t[0],
        i = t[2],
      ...
      if (
        ...
        !o.dims
          .map((u, d) => (d === r ? Math.ceil(u / n) === i.dims[d] : u === i.dims[d]))
          .reduce((u, d) => u && d, !0)
      )
        throw new Error(
      ...
      if (a) {
        if (a.dataType !== o.dataType)
          throw new Error('Zero point must have the same data type as the input tensor.');
        if (
          a.dims.length !== i.dims.length ||
          !a.dims.map((u, d) => u === i.dims[d]).reduce((u, d) => u && d, !0)
        )
          throw new Error(
      ...
      (zg = (t, e) => {
        let r = t[0].dims,
          n = t[1].dims,
          o = r.length,
          i = k.normalizeAxis(e.gatherAxis, o),
          a = k.normalizeAxis(e.quantizeAxis, o),
          u = r.slice(0);
        u.splice(i, 1, ...n);
        let d = k.size(u),
          c = t[2].dataType,
          ...
          g = [
            ...
            { type: 12, data: a },
            { type: 12, data: i },
            { type: 12, data: e.blockSize },
            ...W(...t.map((b, _) => b.dims), u),
          ],
          y = (b) => {
            let _ = O('data', t[0].dataType, t[0].dims.length),
              S = O('inputIndices', t[1].dataType, t[1].dims.length),
              x = O('scales', t[2].dataType, t[2].dims.length),
              v = t.length > 3 ? O('zeroPoint', t[3].dataType, t[3].dims.length) : void 0,
              T = R('output', c, u.length),
              I = [_, S, x];
            v && I.push(v);
            let E = [
              { name: 'output_size', type: 'u32' },
      ...
      (Il = (t) =>
        J({ blockSize: t.blockSize, gatherAxis: t.gatherAxis, quantizeAxis: t.quantizeAxis })));
  });
var Bg,
  Mg,
  Al,
    ...
    ((Bg = (t) => {
      ...
      (Mg = (t, e) => {
        let r = t[0].dims,
          ...
          i = t[1].dims,
          a = t[1].dataType,
          u = k.normalizeAxis(e.axis, o),
          d = r[u],
          c = i.slice(0),
          p = k.size(c),
          m = O('input', n, o),
          g = O('indicesInput', a, i.length),
          y = R('output', n, c.length),
          b = [
            { type: 12, data: p },
            { type: 6, data: d },
            { type: 12, data: u },
        ...
        return (
          b.push(...W(r, i, c)),
          {
            ...
            getRunData: () => ({
              outputs: [{ dims: c, dataType: t[0].dataType }],
...
var Rg,
  ...
  Dl = V(() => {
    ...
    ((Rg = (t) => {
      ...
      (Ug = (t, e) => {
        let r = t[0].dims.slice(),
          n = t[1].dims.slice(),
          [o, i, a] = Hr.getShapeOfGemmResult(
            r,
            e.transA,
            n,
            e.transB,
        ...
        let _ = (x) => {
            let v = '';
            e.transA && e.transB
              ? (v = 'value += a[k * uniforms.M + m] * b[n * uniforms.K + k];')
              : e.transA && !e.transB
                ? (v = 'value += a[k * uniforms.M + m] * b[k * uniforms.N + n];')
                : !e.transA && e.transB
                  ? (v = 'value += a[m * uniforms.K + k] * b[n * uniforms.K + k];')
                  : !e.transA &&
                    !e.transB &&
                    (v = 'value += a[m * uniforms.K + k] * b[k * uniforms.N + n];');
            let T = e.alpha === 1 ? '' : 'value *= uniforms.alpha;',
              I = O('a', t[0].dataType, t[0].dims),
              E = O('b', t[1].dataType, t[1].dims),
              A = I.type.value,
              D = null,
              w = [I, E];
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
          ...
          S = (x) => {
            let v = O('a', t[0].dataType, t[0].dims),
              T = O('b', t[1].dataType, t[1].dims),
              I = null,
              E = [v, T];
      ...
      `),
                (w = 'value += tile_a[k][local_id.y] * tile_b[local_id.x][k];'))
              : e.transA && !e.transB
                ? ((U = `
      var col = tile_row_start + local_id.x;
      var row = k_start + local_id.y;
      ...
      `),
                  (w = 'value += tile_a[k][local_id.y] * tile_b[k][local_id.x];'))
                : !e.transA && e.transB
                  ? ((U = `
      ...
      `),
                    (w = 'value += tile_a[local_id.y][k] * tile_b[local_id.x][k];'))
                  : !e.transA &&
                    !e.transB &&
                    ((U = `
      var col = k_start + local_id.x;
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        return m
          ? {
              name: 'GemmShared',
              shaderCache: { hint: `${e.cacheKey}`, inputDependencies: b },
              getRunData: () => ({
                outputs: [{ dims: u, dataType: t[0].dataType }],
                dispatchGroup: { x: c * p },
                programUniforms: y,
              }),
              getShaderSource: S,
...
`),
      (Fg = (t, e, r) =>
        ...
        })() + `${t.setByOffset('global_idx', 'result')}`),
      (qg = (t, e) => {
        let r = O('x', t[0].dataType, t[0].dims.length),
          n = [t[1].dims[0], t[1].dims[1], t[1].dims[2]],
          o = O('grid', t[1].dataType, n.length, 2),
          i = [t[0].dims[0], t[0].dims[1], t[1].dims[1], t[1].dims[2]];
        e.format === 'NHWC' &&
          ((i = [t[0].dims[0], t[1].dims[1], t[1].dims[2], t[0].dims[3]]),
          ([mt, It, qt, Kt] = [0, 3, 1, 2]));
        let a = R('output', t[0].dataType, i.length),
          u = r.type.value,
          d = k.size(i),
          c = [{ type: 12, data: d }, ...W(t[0].dims, n, i)],
          p = (m) => `
  ...
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
      ...
      ${Fg(a, u, e)}
        ...
        return {
          name: 'GridSample',
          shaderCache: { hint: `${e.cacheKey}`, inputDependencies: ['type', 'type'] },
          getRunData: (m) => {
            let g = k.size(i);
            return {
              outputs: [{ dims: i, dataType: m[0].dataType }],
              dispatchGroup: { x: Math.ceil(g / 64) },
              programUniforms: c,
            };
          },
...
var Ue,
  ...
  Do = V(() => {
    ...
    oe();
    pt();
    ((Ue = (t, e) => (t.length > e && t[e].dims.length > 0 ? t[e] : void 0)),
      (Zg = (t, e) => {
        let r = t[0],
          n = Ue(t, 1),
          o = Ue(t, 2),
        ...
        let p = r.dims[0],
          m = r.dims[1],
          g = r.dims.length === 3 ? r.dims[2] : e.numHeads * r.dims[4],
          y = m,
          b = 0,
          _ = 0,
          S = Math.floor(g / e.numHeads);
        ...
        if (u && k.size(u.dims) > 0) {
          ...
          if (u.dims[0] !== p || u.dims[1] !== e.numHeads || u.dims[2] !== m || u.dims[3] !== v)
            throw new Error(
              'Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)',
            );
        }
      ...
      (Qg = (t, e, r, n, o, i, a) => {
        let u = [n, o, i],
          ...
          p = (m) => {
            let g = R('qkv_with_bias', e.dataType, u),
              y = O('qkv', e.dataType, u),
              b = O('bias', r.dataType, u),
              _ = [
                { name: 'output_size', type: 'u32' },
        ...
        return t.compute(
          {
            ...
            getRunData: () => ({
              outputs: [{ dims: u, dataType: e.dataType, gpuDataType: 0 }],
              dispatchGroup: { x: Math.ceil(d / 64) },
              programUniforms: c,
            }),
            getShaderSource: p,
          },
          { inputs: [e, r], outputs: [-1] },
        )[0];
      }),
      (dr = (t, e, r, n, o, i, a, u) => {
        let d = i;
        if (a && k.size(a.dims) > 0) {
          ...
          return (
            (d = Qg(t, i, a, e, n, r * o, u)),
            (d = d.reshape([e, n, r, o])),
            r === 1 || n === 1 ? d : t.compute(ze(d, Rl.perm), { inputs: [d], outputs: [-1] })[0]
          );
        } else
          return (
            i.dims.length === 3 && (d = i.reshape([e, n, r, o])),
            r === 1 || n === 1 ? d : t.compute(ze(d, Rl.perm), { inputs: [d], outputs: [-1] })[0]
          );
      }),
      (Nl = (t, e) => {
        ...
        let m = o && i && o.dims.length === 4 && i.dims.length === 4,
          g = dr(t, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, a, 0);
        if (m) return Ft(t, g, o, i, u, void 0, c, p, d, r);
        if (!o || !i) throw new Error('key and value must be provided');
        let y = dr(t, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, a, r.hiddenSize),
          b = dr(
            t,
            r.batchSize,
            r.numHeads,
  ...
  Bo = V(() => {
    ...
    ((Xg = (t) => {
      ...
      (Yg = (t, e) => {
        ...
        return (
          t[1].dims[0] > 0 &&
            (t[1].getBigInt64Array().forEach((o) => r.push(Number(o))), (n = r.length)),
          J({ numOutputs: n, axis: e.axis, splitSizes: r })
        );
      }),
      (Jg = (t) => `
      ...
      (eb = (t) => {
        ...
        for (let n = 0; n < e; ++n) {
          ...
          e === 1
            ? r.push(o)
            : n === 0
              ? r.push(`if (output_number == ${n}u) { ${o} }`)
              : n === e - 1
                ? r.push(`else { ${o} }`)
                : r.push(`else if (output_number == ${n}) { ${o} }`);
        }
        return `
...
`)}
      ...
      (zo = (t, e) => {
        let r = t[0].dims,
          n = k.size(r),
          o = t[0].dataType,
          i = k.normalizeAxis(e.axis, r.length),
          a = new Array(e.numOutputs),
          u = O('input', o, r.length),
          d = new Array(e.numOutputs),
          c = [],
          p = [],
          m = 0,
          g = [{ type: 12, data: n }];
        for (let b = 0; b < e.numOutputs; b++) {
          ...
          ((_[i] = e.splitSizes[b]),
            p.push(_),
            (a[b] = R(`output${b}`, o, _.length)),
            c.push({ dims: p[b], dataType: t[0].dataType }));
        }
  ...
  ${b.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
        ...
        return {
          name: 'Split',
          shaderCache: { hint: e.cacheKey, inputDependencies: ['rank'] },
          getShaderSource: y,
          getRunData: () => ({
            outputs: c,
            dispatchGroup: { x: Math.ceil(n / 64) },
      ...
      (Ll = (t) => {
        let e = t.axis,
          r = t.splitSizes,
          n = t.numOutputs < 0 ? r.length : t.numOutputs;
...
var tb,
  ...
  Mo = V(() => {
    ...
    ((tb = (t, e) => {
      let [r, n, o, i] = t,
        { numHeads: a, rotaryEmbeddingDim: u } = e;
      ...
      let d = r.dims[0],
        c = r.dims[r.dims.length - 2],
        p = o.dims[0],
        m = k.sizeFromDimension(r.dims, 1) / c,
        g = u === 0 ? o.dims[1] * 2 : m / a;
      ...
      (mn = (t, e) => {
        let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e,
          a = t[0].dims[0],
          u = k.sizeFromDimension(t[0].dims, 1),
          d = t[0].dims[t[0].dims.length - 2],
          c = u / d,
          p = t[2].dims[1],
          m = o === 0 ? p * 2 : c / n,
          g = new Array(a, d, c / m, m - p),
          y = k.computeStrides(g),
          b = [
            { type: 1, data: i },
            { type: 12, data: g },
            { type: 12, data: y },
            ...(t[0].dims.length === 3 ? new Array({ type: 12, data: [u, c, m, 1] }) : []),
            ...(t[0].dims.length === 4 ? new Array({ type: 12, data: [u, m, d * m, 1] }) : []),
            ...W(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims),
          ],
          _ = (S) => {
            let x = O('input', t[0].dataType, t[0].dims.length),
              v = O('position_ids', t[1].dataType, t[1].dims.length),
              T = O('cos_cache', t[2].dataType, t[2].dims.length),
              I = O('sin_cache', t[3].dataType, t[3].dims.length),
              E = R('output', t[0].dataType, t[0].dims.length);
            return (
              S.registerUniforms([
                { name: 'scale', type: 'f32' },
                { name: 'global_shape', type: 'u32', length: g.length },
                { name: 'global_strides', type: 'u32', length: y.length },
                { name: 'input_output_strides', type: 'u32', length: y.length },
              ]),
              `
...
var rb,
  ...
  Fl = V(() => {
    ...
    ((rb = (t, e) => {
      ...
      let u = !1,
        d = r.dims[0],
        c = r.dims[1],
        p = r.dims.length === 3 ? (u ? r.dims[2] / 3 : r.dims[2]) : e.numHeads * r.dims[4],
        m = c,
        g = 0,
        y = !n || n.dims.length === 0,
        b = Math.floor(y ? p / (e.numHeads + 2 * e.kvNumHeads) : p / e.numHeads);
      y && (p = b * e.numHeads);
      let _ = i && i.dims.length !== 0,
        S = a && a.dims.length !== 0;
      if (
        _ &&
        i.dims.length === 4 &&
        i.dims[0] === d &&
        i.dims[1] !== e.kvNumHeads &&
        i.dims[2] === e.kvNumHeads &&
        i.dims[3] === b
      )
      ...
      if (n && n.dims.length > 0) {
        ...
        if (n.dims.length === 3) {
          ...
          if (n.dims[2] !== e.numHeads || n.dims[3] !== 2 || n.dims[4] !== b)
            throw new Error(
              'Expect "key" shape (batch_size, kv_sequence_length, num_heads, 2, head_size) for packed kv',
            );
          if (o) throw new Error('Expect "value" be none when "key" has packed kv format.');
          ...
          if (n.dims[1] !== e.numHeads || n.dims[3] !== b)
            throw new Error(
              'Expect "key" shape (batch_size, num_heads, kv_sequence_length, head_size) for past_key',
            );
          m = n.dims[2];
      ...
      let T = 0,
        I = !1,
        E = e.kvNumHeads ? b * e.kvNumHeads : p;
      ...
      if (A) {
        ...
        for (let F = 0; F < A.dims.length; F++)
          if (A.dims[F] !== 1 && A.dims[F] !== d)
            throw new Error(
              `seqlens_k has unexpected shape. Each dimension must be 1 or batch_size (${d}), got dims[${F}] = ${A.dims[F]}.`,
            );
      }
      return {
        batchSize: d,
      ...
      (Gl = (t, e, r) => {
        ...
        return (
          e.dims.length === 3 &&
            ...
            ((n = e.reshape([r.batchSize, r.kvSequenceLength, o, r.headSize])),
            (n = t.compute(ze(n, nb.perm), { inputs: [n], outputs: [-1] })[0])),
          n
        );
      }),
      (ob = (t, e, r, n) => {
        let o = 7,
          ...
          c = (p) => {
            let m = O('seq_lens', r.dataType, r.dims),
              g = O('total_seq_lens', n.dataType, n.dims),
              y = R('pos_ids', o, a),
              b = [
                { name: 'output_size', type: 'u32' },
                { name: 'sequence_length', type: 'u32' },
  ...
  `;
        ...
        return {
          ...
          shaderCache: { hint: `${t};${e}`, inputDependencies: i },
          getRunData: () => ({
      ...
      (Hl = (t, e) => {
        if ((t.inputs.length > 14 && t.inputs[14]) || (t.inputs.length > 15 && t.inputs[15]))
          throw new Error(
            'GroupQueryAttention (JSEP): q_norm_weight / k_norm_weight inputs are not supported. The per-head Q/K RMS normalization prologue is implemented only on the CUDA and native WebGPU EPs.',
          );
        let r = rb(t.inputs, e);
        ...
        let n = t.inputs[0],
          o = t.inputs[1] && t.inputs[1].dims.length > 0 ? t.inputs[1] : void 0,
          i = t.inputs[2] && t.inputs[2].dims.length > 0 ? t.inputs[2] : void 0,
          a = t.inputs[3] && t.inputs[3].dims.length !== 0 ? t.inputs[3] : void 0,
          u = t.inputs[4] && t.inputs[4].dims.length !== 0 ? t.inputs[4] : void 0,
          d = t.inputs.length > 4 ? t.inputs[5] : void 0,
          c = t.inputs.length > 5 ? t.inputs[6] : void 0,
          p = r.kvNumHeads ? r.kvNumHeads : r.numHeads,
          m = J({
            axis: 2,
            numOutputs: 3,
            splitSizes: [r.numHeads * r.headSize, p * r.headSize, p * r.headSize],
          }),
          [g, y, b] =
            !o && !i ? t.compute(zo([n], m), { inputs: [n], outputs: [-1, -1, -1] }) : [n, o, i],
          _,
          S;
        if (e.doRotary) {
...
var ql,
  ...
  jl = V(() => {
    ...
    ((ql = (t, e, r, n, o, i, a, u) => {
      ...
      S.push(...W(y, b));
      let x = (v) => {
        let T = O('x', e.dataType, 3, d),
          I = O('scale', r.dataType, r.dims),
          E = O('bias', n.dataType, n.dims),
          A = R('output', 1, 3, 2),
          D = [T, I, E, A];
        return `
    ...
    if (local_idx == 0) {
      ...
      return t.compute(
        {
          ...
          shaderCache: { hint: `${d};${u};${g}`, inputDependencies: _ },
          getRunData: () => ({
      ...
      (ib = (t, e, r) => {
        let n = e[0].dims,
          ...
          a = n[0],
          u = n[1],
          d = k.sizeFromDimension(n, i),
          c = fe(d),
          p = k.size(o) / c,
          m = ql(t, e[0], e[1], e[2], a, d, u, r.epsilon),
          g = [a, u, d / c],
          y = [a, u],
          b = ['type', 'none'],
          _ = (S) => {
            let x = O('x', e[0].dataType, g.length, c),
              v = O('scale_shift', 1, y.length, 2),
              T = R('output', e[0].dataType, g.length, c),
              I = [x, v, T];
            return `
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
        ...
        t.compute(
          {
            ...
            getRunData: () => ({
              ...
              dispatchGroup: { x: Math.ceil(p / 64) },
              programUniforms: [{ type: 12, data: p }, ...W(g, y, g)],
            }),
            getShaderSource: _,
          },
          { inputs: [e[0], m] },
      ...
      (ab = (t, e, r) => {
        let n = e[0].dims,
          ...
          i = n[0],
          a = n[n.length - 1],
          u = k.sizeFromDimension(n, 1) / a,
          d = fe(a),
          c = k.size(o) / d,
          p = [
            { type: 12, data: u },
            { type: 12, data: Math.floor(a / d) },
          ],
          m = ['type', 'type'],
          g = !1,
          y = [0, n.length - 1];
        ...
        g = g && n[n.length - 1] !== 1;
        let b = g
            ? t.compute(ze(t.inputs[0], y), { inputs: [t.inputs[0]], outputs: [-1] })[0]
            : t.inputs[0].reshape(Array.from({ length: n.length }, (x, v) => n[y[v]])),
          _ = ql(t, b, e[1], e[2], i, u, a, r.epsilon),
          S = (x) => {
            let v = we(e[0].dataType),
              ...
              E = O('input', e[0].dataType, e[0].dims, d),
...
var sb,
    ...
    ((sb = (t) => {
      ...
      (ub = (t, e, r) => {
        let n = e.simplified,
          ...
          a = !n && t[2],
          u = o,
          d = k.normalizeAxis(e.axis, o.length),
       ...
       Got scale size of ${m} and bias size of ${g}`);
        ...
        let b = fe(p),
          ...
          S = [
            { type: 12, data: c },
            { type: 1, data: p },
            { type: 12, data: Math.floor(p / b) },
            { type: 1, data: e.epsilon },
          ];
        a && _.push('type');
        let x = r > 1,
          v = r > 2,
          T = (E) => {
            let A = we(t[0].dataType),
              D = [O('x', t[0].dataType, t[0].dims, b), O('scale', i.dataType, i.dims, b)];
            (a && D.push(O('bias', a.dataType, a.dims, b)),
              D.push(R('output', t[0].dataType, u, b)),
              x && D.push(R('mean_data_output', 1, y)),
              v && D.push(R('inv_std_output', 1, y)));
            let w = [
  ...
  ${E.mainStart()}
    ...
    ${v ? 'inv_std_output[global_idx] = inv_std_dev' : ''};
        ...
        return (
          x && I.push({ dims: y, dataType: 1 }),
          v && I.push({ dims: y, dataType: 1 }),
          {
            name: 'LayerNormalization',
            shaderCache: { hint: `${b};${r};${n}`, inputDependencies: _ },
            getRunData: () => ({
              outputs: I,
              dispatchGroup: { x: Math.ceil(c / 64) },
              programUniforms: S,
  ...
  Yl = V(() => {
    ...
    ((db = (t) => {
      ...
      (Xl = (t) => {
        ...
        let r = e[e.length - 1],
          n = t.inputs[0].dims[t.inputs[0].dims.length - 1];
        if (r < 8 && n < 8) t.compute(sn(t.inputs, { activation: '' }, e));
        else {
          let o = e[e.length - 2],
            i = k.size(t.inputs[0].dims.slice(0, -2)),
            a = k.size(t.inputs[1].dims.slice(0, -2));
          if (i !== 1 && o === 1 && a === 1) {
            let u = t.inputs[0].reshape([1, i, n]),
              d = t.inputs[1].reshape([1, n, r]),
              c = [1, i, r],
              p = [u, d];
...
var lb,
  ...
  tc = V(() => {
    ...
    ((lb = (t, e) => {
      ...
      let o = Math.floor((e.k + e.blockSize - 1) / e.blockSize),
        i = (e.blockSize / 8) * e.bits,
        a = t[1];
      if (!k.areEqual(a.dims, [e.n, o, i]))
        throw new Error(
      ...
      if (t.length === 4) {
        let p = t[3].dims,
          m = e.n * (e.bits === 8 ? o : Math.floor((o * e.bits + 7) / 8));
      ...
      (cb = (t, e) => {
        ...
        (E.splice(-1, 1, p / y),
          ...
          T.push(...W(E)),
          T.push(...W(t[2].dims)),
          t.length === 4 && T.push(...W(k.convertShape(t[3].dims))));
        let A = [d, o, a / b];
        T.push(...W(A));
        let D = (w) => {
          let U = I.length,
            N = O('a', t[0].dataType, U, g),
            F = O('b', 12, E.length, y),
            q = O('scales', t[2].dataType, t[2].dims.length),
            Y = [N, F, q],
            z = t.length === 4 ? O('zero_points', 12, t[3].dims.length) : void 0;
          z && Y.push(z);
          let L = A.length,
            Q = R('output', t[0].dataType, L, b),
            X = we(t[0].dataType),
            Z = (() => {
              switch (g) {
                case 1:
          ...
          `;
            ...
            b_dequantized_values = ${
              g === 1
                ? `${Z}(${Array.from({ length: 8 }, (Oe, ge) => `(b_quantized_values[${ge}] - ${z ? `zero_point${ve}` : 'zero_point'}) * scale${ve}`).join(', ')});`
                : `(b_quantized_values - ${Z}(${Array(8)
                    .fill(`${z ? `zero_point${ve}` : 'zero_point'}`)
                    .join(',')})) * scale${ve};`
            };
      ...
      (pb = (t, e) => {
        ...
        (U.splice(-1, 1, p / y),
          ...
          D.push(...W(U)),
          D.push(...W(t[2].dims)),
          t.length === 4 && D.push(...W(k.convertShape(t[3].dims))));
        let N = [d, o, a];
        D.push(...W(N));
        let F = (q) => {
          let Y = w.length,
            z = O('a', t[0].dataType, Y, g),
            L = O('b', 12, U.length, y),
            Q = O('scales', t[2].dataType, t[2].dims.length),
            X = [z, L, Q],
            Z = t.length === 4 ? O('zero_points', 12, t[3].dims.length) : void 0;
      ...
      (Jl = (t, e) => {
        (lb(t.inputs, e),
          e.blockSize === 32 &&
          t.adapterInfo.isVendor('intel') &&
          t.adapterInfo.isArchitecture('gen-12lp')
            ? t.compute(pb(t.inputs, e))
            : t.compute(cb(t.inputs, e)));
      }),
      (ec = (t) => J(t)));
  });
var mb,
  ...
  nc = V(() => {
    ...
    ((mb = (t) => {
      ...
      (_b = (t, e) => {
        let r = k.padShape(t[0].dims.slice(), e.pads),
          n = t[0].dims,
          o = k.size(r),
          i = [
            { type: 12, data: o },
        ...
        (e.mode === 0 && i.push({ type: a ? t[2].dataType : 1, data: e.value }),
          i.push(...W(t[0].dims, r)));
        let u = ['rank'],
          d = (c) => {
            let p = R('output', t[0].dataType, r.length),
              m = O('x', t[0].dataType, n.length),
              g = m.type.value,
              y = yb(p, n.length, e),
              b = [
                { name: 'output_size', type: 'u32' },
                { name: 'pads', type: 'i32', length: e.pads.length },
              ];
            return (
              e.mode === 0 && b.push({ name: 'constant_value', type: a ? g : 'f32' }),
              `
        ...
        return {
          name: 'Pad',
          shaderCache: { hint: `${e.mode}${a}`, inputDependencies: u },
          getRunData: () => ({
            outputs: [{ dims: r, dataType: t[0].dataType }],
      ...
      (wb = (t, e) => {
        if (t.length > 1) {
          let r = t[1].getBigInt64Array(),
            n =
              t.length >= 3 && t[2].data
                ? t[2].dataType === 10
                  ? t[2].getUint16Array()[0]
                  : t[2].getFloat32Array()[0]
                : 0,
            o = t[0].dims.length,
...
var fn,
  ...
  wc = V(() => {
    ...
    oe();
    ((fn = (t) => {
      if (_e.webgpu.validateInputContent && (!t || t.length !== 1))
      ...
      (oc = (t, e, r) => {
        ...
        let i = Object.hasOwnProperty.call(e, 'dilations'),
          a = e.kernelShape.slice(),
          u = e.strides.slice(),
          d = i ? e.dilations.slice() : [],
          c = e.pads.slice();
        zt.adjustPoolAttributes(r, o, a, u, d, c);
        let p = zt.computePoolOutputShape(r, o, u, d, a, c, e.autoPad, e.ceilMode),
          m = Object.assign({}, e);
        i
          ? Object.assign(m, {
              kernelShape: a,
          ...
          : Object.assign(m, { kernelShape: a, strides: u, pads: c, cacheKey: e.cacheKey });
        let g = p.slice();
      ...
      (ic = (t, e) => {
        ...
        if (e.kernelShape.length <= 2) {
          let u = e.kernelShape[e.kernelShape.length - 1],
            d = e.strides[e.strides.length - 1],
            c = e.pads[e.pads.length / 2 - 1],
            p = e.pads[e.pads.length - 1],
            m = !!(c + p);
          (i.push(
            { type: 12, data: u },
            { type: 12, data: d },
          ...
          let g = !1;
          if (e.kernelShape.length === 2) {
            let y = e.kernelShape[e.kernelShape.length - 2],
              b = e.strides[e.strides.length - 2],
          ...
          (i.push({ type: 12, data: u }, { type: 12, data: e.pads }, { type: 12, data: e.strides }),
            a.push(
              { name: 'kernelStrides', type: 'u32', length: u.length },
              { name: 'pads', type: 'u32', length: e.pads.length },
              { name: 'strides', type: 'u32', length: e.strides.length },
            ));
      ...
      (sc = (t) => `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`),
      ($b = (t) => `${sc(t)};${t.countIncludePad}`),
      (vb = (t) => `${sc(t)};${t.storageOrder};${t.dilations}`),
      (uc = (t) => ({
        format: t.format,
        autoPad: ['NOTSET', 'VALID', 'SAME_UPPER', 'SAME_LOWER'][t.auto_pad],
      ...
      (dc = (t, e, r, n) => {
        let [o, i] = oc(e, n, r),
          a = O('x', e.dataType, e.dims.length),
          u = a.type.value,
          d = 'value += x_val;',
          c = '';
        o.countIncludePad
        ...
        return {
          name: t,
          shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: _ },
          getRunData: () => ({
    ...
    `,
          u = '',
          d = O('x', e.dataType, e.dims.length),
          c = ['rank'],
          [p, m, g, y, b] = ic(i, o);
        return (
          p.push(...W(e.dims, i)),
          {
            name: t,
            shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: c },
            getRunData: () => ({
              outputs: [{ dims: i, dataType: e.dataType }],
              dispatchGroup: { x: Math.ceil(k.size(i) / 64) },
              programUniforms: p,
  ...
  xc = V(() => {
    ...
    ((Sb = (t, e) => {
      ...
      if (t.length > 2) {
        ...
        if (!t[1].dims.map((r, n) => r === t[2].dims[n]).reduce((r, n) => r && n, !0))
      ...
      if (e.blockSize > 0) {
        ...
        if (
          !t[1].dims.map((o, i) => i === e.axis || o === t[0].dims[i]).reduce((o, i) => o && i, !0)
        )
          throw new Error(
      ...
      (Tb = (t, e) => {
        let r = k.normalizeAxis(e.axis, t[0].dims.length),
          n = t[0].dataType,
          o = n === 3,
          i = t[0].dims,
          a = t[1].dataType,
          u = k.size(i),
          d = n === 3 || n === 2,
          c = d ? [Math.ceil(k.size(t[0].dims) / 4)] : t[0].dims,
          p = t[1].dims,
          m = t.length > 2 ? t[2] : void 0,
          g = m ? (d ? [Math.ceil(k.size(m.dims) / 4)] : m.dims) : void 0,
          y = p.length === 0 || (p.length === 1 && p[0] === 1),
          b = y === !1 && p.length === 1,
          _ = fe(u),
          S = y && (!d || _ === 4),
          x = S ? _ : 1,
          v = S && !d ? _ : 1,
          T = O('input', d ? 12 : n, c.length, v),
          I = O('scale', a, p.length),
          E = m ? O('zero_point', d ? 12 : n, g.length) : void 0,
          A = R('output', a, i.length, x),
          D = [T, I];
        E && D.push(E);
        let w = [c, p];
        m && w.push(g);
      ...
      ${F.mainStart()}
          ...
          ${
            ...
            let x_value = ${x === 1 ? 'x_vec[global_idx % 4]' : 'x_vec'};`
          ...
          ${
            y
              ? `let scale_value= ${I.getByOffset('0')}`
              : b
                ? `
            ...
            E
              ? y
                ...
                let zero_point_value= zero_point_vec[0]`
                  : `let zero_point_value = ${E.getByOffset('0')}`
                : b
                  ? d
                    ? `
                ...
                let zero_point_value = zero_point_vec[zero_point_index % 4]`
                    : `
                let zero_point_index = ${A.indicesGet('output_indices', 'uniforms.axis')};
                let zero_point_value = ${E.getByOffset('zero_point_index')};`
                  : d
                    ? `
                ...
                let zero_point_value = zero_point_vec[zero_point_offset % 4];`
                    : `let zero_point_value = ${E.getByIndices('scale_indices')};`
      ...
      ${A.setByOffset('global_idx', `${A.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        return {
          ...
          shaderCache: {
            hint: e.cacheKey,
            inputDependencies: E ? ['rank', 'rank', 'rank'] : ['rank', 'rank'],
          },
          getShaderSource: N,
          getRunData: () => ({
            outputs: [{ dims: i, dataType: a }],
            dispatchGroup: { x: Math.ceil(u / x / 64), y: 1, z: 1 },
            programUniforms: U,
          }),
        };
      }),
...
var Ib,
  ...
  Tc = V(() => {
    ...
    ((Ib = (t, e, r) => {
      ...
      (Cb = (t, e, r, n) => {
        let o = Math.abs(Math.ceil((e - t) / r)),
          i = [o],
          a = o,
          u = [{ type: 12, data: a }, { type: n, data: t }, { type: n, data: r }, ...W(i)],
          d = (c) => {
            let p = R('output', n, i.length),
              m = p.type.value,
              g = [
                { name: 'outputSize', type: 'u32' },
                { name: 'start', type: m },
      ...
      (Sc = (t) => {
        ...
        (t.inputs[0].dataType === 6
          ? ((e = t.inputs[0].getInt32Array()[0]),
            (r = t.inputs[1].getInt32Array()[0]),
            (n = t.inputs[2].getInt32Array()[0]))
          : t.inputs[0].dataType === 1 &&
            ((e = t.inputs[0].getFloat32Array()[0]),
            (r = t.inputs[1].getFloat32Array()[0]),
            (n = t.inputs[2].getFloat32Array()[0])),
          _e.webgpu.validateInputContent && Ib(e, r, n),
          t.compute(Cb(e, r, n, t.inputs[0].dataType), { inputs: [] }));
      }));
  });
var Ab,
  Eb,
  ...
  Ac = V(() => {
    ...
    ((Ab = (t, e, r, n) => {
      ...
      switch (t) {
        ...
        case 'add':
          return n === 'i32' || n === 'u32'
            ? `atomicAdd(&${e}, bitcast<${n}>(${r}));`
            : `
              ${o}bitcast<${n}>(oldValue) + (${r})${i}`;
        case 'max':
          return n === 'i32' || n === 'u32'
            ? `atomicMax(&${e}, bitcast<${n}>(${r}));`
            : `
                ${o}max(bitcast<f32>(oldValue), (${r}))${i}`;
        case 'min':
          return n === 'i32' || n === 'u32'
            ? `atomicMin(&${e}, bitcast<${n}>(${r}));`
            : `${o}min(bitcast<${n}>(oldValue), (${r}))${i}`;
        case 'mul':
      ...
      (Eb = (t, e) => {
        let r = t[0].dims,
          ...
          o = r,
          i = 1,
          a = Math.ceil(k.sizeToDimension(n, n.length - 1) / i),
          u = n[n.length - 1],
          d = k.sizeFromDimension(r, u),
          c = [
            { type: 12, data: a },
            { type: 12, data: u },
            { type: 12, data: d },
          ...
          p = (m) => {
            let g = O('indices', t[1].dataType, t[1].dims.length),
              y = O('updates', t[2].dataType, t[2].dims.length, i),
              b =
                e.reduction !== 'none' && e.reduction !== ''
                  ? Fs('output', t[0].dataType, o.length)
                  : R('output', t[0].dataType, o.length, i);
            return `
...
var kb,
  ...
  Dc = V(() => {
    ...
    ((kb = (t, e) => {
      if (
        ...
        if (e.mode === 'linear') {
          if (!(
            t.length === 2 ||
            t.length === 3 ||
            (t.length === 4 && t[0] === 1 && t[1] === 1) ||
            (t.length === 4 && t[0] === 1 && t[3] === 1) ||
            (t.length === 5 && t[0] === 1 && t[1] === 1)
          ))
      ...
      (Ob = (t, e, r, n, o, i) => {
        let [a, u, d] = r > 10 ? [1, 2, 3] : [-1, t.length > 1 ? 1 : -1, -1],
          c = t[0].dims.length;
        if (a > 0 && t.length > a && t[a].dims.length > 0)
          t[a].getFloat32Array().forEach((p) => i.push(p));
        ...
        if (u > 0 && t.length > u && t[u].dims.length === 1 && t[u].dims[0] > 0) {
          if (
            (t[u].getFloat32Array().forEach((p) => n.push(p)),
            n.length !== 0 && n.length !== c && r >= 18 && n.length !== e.axes.length)
          )
            throw new Error(
        ...
        if (
          ...
          t[d].dims.length === 1 &&
          t[d].dims[0] > 0 &&
          (t[d].getBigInt64Array().forEach((p) => o.push(Number(p))),
          o.length !== 0 && o.length !== c && r >= 18 && o.length !== e.axes.length)
        )
          throw new Error(
...
`),
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { ` +
      ...
      (Rb = (t, e, r) => {
          ...
          switch (r.keepAspectRatioPolicy) {
            case 'not_larger':
              return r.axes.length > 0
                ? Math.min(...r.axes.map((i) => e[i]), Number.MAX_VALUE)
                : Math.min(...e, Number.MAX_VALUE);
            case 'not_smaller':
              return r.axes.length > 0
                ? Math.max(...r.axes.map((i) => e[i]), Number.MIN_VALUE)
                : Math.max(...e, Number.MIN_VALUE);
            default:
              throw new Error(
        ...
        return (
          r.axes.length > 0
            ? (r.axes.forEach((i) => (e[i] = n)),
              r.axes.forEach((i) => (o[i] = Math.round(t[i] * e[i]))))
            : (e.fill(n, 0, e.length), o.forEach((i, a) => (o[a] = Math.round(i * e[a])))),
          o
        );
      }),
      (Ub = (t, e, r, n, o) => `
...
`
          : ''),
      (Lb = (t, e, r, n, o) => {
        let [a, u, d, c] = r.length === 2 ? [-1, 0, 1, -1] : [0, 2, 3, 1],
          p = t.type.value;
        return `
    ...
    fn bilinearInterpolation(output_indices: ${e.type.indices}) -> ${p} {
      ...
      ${
        n
          ? `if (row < 0 || row > (${r[u]} - 1) || col < 0 || col > (${r[d]} - 1)) {
        return ${o};
      }`
          : ''
      };
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    `;
      ...
      (Gb = (t, e, r, n, o) => {
        let [a, u, d, c, p] = r.length === 3 ? [-1, 0, 1, 2, -1] : [0, 2, 3, 4, 1],
          m = t.type.value;
        return `
    ...
    fn trilinearInterpolation(output_indices: ${e.type.indices}) -> ${m} {
      ...
      ${
        n
          ? `if (depth < 0 || depth > (${r[u]} - 1) || height < 0 || height > (${r[d]} - 1) || width < 0 || (width > ${r[c]} - 1)) {
      return ${o};
        }`
          : ''
      };
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      (Hb = (t, e, r, n, o, i) => {
        let a = t.dims,
          u = Bb(i, e.axes, a.length),
          d = Mb(a, n, o, e.axes),
          c = n.slice();
        n.length === 0 &&
          ((c = a.map((v, T) => (v === 0 ? 1 : d[T] / v))),
          e.keepAspectRatioPolicy !== 'stretch' && (d = Rb(a, c, e)));
        let p = R('output', t.dataType, d.length),
          m = O('input', t.dataType, a.length),
          g = k.size(d),
          y = a.length === d.length && a.every((v, T) => v === d[T]),
          b = e.coordinateTransformMode === 'tf_crop_and_resize',
          _ = e.extrapolationValue,
          S = m.type.value,
          x = (v) => `
      ${
        y
          ...
          case 'cubic':
            ...
            ${(() => {
              if (a.length === 2 || a.length === 4)
                return `${Wb(m, p, a, d, c, u, e.cubicCoeffA, b, e.extrapolationValue, e.excludeOutside)}`;
              throw Error(
...
`
        ...
        return {
          ...
          getShaderSource: x,
          getRunData: () => ({
            outputs: [{ dims: d, dataType: t.dataType }],
            dispatchGroup: { x: Math.ceil(g / 64) },
            programUniforms: [
              { type: 12, data: g },
              { type: 1, data: c },
      ...
      (Oc = (t) => {
        let e = t.antialias,
          r = t.axes,
          n = t.coordinateTransformMode,
          o = t.cubicCoeffA,
          i = t.excludeOutside !== 0,
          a = t.extrapolationValue,
          u = t.keepAspectRatioPolicy,
          d = t.mode,
          c = t.nearestMode === '' ? 'simple' : t.nearestMode;
        return J({
          antialias: e,
          axes: r,
...
var qb,
  ...
  Bc = V(() => {
    ...
    ((qb = (t) => {
      ...
      let o = e.dims[e.dims.length - 1],
        i = e.dims[e.dims.length - 2];
      ...
      (Kb = (t, e, r, n) => {
        let o = e.simplified,
          ...
          T = (E) => {
            ...
            (m && D.push(O('beta', t[3].dataType, t[3].dims, x)),
              g && D.push(O('bias', t[4].dataType, t[4].dims, x)),
              D.push(R('output', t[0].dataType, u, x)),
              y && D.push(R('mean_output', 1, p)),
              b && D.push(R('inv_std_output', 1, p)),
              _ && D.push(R('input_skip_bias_sum', t[0].dataType, u, x)));
            let w = we(t[0].dataType),
              U = we(1, x);
            return `
      ...
      ${E.mainStart([S, 1, 1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
          ...
          I = [{ dims: u, dataType: t[0].dataType }];
        return (
          r > 1 && I.push({ dims: p, dataType: 1 }),
          r > 2 && I.push({ dims: p, dataType: 1 }),
          r > 3 && I.push({ dims: i, dataType: t[0].dataType }),
          {
      ...
      (zc = (t, e) => {
        qb(t.inputs);
        let n = [0];
        (t.outputCount > 1 && n.push(-3),
          t.outputCount > 2 && n.push(-3),
          t.outputCount > 3 && n.push(3),
          t.compute(Kb(t.inputs, e, t.outputCount, !1), { outputs: n }));
      }));
  });
var jb,
  hn,
  ...
  Nc = V(() => {
    ...
    ((jb = (t, e) => {
      ...
      (hn = (t, e) => {
        let r = [];
        if (t.length > e)
          if (t[e].dataType === 7) t[e].getBigInt64Array().forEach((n) => r.push(Number(n)));
      ...
      (Zb = (t, e) => {
        if (t.length > 1) {
          let r = hn(t, 1),
            ...
            o = hn(t, 3);
          return (
            o.length === 0 && (o = [...Array(t[0].dims.length).keys()]),
            J({ starts: r, ends: n, axes: o })
          );
        } else return e;
      }),
      (Mc = (t, e, r, n, o) => {
        ...
        return (
          t < 0 && (i += r[n[e]]),
          o[e] < 0 ? Math.max(0, Math.min(i, r[n[e]] - 1)) : Math.max(0, Math.min(i, r[n[e]]))
        );
      }),
      (Qb = (
        t,
        e,
        r,
      ) => `fn calculateInputIndices(output_indices: ${e.type.indices}) -> ${t.type.indices} {
          var input_indices: ${t.type.indices};
          var carry = 0u;
      ...
      (Xb = (t, e) => {
        let r = t[0].dims,
          n = k.size(r),
          o = e.axes.length > 0 ? k.normalizeAxes(e.axes, r.length) : [...Array(r.length).keys()],
          i = hn(t, 4);
        (i.forEach(
          (x) =>
            x !== 0 ||
        ...
        let a = e.starts.map((x, v) => Mc(x, v, r, o, i)),
          u = e.ends.map((x, v) => Mc(x, v, r, o, i));
        if (o.length !== a.length || o.length !== u.length)
          throw new Error('start, ends and axes should have the same number of elements');
        if (o.length !== r.length)
          for (let x = 0; x < r.length; ++x)
            o.includes(x) || (a.splice(x, 0, 0), u.splice(x, 0, r[x]), i.splice(x, 0, 1));
        ...
        let p = { dims: c, dataType: t[0].dataType },
          m = R('output', t[0].dataType, c.length),
          g = O('input', t[0].dataType, t[0].dims.length),
          y = k.size(c),
          b = [
            { name: 'outputSize', type: 'u32' },
      ...
      ${x.registerUniforms(b).declareVariables(g, m)}
        ...
        return {
          name: 'Slice',
          shaderCache: { hint: `${d.length}_${a.length}_${i.length}`, inputDependencies: ['rank'] },
          getShaderSource: S,
          getRunData: () => ({
            outputs: [p],
            dispatchGroup: { x: Math.ceil(n / 64) },
    ...
    ((Yb = (t) => {
      ...
      (Jb = (t, e) => {
        let r = t.inputs[0],
          ...
          o = k.size(n),
          i = n.length,
          a = k.normalizeAxis(e.axis, i),
          u = a < n.length - 1,
          d,
          c = [];
        u
          ? ((c = Array.from({ length: i }, (D, w) => w)),
            (c[a] = i - 1),
            (c[i - 1] = a),
            (d = t.compute(ze(r, c), { inputs: [r], outputs: [-1] })[0]))
          : (d = r);
        let p = d.dims,
          m = p[i - 1],
          g = o / m,
            ...
            w === 4
              ...
              : w === 2
                ...
                : w === 3
                  ? `max(max(${D}.x, ${D}.y), ${D}.z)`
                  : D,
          x = O('x', d.dataType, d.dims, y),
          v = R('result', d.dataType, d.dims, y),
          T = x.type.value,
          I =
            we(d.dataType) === 'f32'
              ? `var threadMax = ${T}(-3.4028234663852886e+38f);`
      ...
      ${D.mainStart(_)}
        ...
        for (var col = lindex; col < cols; col += wg) {
          ...
          A = t.compute(
            {
              name: 'Softmax',
              shaderCache: { hint: `${y};${_}`, inputDependencies: ['type'] },
              getRunData: () => ({
                outputs: [{ dims: p, dataType: d.dataType }],
                dispatchGroup: { x: g },
...
var Gc,
  ...
  Fc = V(() => {
    ...
    te();
    oe();
    ((Gc = (t) => Array.from(t.getBigInt64Array(), Number)),
      (ey = (t) => {
        ...
        if (Gc(t[1]).length !== t[0].dims.length)
          throw new Error(
      ...
      ${d.setByOffset('global_idx', u.getByIndices('input_indices'))}
        ...
        return {
          name: 'Tile',
          shaderCache: { hint: `${n}`, inputDependencies: ['rank'] },
          getRunData: () => ({
            outputs: [{ dims: o, dataType: t[0].dataType }],
            dispatchGroup: { x: Math.ceil(i / 64) },
            programUniforms: [{ type: 12, data: i }, ...W(t[0].dims, o)],
          }),
          getShaderSource: c,
        };
      }),
...
var ny,
  ...
  Kc = V(() => {
    ...
    oe();
    ((ny = (t, e, r, n, o) => {
      let i = R('output_data', o, r.length, 4),
        a = O('a_data', e[1].dataType, e[1].dims.length, 4),
        u = O('b_data', e[2].dataType, e[2].dims.length, 4),
        d = O('c_data', e[0].dataType, e[0].dims.length, 4),
        c,
        p = (m, g, y) => `select(${g}, ${m}, ${y})`;
      if (!n)
        c = i.setByOffset(
          'global_idx',
          p(a.getByOffset('global_idx'), u.getByOffset('global_idx'), d.getByOffset('global_idx')),
        );
      else {
        let m = (g, y, b = '') => {
          let _ = `a_data[index_a${y}][component_a${y}]`,
            S = `b_data[index_b${y}][component_b${y}]`,
            x = `bool(c_data[index_c${y}] & (0xffu << (component_c${y} * 8)))`;
          return `
      ...
      (oy = (t) => {
        let e = t[1].dims,
          ...
          n = t[0].dims,
          o = t[1].dataType,
          i = !(k.areEqual(e, r) && k.areEqual(r, n)),
          a = e,
          u = k.size(e);
        if (i) {
        ...
        return {
          ...
          getRunData: () => ({
            ...
            programUniforms: [{ type: 12, data: d }, ...W(n, e, r, a)],
          }),
        };
      }),
      (qc = (t) => {
  ...
  Qc = V(() => {
    ...
    gn = class {
      ...
      run(e, r, n, o, i) {
        ...
        (u.setPipeline(e.computePipeline),
          u.setBindGroup(0, c),
      ...
      build(e, r) {
        ...
        let a = qs(r, this.backend.device.limits),
          u = e.getShaderSource(a),
          d = `${o.join(`
`)}
${a.additionalImplementations}
${u}`,
          c = n.createShaderModule({ code: d, label: e.name });
        ...
        return (
          Re(e.name),
          { programInfo: e, computePipeline: p, uniformVariablesInfo: a.variablesInfo }
        );
      }
      normalizeDispatchGroupSize(e) {
        let r = typeof e == 'number' ? e : e.x,
          n = typeof e == 'number' ? 1 : e.y || 1,
          o = typeof e == 'number' ? 1 : e.z || 1,
          i = this.backend.device.limits.maxComputeWorkgroupsPerDimension;
        if (r <= i && n <= i && o <= i) return [r, n, o];
        let a = r * n * o,
          u = Math.ceil(Math.sqrt(a));
        if (u > i) {
          if (((u = Math.ceil(Math.cbrt(a))), u > i))
  ...
  Yc = V(() => {
    ...
    ((iy = (t, e) => {
      if (e.length !== t.length)
        throw new Error(
          `inputDependencies length ${e.length} is not equal to inputTensors length ${t.length}.`,
        );
      let r = [];
      for (let n = 0; n < t.length; ++n) {
        let o = t[n].dataType;
      ...
      (ay = (t, e, r) => {
        let n = t.name;
        return (
          t.shaderCache?.hint && (n += '[' + t.shaderCache.hint + ']'),
          (n +=
            ':' +
            r +
            `:${iy(e, t.shaderCache?.inputDependencies ?? new Array(e.length).fill('dims'))}`),
          n
        );
      }),
      (Ro = class {
      ...
      (Uo = class {
        ...
        async initialize(e, r) {
          ...
          (i('chromium-experimental-timestamp-query-inside-passes') || i('timestamp-query'),
            i('shader-f16'),
            i('subgroups'),
            (this.device = await r.requestDevice(o)));
          let a = r,
            u =
              r.info ??
              (typeof a.requestAdapterInfo == 'function' ? await a.requestAdapterInfo() : void 0);
          ((this.adapterInfo = new Ro(u)),
            (this.gpuDataManager = Gs(this)),
            (this.programManager = new gn(this)),
            ...
            (this.device.onuncapturederror = (d) => {
              d.error instanceof GPUValidationError &&
                console.error(`An uncaught WebGPU validation error was raised: ${d.error.message}`);
            }),
          ...
          (this.queryType !== 'none' &&
            ...
            this.queryType !== 'none' &&
              e.mapAsync(GPUMapMode.READ).then(() => {
                let r = new BigUint64Array(e.getMappedRange()),
                  n = this.pendingQueries.get(e);
                for (let o = 0; o < r.length / 2; o++) {
                  let i = n[o],
                    a = i.kernelId,
                    u = this.kernels.get(a),
                    d = u.kernelType,
                    c = u.kernelName,
                    p = i.programName,
                    m = i.inputTensorViews,
                    g = i.outputTensorViews,
                    y = r[o * 2],
                    b = r[o * 2 + 1];
                  typeof this.queryTimeBase > 'u' && (this.queryTimeBase = y);
                  let _ = Number(y - this.queryTimeBase),
                    S = Number(b - this.queryTimeBase);
                  if (!Number.isSafeInteger(_) || !Number.isSafeInteger(S))
                    throw new RangeError('incorrect timestamp range');
                  if (this.env.webgpu.profiling?.ondata)
                    this.env.webgpu.profiling.ondata({
                      version: 1,
                      inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })),
                      outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })),
                      kernelId: a,
                      kernelType: d,
                      kernelName: c,
                      programName: p,
                    ...
                    (g.forEach((T, I) => {
                      ...
                      console.log(
                        `[profiling] kernel "${a}|${d}|${c}|${p}" ${x}${v}start time: ${_} ns, execution time: ${S - _} ns`,
                      ));
                  }
                  Cr('GPU', `${p}::${y}::${b}`);
                }
        ...
        run(e, r, n, o, i, a) {
          ...
          let { outputs: d, dispatchGroup: c, programUniforms: p } = e.getRunData(r),
            m = n.length === 0 ? d.map((T, I) => I) : n;
          if (m.length !== d.length)
            throw new Error(`Output size ${m.length} must be equal to ${d.length}.`);
          let g = [],
            y = [];
          for (let T = 0; T < d.length; ++T) {
            if (!Number.isInteger(m[T]) || m[T] < -3 || m[T] >= a)
              throw new Error(`Invalid output index: ${m[T]}`);
            if (m[T] === -3) continue;
            let I = m[T] === -1,
              E = m[T] === -2,
              A = I || E ? i(d[T].dataType, d[T].dims) : o(m[T], d[T].dataType, d[T].dims);
          ...
          if (p) {
            ...
            p.forEach((w) => {
              ...
              let N = w.type === 10 ? 2 : 4,
                ...
                q;
              (w.type === 10
                ? ((q = U.length > 4 ? 16 : U.length > 2 ? 8 : U.length * N),
                  (F = U.length > 4 ? 16 : N * U.length))
                : ((q = U.length <= 2 ? U.length * N : 16), (F = 16)),
                (T = Math.ceil(T / q) * q),
                I.push(T));
              let Y = w.type === 10 ? 8 : 4;
            ...
            p.forEach((w, U) => {
              let N = I[U],
                F = typeof w.data == 'number' ? [w.data] : w.data;
            ...
            (this.device.queue.writeBuffer(D.buffer, 0, A, 0, T),
              this.gpuDataManager.release(D.id),
              (b = { offset: 0, size: T, buffer: D.buffer }));
          }
          let _ = this.programManager.normalizeDispatchGroupSize(c),
            S = _[1] === 1 && _[2] === 1,
            x = ay(e, r, S),
            v = this.programManager.getArtifact(x);
          if (
            (v ||
              ((v = this.programManager.build(e, _)),
              this.programManager.setArtifact(x, v),
              se('info', () => `[artifact] key: ${x}, programName: ${e.name}`)),
            p && v.uniformVariablesInfo)
          ) {
            if (p.length !== v.uniformVariablesInfo.length)
              throw new Error(
                `Uniform variables count mismatch: expect ${v.uniformVariablesInfo.length}, got ${p.length} in program "${v.programInfo.name}".`,
              );
            for (let T = 0; T < p.length; T++) {
              let I = p[T],
                E = I.type,
                A = typeof I.data == 'number' ? 1 : I.data.length,
                [D, w] = v.uniformVariablesInfo[T];
              if (E !== D || A !== w)
                throw new Error(
                  `Uniform variable ${T} mismatch: expect type ${D} with size ${w}, got type ${E} with size ${A} in program "${v.programInfo.name}".`,
                );
            }
          }
          if (
            (se(
              'info',
              () => `[ProgramManager] run "${e.name}" (key=${x}) with ${_[0]}x${_[1]}x${_[2]}`,
            ),
        ...
        computeKernel(e, r, n) {
          ...
          let i = o.kernelType,
            ...
            d = o.attributes;
          if (this.currentKernelId !== null)
            throw new Error(`kernel "[${i}] ${a}" is not allowed to be called recursively`);
          ((this.currentKernelId = e),
            d[0] && ((d[1] = d[0](d[1])), (d[0] = void 0)),
            se('info', () => `[WebGPU] Start to run kernel "[${i}] ${a}"...`));
            ...
            c &&
              n.push(
                this.device
                  .popErrorScope()
                  .then((p) =>
                    p ? `GPU validation error for kernel "[${i}] ${a}": ${p.message}` : null,
                  ),
              );
        ...
        registerBuffer(e, r, n, o) {
          ...
          let a = i.get(r),
            u = this.gpuDataManager.registerExternalBuffer(n, o, a);
          return (i.set(r, [u, n]), u);
        }
        unregisterBuffers(e) {
          let r = this.sessionExternalDataMapping.get(e);
          r &&
            (r.forEach((n) => this.gpuDataManager.unregisterExternalBuffer(n[0])),
        ...
        replay() {
          ...
          for (let o = 0; o < n; o++) {
            ...
            (this.writeTimestamp(this.pendingDispatchNumber * 2),
              i.setPipeline(a.computePipeline),
              i.setBindGroup(0, a.bindGroup),
              i.dispatchWorkgroups(...a.dispatchGroup),
              this.writeTimestamp(this.pendingDispatchNumber * 2 + 1),
              this.pendingDispatchNumber++,
              this.queryType !== 'none' && this.pendingKernels.push(r[o]),
    ...
    ((lr = class t {
      ...
      (No = class {
        constructor(e, r, n) {
          ...
          ((this.outputCount = Number(e.getValue(o * i++, a))),
            (this.customDataOffset = Number(e.getValue(o * i++, '*'))),
            (this.customDataSize = Number(e.getValue(o * i++, a))));
          let d = [];
          for (let c = 0; c < u; c++) {
            let p = Number(e.getValue(o * i++, a)),
              m = Number(e.getValue(o * i++, '*')),
              g = Number(e.getValue(o * i++, a)),
              y = [];
        ...
        compute(e, r) {
          let n = r?.inputs?.map((u) => (typeof u == 'number' ? this.inputs[u] : u)) ?? this.inputs,
            o = r?.outputs ?? [],
            i = (u, d, c) => new lr(this.module, d, this.output(u, c), c),
            a = (u, d) => {
              let c = xt(u, d);
        ...
        output(e, r) {
          ...
          try {
            let o = this.module.PTR_SIZE,
              i = o === 4 ? 'i32' : 'i64',
              a = this.module.stackAlloc((1 + r.length) * o);
            ...
            throw new Error(
              `Failed to generate kernel's output[${e}] with dims [${r}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${o}`,
            );
          } finally {
      ...
      (sy = async (t, e, r, n) => {
        ...
        if (t === 'webgpu') {
          let i = (Yc(), er(Xc)).WebGpuBackend,
            a = new i();
          (await a.initialize(r, n),
            o('webgpu', [
              a,
              (u) => a.alloc(Number(u)),
              (u) => a.free(u),
              ...
              async (u, d, c) => {
                (se(
                  ...
                  await a.download(Number(u), () =>
                    e.HEAPU8.subarray(Number(d) >>> 0, Number(d + c) >>> 0),
                  ));
              },
              (u, d, c) =>
                a.createKernel(u, Number(d), c, e.UTF8ToString(e._JsepGetNodeName(Number(d)))),
              (u) => a.releaseKernel(u),
              (u, d, c, p) => {
                se(
                  'verbose',
  ...
  Jn = V(() => {
    ...
    ((uy = (t, e) => {
      ...
      (Dr = async (t, e) => {
        ...
        {
          let n = (ep(), er(Jc)).init;
          (e === 'webgpu' && (await n('webgpu', ye(), t, r)),
            e === 'webnn' && (await n('webnn', ye(), t)));
        }
      }),
      (Ut = new Map()),
      (dy = (t) => {
        ...
        try {
          let n = e.PTR_SIZE,
            o = e.stackAlloc(2 * n);
          e._OrtGetInputOutputCount(t, o, o + n) !== 0 &&
            me("Can't get session input/output count.");
          let a = n === 4 ? 'i32' : 'i64';
      ...
      (tp = (t, e) => {
        ...
        try {
          let i = r.PTR_SIZE,
            a = r.stackAlloc(2 * i);
          r._OrtGetInputOutputMetadata(t, e, a, a + i) !== 0 &&
            me("Can't get session input/output metadata.");
          let d = Number(r.getValue(a, '*'));
          o = Number(r.getValue(a + i, '*'));
          let c = r.HEAP32[o / 4];
          if (c === 0) return [d, 0];
          let p = r.HEAPU32[o / 4 + 1],
            m = [];
          for (let g = 0; g < p; g++) {
      ...
      (zr = async (t, e) => {
        ...
        try {
            ...
            if ((typeof I == 'string' ? I : I.name) === 'webnn') {
              if (((o.shouldTransferToMLTensor = !1), typeof I != 'string')) {
                ...
                D
                  ? (o.currentContext = D)
                  : w
                    ? (o.currentContext = await o.webnnCreateMLContext(w))
          ...
          ((i = await o._OrtCreateSession(r, n, a)),
            o.webgpuOnCreateSession?.(i),
            i === 0 && me("Can't create a session."),
          ...
          for (let I = 0; I < m; I++) {
            ...
            (b.push(w),
              S.push(
                A === 0
                  ? { name: w, isTensor: !1 }
                  : { name: w, isTensor: !0, type: rt(A), shape: D },
              ));
          }
          for (let I = 0; I < g; I++) {
            let [E, A, D] = tp(i, I + m);
              ...
              ));
            {
              ...
              let U =
                  typeof e?.preferredOutputLocation == 'string'
                    ...
                    : (e?.preferredOutputLocation?.[w] ?? 'cpu'),
                N = o.webnnIsGraphOutput;
              if (U === 'cpu' && N && N(i, w)) {
                v.push('ml-tensor-cpu-output');
                continue;
              }
              if (U !== 'cpu' && U !== 'cpu-pinned' && U !== 'gpu-buffer' && U !== 'ml-tensor')
                throw new Error(`Not supported preferred output location: ${U}.`);
              if (y && U !== 'gpu-buffer')
                throw new Error(
                  `Not supported preferred output location: ${U}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`,
                );
              v.push(U);
            }
          }
          ...
          return (
            v.some(
              (I) => I === 'gpu-buffer' || I === 'ml-tensor' || I === 'ml-tensor-cpu-output',
            ) &&
              ((u = o._OrtCreateBinding(i)),
              u === 0 && me("Can't create IO binding."),
              (T = {
                handle: u,
                outputPreferredLocations: v,
                outputPreferredLocationsEncoded: v
                  .map((I) => (I === 'ml-tensor-cpu-output' ? 'ml-tensor' : I))
                  .map((I) => oo(I)),
              })),
            Ut.set(i, [i, c, p, T, y, !1]),
            [i, b, _, S, x]
          );
        } catch (m) {
          throw (
            c.forEach((g) => o._OrtFree(g)),
            p.forEach((g) => o._OrtFree(g)),
            u !== 0 && o._OrtReleaseBinding(u) !== 0 && me("Can't release IO binding."),
            i !== 0 && o._OrtReleaseSession(i) !== 0 && me("Can't release session."),
            m
          );
        } finally {
          (o._free(r),
            a !== 0 && o._OrtReleaseSessionOptions(a) !== 0 && me("Can't release session options."),
            d.forEach((m) => o._free(m)),
      ...
      (Br = (t) => {
        ...
        let [n, o, i, a, u] = r;
        (a &&
          (u && e._OrtClearBoundOutputs(a.handle) !== 0 && me("Can't clear bound outputs."),
          e._OrtReleaseBinding(a.handle) !== 0 && me("Can't release IO binding.")),
          e.jsepOnReleaseSession?.(t),
          e.webnnOnReleaseSession?.(t),
          e.webgpuOnReleaseSession?.(t),
          o.forEach((d) => e._OrtFree(d)),
          i.forEach((d) => e._OrtFree(d)),
          e._OrtReleaseSession(n) !== 0 && me("Can't release session."),
          Ut.delete(t));
      }),
          ...
          if (Array.isArray(x)) {
            ...
            for (let v = 0; v < x.length; v++) {
              if (typeof x[v] != 'string')
                throw new TypeError(`tensor data at index ${v} is not a string`);
            ...
            if (c !== 'string' && v && T) {
              ...
              if (v(n, I) || T(n, I)) {
                ...
                let A = u.webnnCreateTemporaryTensor,
                  D = u.webnnUploadTensor;
                if (!A || !D)
                  throw new Error(
                ...
                ((b = x.byteLength),
                  (y = u._malloc(b)),
                  r.push(y),
                  u.HEAPU8.set(new Uint8Array(x.buffer, x.byteOffset, b), y));
            } else
              ((b = x.byteLength),
                (y = u._malloc(b)),
                r.push(y),
      ...
      (Mr = async (t, e, r, n, o, i) => {
        ...
        try {
          ...
          for (let L = 0; L < _; L++)
            (a.setValue(w + L * u, T[L], '*'), a.setValue(U + L * u, p[e[L]], '*'));
          for (let L = 0; L < S; L++)
            (a.setValue(N + L * u, I[L], '*'), a.setValue(F + L * u, m[n[L]], '*'));
          if (g && !b) {
            let { handle: L, outputPreferredLocations: Q, outputPreferredLocationsEncoded: X } = g;
            if (p.length !== _)
              throw new Error(
                `input count from feeds (${_}) is expected to be always equal to model's input count (${p.length}).`,
              );
            _t('wasm bindInputsOutputs');
            for (let Z = 0; Z < _; Z++) {
              let ne = e[Z];
              (await a._OrtBindInput(L, p[ne], T[Z])) !== 0 &&
                me(`Can't bind input[${Z}] for session=${t}.`);
            }
            for (let Z = 0; Z < S; Z++) {
              let ne = n[Z];
              o[Z]?.[3]
                ? (A.push(I[Z]),
                  a._OrtBindOutput(L, m[ne], I[Z], 0) !== 0 &&
                    me(`Can't bind pre-allocated output[${Z}] for session=${t}.`))
                : a._OrtBindOutput(L, m[ne], 0, X[ne]) !== 0 &&
                  me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
            }
            (wt('wasm bindInputsOutputs'), Ut.set(t, [c, p, m, g, y, !0]));
          }
          (a.jsepOnRunStart?.(c), a.webnnOnRunStart?.(c));
          let q;
          (g
            ? (q = await a._OrtRunWithBinding(c, g.handle, S, N, x))
            : (q = await a._OrtRun(c, U, w, _, F, S, N, x)),
            q !== 0 && me('failed to call OrtRun().'));
          let Y = [],
            z = [];
          ...
          for (let L = 0; L < S; L++) {
            ...
            if (Q === I[L] || A.includes(I[L])) {
              (Y.push(o[L]),
                Q !== I[L] && a._OrtReleaseTensor(Q) !== 0 && me("Can't release tensor."));
              continue;
            }
            let X = a.stackSave(),
              Z = a.stackAlloc(4 * u),
              ...
              le = 0;
            try {
              a._OrtGetTensorData(Q, Z, Z + u, Z + 2 * u, Z + 3 * u) !== 0 &&
                me(`Can't access output tensor data on index ${L}.`);
              let $e = u === 4 ? 'i32' : 'i64',
                M = Number(a.getValue(Z, $e));
              le = a.getValue(Z + u, '*');
              let G = a.getValue(Z + u * 2, '*'),
                be = Number(a.getValue(Z + u * 3, $e)),
                ke = [];
              ...
              if (ie === 'string') {
                ...
                for (let Te = 0; Te < ve; Te++) {
                  let qe = a.getValue(le + Te * u, '*'),
                    Ne = a.getValue(le + (Te + 1) * u, '*'),
                    Se = Te === ve - 1 ? void 0 : Ne - qe;
                ...
                let ge = a.webnnEnsureTensor,
                  Te = a.webnnIsGraphInputOutputTypeSupported;
                if (!ge || !Te)
                  throw new Error(
                    'preferredLocation "ml-tensor" is not supported without using WebNN.',
                  );
                if (xt(M, ve) === void 0 || !Wr(ie))
                  throw new Error(`Unsupported data type: ${ie}`);
                if (!Te(t, ie, !1))
                  throw new Error(
                    `preferredLocation "ml-tensor" for ${ie} output is not supported by current WebNN Context.`,
                  );
                ...
                let ge = a.webnnCreateMLTensorDownloader(le, ie)(),
                  Te = Y.length;
                ((ne = !0),
                  z.push(
                    (async () => {
                ...
                let ge = Ht(ie),
                  Te = new ge(ve);
                (new Uint8Array(Te.buffer, Te.byteOffset, Te.byteLength).set(
                  a.HEAPU8.subarray(le, le + Te.byteLength),
                ),
                  Y.push([ie, ke, Te, 'cpu']));
              }
            } finally {
              (a.stackRestore(X),
                ie === 'string' && le && a._free(le),
                ne || a._OrtReleaseTensor(Q));
            }
          }
          g &&
            !y &&
            (a._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."),
            Ut.set(t, [c, p, m, g, y, !1]));
          for (let [L, Q] of await Promise.all(z)) Y[L][2] = Q;
          return (wt('wasm ProcessOutputTensor'), Y);
        } finally {
          (a.webnnOnRunEnd?.(c),
            a.stackRestore(D),
            T.forEach((q) => a._OrtReleaseTensor(q)),
            I.forEach((q) => a._OrtReleaseTensor(q)),
            E.forEach((q) => a._free(q)),
            x !== 0 && a._OrtReleaseRunOptions(x),
            v.forEach((q) => a._free(q)));
        }
      }),
      (Rr = (t) => {
        let e = ye(),
...
var Nt,
  ...
  Wo = V(() => {
    ...
    $t();
    kr();
    ((Nt = () => !!_e.wasm.proxy && typeof document < 'u'),
      (cr = !1),
      (yn = !1),
      (_n = !1),
      (Lo = new Map()),
      ...
      (cy = (t) => {
        switch (t.data.type) {
          case 'init-wasm':
            ((cr = !1),
              t.data.err ? ((_n = !0), Vo[1](t.data.err)) : ((yn = !0), Vo[0]()),
              bn && (URL.revokeObjectURL(bn), (bn = void 0)));
            break;
          case 'init-ep':
          case 'copy-from':
          case 'create':
      ...
      (ap = async (t, e) => {
        if (Nt()) {
          ...
          return (
            ...
            new Promise((r, n) => {
              jt('create', [r, n]);
              let o = { type: 'create', in: { model: t, options: { ...e } } },
                i = [];
          ...
          return (
            ...
            new Promise((a, u) => {
              ...
              let d = r,
                c = {
                  type: 'run',
                  in: { sessionId: t, inputIndices: e, inputs: d, outputIndices: n, options: i },
                };
    ...
    ((lp = (t, e) => {
      ...
      (wn = class {
        ...
        async loadModel(e, r) {
          Ve();
          let n;
          (typeof e == 'string' ? (n = await this.fetchModelAndCopyToWasmMemory(e)) : (n = e),
            ([
              this.sessionId,
              this.inputNames,
              this.outputNames,
        ...
        async run(e, r, n) {
          ...
          Object.entries(r).forEach((g) => {
            let y = g[0],
              b = g[1],
              _ = this.outputNames.indexOf(y);
            if (_ === -1) throw new Error(`invalid output '${y}'`);
            (a.push(b), u.push(_));
          });
          let d = o.map((g, y) => lp(g, () => `input "${this.inputNames[i[y]]}"`)),
            c = a.map((g, y) => (g ? lp(g, () => `output "${this.outputNames[u[y]]}"`) : null)),
            p = await up(this.sessionId, i, d, u, c, n),
            m = {};
...
var pp,
  ...
  fp = V(() => {
    ...
    cp();
    ((pp = () => {
      (typeof _e.wasm.initTimeout != 'number' || _e.wasm.initTimeout < 0) &&
        (_e.wasm.initTimeout = 0);
      let t = _e.wasm.simd;
      if (
        (typeof t != 'boolean' &&
          t !== void 0 &&
          ...
          (_e.wasm.simd = !1)),
        typeof _e.wasm.proxy != 'boolean' && (_e.wasm.proxy = !1),
        typeof _e.wasm.trace != 'boolean' && (_e.wasm.trace = !1),
        typeof _e.wasm.numThreads != 'number' ||
          !Number.isInteger(_e.wasm.numThreads) ||
          _e.wasm.numThreads <= 0)
      )
        if (typeof self < 'u' && !self.crossOriginIsolated) _e.wasm.numThreads = 1;
        else {
          let e =
            typeof navigator > 'u' ? qn('node:os').cpus().length : navigator.hardwareConcurrency;
...
Object.defineProperty(_e.versions, 'web', { value: ds, enumerable: !0 });
export {
  Pf as InferenceSession,
  Cr as TRACE,
