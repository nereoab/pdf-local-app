...
var ort = (() => {
      ...
      ((Ct = new Map()),
        ...
        (Ge = (e, t, n) => {
          if (
            ...
            let r = Ct.get(e);
            if (r === void 0) Ct.set(e, { backend: t, priority: n });
            else {
  ...
  var An,
    ...
    Or = k(() => {
      ...
      ((An = (e, t) => {
        ...
        return u === 'RGBA'
          ? new fe('float32', l, [1, 4, n, r])
          : new fe('float32', l, [1, 3, n, r]);
      }),
        (kr = async (e, t) => {
        ...
        (Ur = () => {
          if (!Mr) {
            ...
            let e = typeof BigInt64Array < 'u' && BigInt64Array.from,
              ...
              r = typeof n < 'u' && n.from;
            (e && (Xe.set('int64', BigInt64Array), ft.set(BigInt64Array, 'int64')),
              t && (Xe.set('uint64', BigUint64Array), ft.set(BigUint64Array, 'uint64')),
              r ? (Xe.set('float16', n), ft.set(n, 'float16')) : Xe.set('float16', Uint16Array));
          }
        }));
    });
  var Vr,
  ...
  var ht,
    ...
    kn = k(() => {
      ...
      Cn();
      ((ht = (e, t) => {
        (typeof pe.trace > 'u' ? !pe.wasm.trace : !pe.trace) ||
  ...
  var Xr,
    ...
    eo = k(() => {
      ...
      rd = Yr ? null : (e) => new Worker(e ?? $e, { type: 'classic', name: Xr });
    });
  var od,
    id,
    $e,
    ...
    Pt = k(() => {
      'use strict';
      kt();
      ((od = typeof location > 'u' ? void 0 : location.origin),
        (id = () => {
          if (!!1)
        ...
        (ud = async (e) => (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ e)).default),
        (to = (eo(), mt(Jr)).default),
        (oo = async () => {
          if (!$e)
    ...
    co = k(() => {
      ...
      ((pd = (e) => {
          ...
          for (let o of r) {
            ...
            switch (i) {
              case 'webnn':
                if (
                  ((i = 'WEBNN'),
                  st(e, 'session.disable_quant_qdq', '1', n),
                  st(e, 'session.disable_qdq_constant_folding', '1', n),
                  typeof o != 'string')
                ) {
                  let p = o?.deviceType;
            ...
            let a = ve(i, n),
              ...
              l = 0;
            if (u > 0) {
              ((d = ne()._malloc(u * ne().PTR_SIZE)),
                n.push(d),
                (l = ne()._malloc(u * ne().PTR_SIZE)),
                n.push(l));
              for (let c = 0; c < u; c++)
                (ne().setValue(d + c * ne().PTR_SIZE, s[c][0], '*'),
                  ne().setValue(l + c * ne().PTR_SIZE, s[c][1], '*'));
            }
            (await ne()._OrtAppendExecutionProvider(e, a, d, l, u)) !== 0 &&
        ...
        (lo = async (e) => {
          ...
          fd(o);
          try {
            let i = pd(o.graphOptimizationLevel ?? 'all'),
              s = md(o.executionMode ?? 'sequential'),
            ...
            let l =
              typeof o.optimizedModelFilePath == 'string' ? ve(o.optimizedModelFilePath, r) : 0;
            if (
              ...
              o.executionProviders && (await hd(n, o, r)),
  ...
  var gd,
    ...
    Pe = k(() => {
      ...
      ((gd = ['V', 'I', 'W', 'E', 'F']),
        (yd = (e, t) => {
          console.log(`[${gd[e]},${new Date().toISOString()}]${t}`);
        }),
        (Ft = (e, t) => {
          ((po = e), (mo = t));
        }),
        (bd = (e, t) => {
          let n = bt(e),
            r = bt(po);
          n >= r && yd(n, typeof t == 'function' ? t() : t);
        }),
        (Z = (...e) => {
          mo && bd(...e);
        }));
      ...
      ((yo = new Map([
        ...
        (_d = (e, t) => {
          ...
          let o = e.byteLength / r,
            i = new (at(t))(e.buffer, e.byteOffset, o);
          switch (t) {
            case 'int64':
            case 'uint64': {
        ...
        (Zt = class {
          ...
          async ensureTensor(t, n, r, o) {
            ...
            if (!s?.input.dataTypes.includes(n)) {
              if (((a = $d.get(n)), !a || s?.input.dataTypes.includes(a)))
            ...
            if (this.wrapper) {
              if (this.wrapper.fallbackType)
                if (this.wrapper.fallbackType === 'int32')
                  ((n = _d(t, this.wrapper.type)), this.wrapper.setIsDataConverted(!0));
                else
        ...
        (Ln = class {
          ...
          registerTensor(t, n, r, o) {
            ...
            return (
              this.tensorTrackersById.set(s, new Zt(this, a)),
    ...
    vo = k(() => {
      ...
      ((Qt = new Map([
        ...
        (Xt = class {
          ...
          onRunStart(t) {
            (Z('verbose', () => `[WebNN] onRunStart {sessionId: ${t}}`),
...
`)
  ...
  var Td,
    ...
    Le = k(() => {
      ...
      ((Td = (e, t) => {
        ...
        (Id = (e, t) => x.sortBasedOnPerm(e, ko(e.length, t))),
        (Cd = (e, t, n, r) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
          ...
          let { newShape: l, newPerm: c } = Ad(e.dims, o),
       ...
       `,
        ...
        (De = (e, t, n, r) => {
          ...
          let s = x.normalizeAxes(i, e.inputs[0].dims.length),
            a = s,
            u = e.inputs[0],
            d = Rd(a, e.inputs[0].dims.length);
          d.length > 0 &&
            ((u = e.compute(me(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0]),
            (a = Bd(a.length, u.dims.length)));
          let [l, c] = Od(u.dims, a),
            p = l;
          (o.keepDims && (p = Md(l, s)),
            e.compute(Vd(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] }));
        }),
        (Do = (e, t) => {
  ...
  var Be,
    ...
    tn = k(() => {
      ...
      ((Be = (e) => {
        ...
        (Ld = (e) => ['', '', `var value = ${e.getByIndices('input_indices')};`, '']),
        ...
        (Oe = (e, t, n, r) => {
          ...
          e.compute(
            nn(
              ...
              [o[0]],
              i.noopWithEmptyAxes && i.axes.length === 0 ? Ld : r,
              i.axes,
              o[0].dataType,
              i.keepDims,
              i.noopWithEmptyAxes,
     ...
     output[outputIdx] = value;
        ...
        (ut = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          ...
          (m && x.size(m.dims) > 0 && w.push(m),
            l && w.push(l),
            c && w.push(c),
            e.compute(el(p, _, r, m, d, h, l, c), { inputs: w, outputs: p > 1 ? [0, 2] : [0] }));
        }),
        (tl = (e, t) => {
    ...
    ${b.setByOffset('global_idx', 'value')}
        ...
        (ii = (e, t) => {
          let { inputs: n, outputCount: r } = e,
            o = ol({ ...t, outputCount: r });
          if ((te.webgpu.validateInputContent && nl(n, o), t.trainingMode))
...
`),
        (ll = (e) => `quick_gelu_impl(${e})`),
        (Fi = (e, t) => {
          let n = de(e.inputs[0].dataType);
          e.compute(
            ee(e.inputs[0], 'QuickGelu', ll, dl(n, t.alpha), t.cacheKey, e.inputs[0].dataType),
          );
        }));
    });
  var cl,
...
`;
    ...
    `;
        ...
        (vt = (e, t, n, r, o = !1, i) => {
          ...
          let O = (W) => {
            ...
            Ee(t, X);
            let Te = re(j.type.tensor),
              se = Ce(t, j.type.value, Te),
              A = xl(_, M, se, [U, G, N, j], o);
            return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${j}>` : j}) {
        ...
        setOutputAtIndex(flatIndex ${h ? '/ 4' : ''}, value);
              ...
              Te = S('w', e[1].dataType, e[1].dims.length, N),
              se = [X, Te],
      ...
      ((Tl = (e) => {
        ...
        (bs = (e, t, n, r, o, i) => {
          let s = i === 'channelsLast',
            ...
            d = [64, 1, 1],
            l = { x: n.map((g, _) => _) },
            c = [Math.ceil(Tl(l.x.map((g) => n[g])) / d[0]), 1, 1];
  ...
  var Al,
    ...
    Ss = k(() => {
      ...
      ((Al = (e, t, n, r, o, i) => {
        ...
        (xs = (e, t, n, r) => {
          let o = n.format === 'NHWC',
            i = Al(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
          if (n.group !== 1) {
            let $ = [t[0]];
            if (o) {
              let I =
          ...
          if (
            ...
            M < 8 && O < 8
              ...
              : e.compute(vt(z, n, i, E, o, r), { inputs: z });
            return;
          }
          let b = !0,
            y =
  ...
  var zl,
    ...
    Ps = k(() => {
      ...
      Ke();
      Le();
      ((zl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
        (Dl = (e, t, n, r, o) => {
      ...
      ((je = 256),
        ...
        (Nl = (e, t, n, r, o) => {
          let i = n / e,
            ...
            u = `  for (var t = local_idx; t < ${i}u; t += ${je}u) {
`;
...
`;
    ...
    workgroupBarrier();`;
              let { code: y, resultOffset: g } = Wl(l, n, u),
  ...
  var Ql,
    ...
    Js = k(() => {
      ...
      ((Ql = (e) => {
        ...
        (Xl = (e, t) => (e.length > t.length ? Xs(e, t) : Xs(t, e))),
        (Yl = (e) => {
          let t = e[0].dims,
            n = Array.from(e[1].getBigInt64Array(), Number),
            r = Xl(t, n),
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        (ia = (e, t) => {
          ...
          let m = nc(e, n[1], p, t.batchDims, r, a, c, l, s),
            h = t.batchDims + s;
          if (h > r.length)
            throw new Error(
...
`),
  ...
  var _e,
    ...
    lr = k(() => {
      ...
      q();
      Le();
      ((_e = (e, t) => (e.length > t && e[t].dims.length > 0 ? e[t] : void 0)),
        (_c = (e, t) => {
          let n = e[0],
            r = _e(e, 1),
            o = _e(e, 2),
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
        ...
        (va = (e, t) => {
          ...
          let c = o && i && o.dims.length === 4 && i.dims.length === 4,
            p = xt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
...
`)}
        ...
        (Ia = (e, t, n) => {
          ...
          return (
            t.dims.length === 3 &&
              ...
              (r = e.compute(me(r, Cc.perm), { inputs: [r], outputs: [-1] })[0])),
            r
          );
        }),
        (Ac = (e, t, n, r) => {
  ...
  var gn,
    ...
    ru = k(() => {
      ...
      ((gn = (e) => {
        ...
        (Fc = (e) => `${Ha(e)};${e.countIncludePad}`),
        (qc = (e) => `${Ha(e)};${e.storageOrder};${e.dilations}`),
        (Fa = (e) => ({
          format: e.format,
      ...
      ((Qc = (e, t, n) => {
        ...
        (au = (e) => {
          ...
          (e.inputs[0].dataType === 6
            ...
            te.webgpu.validateInputContent && Qc(t, n, r),
            e.compute(Xc(t, n, r, e.inputs[0].dataType), { inputs: [] }));
        }));
    });
  var Yc,
    Jc,
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Yc(t.reduction, 'output[data_offset + i]', 'value', m.type.value)}
        ...
        (lu = (e, t) => {
          e.compute(Jc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        }));
    });
  var ep,
    tp,
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
        ...
        (fp = (e, t, n, r, o, i) => {
          let s = e.dims,
            a = ip(i, t.axes, s.length),
            u = sp(s, r, o, t.axes),
            d = r.slice();
          r.length === 0 &&
            ((d = s.map((g, _) => (g === 0 ? 1 : u[_] / g))),
            t.keepAspectRatioPolicy !== 'stretch' && (u = ap(s, d, t)));
          ...
          case 'cubic':
            ...
            ${(() => {
              if (s.length === 2 || s.length === 4)
                return `${pp(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
              throw Error(
      ...
      ${v.mainStart([b, 1, 1])}
        ...
        (yu = (e, t) => {
          ...
          (e.outputCount > 1 && r.push(-3),
            ...
            e.compute(yp(e.inputs, t, e.outputCount, !1), { outputs: r }));
        }));
    });
  var bp,
    yn,
...
${a}`,
        ...
        (kp = (e, t, n) => {
          ...
          return (
            ...
            (r +=
              ':' +
              n +
              `:${Ep(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill('dims'))}`),
            r
          );
        }),
        (fr = class {
            ...
            ((this.adapterInfo = new fr(a)),
              ...
              (this.device.onuncapturederror = (u) => {
                u.error instanceof GPUValidationError &&
                  console.error(
                    `An uncaught WebGPU validation error was raised: ${u.error.message}`,
                  );
              }),
          ...
          run(t, n, r, o, i, s) {
            ...
            for (let _ = 0; _ < u.length; ++_) {
              ...
              if ((w && this.temporaryData.push(T), v)) {
                ...
                (I || ((I = []), this.kernelPersistentData.set(this.currentKernelId, I)),
                  I.push(T));
              }
              f.push(T);
            }
        ...
        (gr = class {
          ...
          compute(t, n) {
            let r =
              ...
              o = n?.outputs ?? [],
              i = (a, u, d) => new St(this.module, u, this.output(a, d), d),
              s = (a, u) => {
                let d = qe(a, u);
    ...
    zn = k(() => {
      ...
      ((zp = (e, t) => {
        ...
        (Bt = async (e, t) => {
          ...
          {
            let r = (Uu(), mt(Mu)).init;
            (t === 'webgpu' && (await r('webgpu', ne(), e, n)),
              t === 'webnn' && (await r('webnn', ne(), e)));
          }
        }),
        (rt = new Map()),
        (Dp = (e) => {
        ...
        (Ut = async (e, t, n, r, o, i) => {
          ...
          try {
            ...
            if (p && !m) {
              ...
              (Ve('wasm bindInputsOutputs'), rt.set(e, [d, l, c, p, f, !0]));
            }
              ...
              try {
                ...
                if (Q === 'string') {
                  ...
                  for (let le = 0; le < ae; le++) {
                    let We = s.getValue(X + le * a, '*'),
                      It = s.getValue(X + (le + 1) * a, '*'),
                      wr = le === ae - 1 ? void 0 : It - We;
  ...
  var ot,
    ...
    _r = k(() => {
      ...
      He();
      Pt();
      ((ot = () => !!te.wasm.proxy && typeof document < 'u'),
        (Tt = !1),
        (wn = !1),
        ($n = !1),
        (br = new Map()),
  ...
  Object.defineProperty(te.versions, 'web', { value: Qr, enumerable: !0 });
  return mt(Vp);
})();
/**
 * @license
