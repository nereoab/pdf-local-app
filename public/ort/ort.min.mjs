  ...
  td = (e, t, n, r) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let o of Ju(t))
        !ed.call(e, o) &&
          o !== n &&
          Sn(e, o, { get: () => t[o], enumerable: !(r = Yu(t, o)) || r.enumerable });
    return e;
  };
var Tt = (e) => td(Sn({}, '__esModule', { value: !0 }), e);
var It,
  Ze,
  Qe,
  nd,
    ...
    ((It = new Map()),
      ...
      (Qe = (e, t, n) => {
        if (
          ...
          let r = It.get(e);
          if (r === void 0) It.set(e, { backend: t, priority: n });
          else {
...
var An,
  ...
  Or = k(() => {
    ...
    ((An = (e, t) => {
      ...
      (Br = (e, t, n) =>
        new fe({ location: 'cpu-pinned', type: e, data: t, dims: n ?? [t.length] })));
  });
var Xe,
  mt,
  Mr,
      ...
      (Ur = () => {
        if (!Mr) {
          ...
          let e = typeof BigInt64Array < 'u' && BigInt64Array.from,
            ...
            r = typeof n < 'u' && n.from;
          (e && (Xe.set('int64', BigInt64Array), mt.set(BigInt64Array, 'int64')),
            t && (Xe.set('uint64', BigUint64Array), mt.set(BigUint64Array, 'uint64')),
            r ? (Xe.set('float16', n), mt.set(n, 'float16')) : Xe.set('float16', Uint16Array));
        }
      }));
  });
var Vr,
...
var Et,
  Gr = k(() => {
    ...
    Et = class e {
      ...
      async run(t, n, r) {
        (_e(), Ne('InferenceSession.run'));
        let o = {},
          i = {};
        if (typeof t != 'object' || t === null || t instanceof Te || Array.isArray(t))
          throw new TypeError(
        ...
        if (typeof n == 'object') {
          ...
          if (Array.isArray(n)) {
            ...
            for (let c of this.outputNames)
              if (l.indexOf(c) !== -1) {
                let p = n[c];
                (p === null || p instanceof Te) && ((d = !0), (s = !1), (o[c] = p));
              }
            if (d) {
              if (typeof r == 'object' && r !== null) i = r;
              else if (typeof r < 'u') throw new TypeError("'options' must be an object.");
...
var Qr,
  ...
  Jr = k(() => {
    ...
    Ge();
    Pt();
    ((Qr = 'ort-wasm-proxy-worker'), (Xr = globalThis.self?.name === Qr));
    Xr &&
      (self.onmessage = (e) => {
        ...
        try {
          switch (t) {
            ...
            case 'run': {
              ...
              Ut(r, o, i, s, new Array(s.length).fill(null), a).then(
                (u) => {
                  u.some((d) => d[3] !== 'cpu')
                    ? postMessage({
                        type: t,
                    ...
                    : postMessage({ type: t, out: u }, Vt([...i, ...u]));
                },
                (u) => {
    ...
    od = Xr ? null : (e) => new Worker(e ?? $e, { type: 'module', name: Qr });
  });
var no,
  id,
  sd,
  ...
  Pt = k(() => {
    'use strict';
    kt();
    ((no = typeof location > 'u' ? void 0 : location.origin),
      (id = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (sd = () => {
        if (!!1) {
          if (id) {
            let e = URL;
            return new URL(new e('ort.min.mjs', import.meta.url).href, no).href;
          }
      ...
      (Dn = (e, t) => {
        try {
          let n = t ?? $e;
          return (n ? new URL(e, n) : new URL(e)).origin === no;
        } catch {
          return !1;
        }
      }),
      ...
      (dd = async (e) => (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ e)).default),
      (eo = (Jr(), Tt(Yr)).default),
      (oo = async () => {
        if (!$e)
          throw new Error('Failed to load proxy worker: cannot determine the script source URL.');
        if (Dn($e)) return [void 0, eo()];
        let e = await ro($e);
        return [e, eo(e)];
      }),
      (to = void 0),
      (io = async (e, t, n, r) => {
        ...
        if (o) return [void 0, to];
        {
          let i = 'ort-wasm-simd-threaded.jsep.mjs',
            s = e ?? ad(i, t),
            a = !!1 && n && s && !Dn(s, t),
            u = a ? await ro(s) : (s ?? ud(i, t));
          return [a ? u : void 0, await dd(u)];
        }
      }));
  });
var Bn,
        ...
        for (let o of r) {
          ...
          switch (i) {
            case 'webnn':
              if (
                ((i = 'WEBNN'),
                it(e, 'session.disable_quant_qdq', '1', n),
                it(e, 'session.disable_qdq_constant_folding', '1', n),
                typeof o != 'string')
              ) {
                let p = o?.deviceType;
                p && it(e, 'deviceType', p, n);
              }
              break;
            case 'webgpu':
              if (((i = 'JS'), typeof o != 'string')) {
                ...
                if (c?.preferredLayout) {
                  ...
                  it(e, 'preferredLayout', c.preferredLayout, n);
                }
              }
              break;
            case 'wasm':
          ...
          let a = ve(i, n),
            ...
            l = 0;
          if (u > 0) {
            ((d = te()._malloc(u * te().PTR_SIZE)),
              n.push(d),
              (l = te()._malloc(u * te().PTR_SIZE)),
              n.push(l));
            for (let c = 0; c < u; c++)
              (te().setValue(d + c * te().PTR_SIZE, s[c][0], '*'),
                te().setValue(l + c * te().PTR_SIZE, s[c][1], '*'));
          }
          (await te()._OrtAppendExecutionProvider(e, a, d, l, u)) !== 0 &&
            Y(`Can't append execution provider: ${i}.`);
        }
      }),
      (lo = async (e) => {
        let t = te(),
        ...
        hd(o);
        try {
          let i = md(o.graphOptimizationLevel ?? 'all'),
            s = fd(o.executionMode ?? 'sequential'),
            a = typeof o.logId == 'string' ? ve(o.logId, r) : 0,
          ...
          if (
            ...
            o.executionProviders && (await gd(n, o, r)),
            ...
            it(n, 'enableGraphCapture', o.enableGraphCapture.toString(), r);
          }
          ...
          throw (
            n !== 0 && t._OrtReleaseSessionOptions(n) !== 0 && Y("Can't release session options."),
...
var He,
  ...
  L = k(() => {
    ...
    ((He = (e) => {
      ...
      (Fe = (e, t) => {
        let n = [-1, 4, 1, 1, 2, 2, 4, 8, -1, 1, 2, 8, 4, 8, -1, -1, -1, -1, -1, -1, -1, 0.5, 0.5][
            e
          ],
  ...
  Un = k(() => {
    ...
    yt = async (e) => {
      if (typeof e == 'string')
        if (!1)
          try {
            let { readFile: t } = Tn('node:fs/promises');
            return new Uint8Array(await t(e));
          } catch (t) {
            if (t.code === 'ERR_FS_FILE_TOO_LARGE') {
              let { createReadStream: n } = Tn('node:fs'),
                r = n(e),
                o = [];
...
var yd,
  ...
  Pe = k(() => {
    ...
    ((yd = ['V', 'I', 'W', 'E', 'F']),
      (bd = (e, t) => {
        console.log(`[${yd[e]},${new Date().toISOString()}]${t}`);
      }),
      (Ft = (e, t) => {
        ((po = e), (mo = t));
      }),
      (_d = (e, t) => {
        let n = gt(e),
          r = gt(po);
        n >= r && bd(n, typeof t == 'function' ? t() : t);
      }),
      (Z = (...e) => {
        mo && _d(...e);
      }));
...
var Rn,
  ...
  H = k(() => {
    ...
    ((Rn = class {
      ...
      (Je = class e {
        ...
        static computeShapeHelper(t, n, r, o, i, s, a, u, d = 0) {
          if (t) for (let l = 0; l < n.length - 2; l++) r.push(1);
            ...
            for (let l = 0; l < n.length - 2; l++)
              r.push(
                e.adjustPadAndReturnShape(n[l + 2], o[l], i[l], s[l], a, l, l + n.length - 2, u, d),
              );
        }
        ...
        static adjustPadAndReturnShape(t, n, r, o, i, s, a, u, d = 0) {
          ...
          if (u && u !== 'NOTSET')
            switch (u) {
              case 'VALID':
                return ((i[s] = 0), (i[a] = 0), e.computeOutputSize(t - l, n, t, 0, d));
              case 'SAME_LOWER':
              case 'SAME_UPPER':
                if (r !== 1) throw new Error('Dilation not supported for SAME_UPPER or SAME_LOWER');
                {
                  ...
                  return (
                    (i[s] = Math.floor(u === 'SAME_LOWER' ? (p + 1) / 2 : p / 2)),
                    (i[a] = p - i[s]),
                    e.computeOutputSize(t + i[s] + i[a] - l, n, t, i[s], d)
                  );
                }
              default:
      ...
      (fo = -34028234663852886e22),
      (ho = 34028234663852886e22));
  });
var Kt,
  Vn = k(() => {
    'use strict';
    ...
    ((yo = new Map([
      ...
      (wd = (e, t) => {
        ...
        let o = e.byteLength / r,
          i = new (st(t))(e.buffer, e.byteOffset, o);
        switch (t) {
          case 'int64':
          case 'uint64': {
        ...
        async read(t) {
          if (this.fallbackDataType) {
            let n = await this.mlContext.readTensor(this.mlTensor),
              r = bo(new Uint8Array(n), this.dataType);
            if (t) {
              (t instanceof ArrayBuffer
                ? new Uint8Array(t)
      ...
      (Zt = class {
        ...
        async ensureTensor(t, n, r, o) {
          let i = this.tensorManager.getMLContext(t),
            s = this.tensorManager.getMLOpSupportLimits(t),
            a;
          if (!s?.input.dataTypes.includes(n)) {
            if (((a = vd.get(n)), !a || s?.input.dataTypes.includes(a)))
              throw new Error(`WebNN backend does not support data type: ${n}`);
            Z(
              'verbose',
              () => `[WebNN] TensorIdTracker.ensureTensor: fallback dataType from ${n} to ${a}`,
            );
          }
          if (this.wrapper) {
            if (this.wrapper.canReuseTensor(i, n, r)) return this.wrapper.tensor;
            if (o) {
              if (this.wrapper.byteLength !== _o(n, r))
          ...
          return (
            (this.wrapper = await this.tensorManager.getCachedTensor(t, n, r, u, !0, !0, a)),
            o &&
              this.activeUpload &&
          ...
          if (this.wrapper) {
            if (this.wrapper.fallbackType)
              if (this.wrapper.fallbackType === 'int32')
                ((n = wd(t, this.wrapper.type)), this.wrapper.setIsDataConverted(!0));
            ...
            if (t.byteLength === this.wrapper.byteLength) {
              ...
              (Z('verbose', () => 'Data size does not match tensor size. Releasing tensor.'),
                this.releaseTensor());
          }
        ...
        async download(t) {
          if (this.activeUpload) {
            let n = this.wrapper?.isDataConverted
              ? bo(this.activeUpload, this.wrapper?.type)
              : this.activeUpload;
            if (t) {
              t instanceof ArrayBuffer
      ...
      (Ln = class {
        ...
        registerTensor(t, n, r, o) {
          let i = this.getMLContext(t),
            s = go(),
            a = new jt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
    ...
    ((Qt = new Map([
      ...
      (Xt = class {
        ...
        onRunEnd(t) {
          ...
          if (n) {
            for (let r of n)
              (Z('verbose', () => `[WebNN] releasing temporary tensor {tensorId: ${r}}`),
        ...
        async createMLContext(t) {
          ...
          let n = this.mlContextCache.findIndex((r) => xd(r.options, t));
        ...
        registerMLContext(t, n) {
          ...
          (r || ((r = new Set()), this.sessionIdsByMLContext.set(n, r)),
            ...
            this.mlOpSupportLimitsBySessionId.has(t) ||
              this.mlOpSupportLimitsBySessionId.set(t, n.opSupportLimits()),
        ...
        releaseTensorId(t) {
          (Z('verbose', () => `[WebNN] releaseTensorId {tensorId: ${t}}`),
        ...
        uploadTensor(t, n) {
          ...
          (Z('verbose', () => `[WebNN] uploadTensor {tensorId: ${t}, data: ${n.byteLength}}`),
        ...
        isGraphInputOutputTypeSupported(t, n, r = !0) {
          let o = Qt.get(He(n)),
            i = this.mlOpSupportLimitsBySessionId.get(t);
          return typeof o > 'u'
            ? !1
            : r
    ...
    ((xo = new Map([
      ...
      (Gn = class {
        constructor(t) {
          ...
          for (let [n] of xo)
            (Nn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []));
          this.sessionCount = 0;
        }
        upload(t, n) {
          let r = n.buffer,
          ...
          if (s === i && o % 4 === 0)
            this.backend.device.queue.writeBuffer(a.gpuData.buffer, 0, r, o, i);
          else {
        ...
        unregisterExternalBuffer(t) {
          t !== void 0 &&
            ...
            Z('verbose', () => `[WebGPU] GpuDataManager.unregisterExternalBuffer() => id=${t}`));
        }
        create(t, n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
          ...
          let a = { id: So(), type: 0, buffer: o };
          return (
            this.storageCache.set(a.id, { gpuData: a, originalSize: Number(t) }),
            Z('verbose', () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${a.id}`),
            a
          );
        }
        get(t) {
        ...
        onReleaseSession(t) {
          ...
          (n &&
            ...
            (this.sessionCount -= 1),
            this.sessionCount === 0 &&
              (Z('warning', () => '[WebGPU] Clearing webgpu buffer cache'),
...
var et,
  ...
  q = k(() => {
    ...
    ((et = 64),
      ...
      (J = (e) => (e % 4 === 0 ? 4 : e % 2 === 0 ? 2 : 1)),
      (jn = (e = 'f32', t, n = '0') => (!t || t === 1 ? `${e}(${n})` : `vec${t}<${e}>(${n})`)),
      (tt = (e, t, n) => (e === 'f32' ? n : t === 1 ? `f32(${n})` : `vec${t}<f32>(${n})`)),
      (Ie = (e, t) =>
        t === 4
          ? `(${e}.x + ${e}.y + ${e}.z + ${e}.w)`
          : t === 2
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
          ...
          w = (A) => ((m.offsetToIndices = !0), s < 2 ? A : `o2i_${e}(${A})`),
          v = [];
  ...
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join('+')};
          ...
          T = (A) => ((m.indicesToOffset = !0), s < 2 ? A : `i2o_${e}(${A})`),
          I = (...A) => (s === 0 ? '0u' : `${p.indices}(${A.map(f).join(',')})`),
          E = (A, D) => (s < 2 ? `${A}` : `${B(A, D, s)}`),
          z = (A, D, oe) => (s < 2 ? `${A}=${oe};` : `${B(A, D, s)}=${oe};`),
          M = {},
          O = (A, D) => {
            ...
            return (
              (M[oe] = `fn ${oe}(outputIndices: ${D.type.indices}) -> u32 {
          ...
          W = (A, D) =>
            (() => {
              ...
              if (p.storage === 'vec2<u32>' && p.value === 'i32')
                return `${e}[${A}]=vec2<u32>(u32(${D}), select(0u, 0xFFFFFFFFu, ${D} < 0));`;
              if (p.storage === 'vec2<u32>' && p.value === 'u32')
                return `${e}[${A}]=vec2<u32>(u32(${D}), 0u);`;
              if (p.storage === 'u32' && p.value === 'vec4<bool>')
                return `${e}[${A}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${D}));`;
              throw new Error(
    ...
    return ${K(`i2o_${e}(indices)`)};
          ...
          R =
            s < 2
              ? ''
              : (() => {
                  let A = a.map((oe) => `d${oe}: u32`).join(', '),
                    D = a.map((oe) => `d${oe}`).join(', ');
                  return `
  fn get_${e}(${A}) -> ${l} {
    return get_${e}ByIndices(${I(D)});
          ...
          G = (...A) => {
            ...
            return s === 0
              ...
              : s === 1
                ? K(D[0])
                : ((m.get = !0), (m.getByIndices = !0), (m.indicesToOffset = !0), `get_${e}(${D})`);
          },
          N = (A) =>
            s < 2
              ? K(A)
              : ((m.getByIndices = !0), (m.indicesToOffset = !0), `get_${e}ByIndices(${A})`),
          j =
            s < 2
              ? ''
              : `
        ...
        return {
          impl: () => {
            let A = [],
              D = !1;
            return (
              m.offsetToIndices && (A.push(_), (D = !0)),
              m.indicesToOffset && (A.push($), (D = !0)),
              m.broadcastedIndicesToOffset &&
                (Object.values(M).forEach((oe) => A.push(oe)), (D = !0)),
              m.set && (A.push(Q), (D = !0)),
              m.setByIndices && (A.push(j), (D = !0)),
              m.get && (A.push(R), (D = !0)),
              m.getByIndices && (A.push(U), (D = !0)),
              !i &&
                D &&
                A.unshift(
...
`)
          ...
          setByIndices: (A, D) =>
            s < 2
              ? W(A, D)
              : ((m.setByIndices = !0), (m.indicesToOffset = !0), `set_${e}ByIndices(${A}, ${D});`),
          get: G,
          getByOffset: K,
          getByIndices: N,
          usage: r,
      ...
      (Ao = (e, t, n) => Jt(e, t, n, 'atomicOutput', 1)),
      (en = (e, t, n, r = 1) => Jt(e, t, n, 'internal', r)),
      (qn = class {
        constructor(t, n) {
...
var Id,
  ...
  Re = k(() => {
    ...
    ((Id = (e, t) => {
      ...
      (ko = (e, t) => (t.length !== 0 ? t : [...new Array(e).keys()].reverse())),
      (Cd = (e, t) => x.sortBasedOnPerm(e, ko(e.length, t))),
      (Ad = (e, t, n, r) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: l, newPerm: c } = Ed(e.dims, o),
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset('global_idx', b.getByIndices('aIndices'))}
      ...
      (Po = (e, t) => {
        (Id(e.inputs, t.perm), e.compute(me(e.inputs[0], t.perm)));
      }),
      (zo = (e) => V({ perm: e.perm })));
  });
var Pd,
  ...
  Go = k(() => {
    ...
    ((Pd = {
      ...
      (De = (e, t, n, r) => {
        let o = e.inputs.length === 1 ? n : Zn(e.inputs, n),
          i = o.axes;
        i.length === 0 && !o.noopWithEmptyAxes && (i = e.inputs[0].dims.map((f, m) => m));
        let s = x.normalizeAxes(i, e.inputs[0].dims.length),
          a = s,
          u = e.inputs[0],
          d = Vd(a, e.inputs[0].dims.length);
        d.length > 0 &&
          ((u = e.compute(me(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0]),
          (a = Od(a.length, u.dims.length)));
        let [l, c] = Md(u.dims, a),
          p = l;
        (o.keepDims && (p = Ud(l, s)),
          e.compute(Ld(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] }));
      }),
      (Do = (e, t) => {
...
var Be,
  ...
  tn = k(() => {
    ...
    ((Be = (e) => {
      ...
      (Nd = (e) => ['', '', `var value = ${e.getByIndices('input_indices')};`, '']),
...
`)
      ...
      (Zn = (e, t) => {
        ...
        return (
          ...
          V({ axes: n, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes })
        );
      }),
      (Oe = (e, t, n, r) => {
        let o = e.inputs,
          i = o.length === 1 ? n : Zn(o, n);
        e.compute(
          nn(
            t,
            { hint: i.cacheKey, inputDependencies: ['rank'] },
            [o[0]],
            i.noopWithEmptyAxes && i.axes.length === 0 ? Nd : r,
            i.axes,
            o[0].dataType,
            i.keepDims,
            i.noopWithEmptyAxes,
...
`)}`,
      ...
      (Ho = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Kd(e, t) : Do(e, t);
      }),
      (Fo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Gd(e, t) : Bo(e, t);
      }),
      (qo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Hd(e, t) : Oo(e, t);
      }),
      (Ko = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Fd(e, t) : Mo(e, t);
      }),
      (jo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? qd(e, t) : Uo(e, t);
      }),
      (Zo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? jd(e, t) : Ro(e, t);
      }),
      (Qo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Zd(e, t) : Vo(e, t);
      }),
      (Xo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Qd(e, t) : Lo(e, t);
      }),
      (Yo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Xd(e, t) : No(e, t);
      }),
      (Jo = (e, t) => {
        Me(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Wd(e, t) : Wo(e, t);
      }));
  });
var ei,
  ti,
  ...
  ${E.mainStart([g, g, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        return {
          name: 'AttentionProbs',
          shaderCache: { hint: `${b};${o !== void 0};${r !== void 0};${e}`, inputDependencies: $ },
          getRunData: () => ({ outputs: T, dispatchGroup: _, programUniforms: w }),
          getShaderSource: I,
        };
      }),
      (tl = (e, t, n, r, o, i, s = void 0, a = void 0) => {
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      (at = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
        let p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)),
          f = p > 1 ? s : void 0,
          m = p > 1 ? a : void 0,
          h = p > 1 ? d.pastSequenceLength : 0,
          b = h + d.kvSequenceLength,
          y = u && x.size(u.dims) > 0 ? u : void 0,
          g = [t, n];
        (f && x.size(f.dims) > 0 && g.push(f), y && g.push(y), l && g.push(l), c && g.push(c));
        let _ = e.compute(el(p, t, n, f, y, d, h, l, c), {
          inputs: g,
          outputs: p > 1 ? [-1, 1] : [-1],
        })[0];
        e.compute(Jd(_, d.batchSize, d.numHeads, h, d.sequenceLength, b, l, c), {
          inputs: l && c ? [_, l, c] : [_],
          outputs: [],
        });
        let w = [_, r];
        (m && x.size(m.dims) > 0 && w.push(m),
          l && w.push(l),
          c && w.push(c),
          e.compute(tl(p, _, r, m, d, h, l, c), { inputs: w, outputs: p > 1 ? [0, 2] : [0] }));
      }),
      (nl = (e, t) => {
  ...
  ${c.mainStart([s, s, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      (oi = (e, t) => {
        let n = Yd(e.inputs, t),
          [r, o, i] = nl(e, n);
        return at(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
      }));
  });
var rl,
  ol,
    ...
    ${b.setByOffset('global_idx', 'value')}
      ...
      (ii = (e, t) => {
        let { inputs: n, outputCount: r } = e,
          o = il({ ...t, outputCount: r });
        if ((ne.webgpu.validateInputContent && rl(n, o), t.trainingMode))
...
var sl,
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset('global_idx', 'value')}
      ...
      (ai = (e) => {
        (sl(e.inputs), e.compute(al(e.inputs)));
      }));
  });
var ul,
  ee,
      ...
      (ee = (e, t, n, r, o, i = e.dataType, s, a) => {
        ...
        return (
          s && u.push(...s),
          {
            ...
            getShaderSource: (d) => ul(d, x.size(e.dims), e.dataType, i, n, r, a),
            getRunData: (d) => ({
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
      ...
      (Pi = (e) => {
        let t = de(e.inputs[0].dataType);
        e.compute(
          ee(e.inputs[0], 'Relu', (n) => `select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`),
        );
      }),
      (zi = (e) => {
      ...
      (Oi = (e) => {
        ...
        e.compute(
          ee(
            ...
            'HardSwish',
            (n) =>
              `${n} * max(vec4<${t}>(0.0), min(vec4<${t}>(1.0), vec4<${t}>(${t}(1.0 / 6.0)) * ${n} + vec4<${t}>(0.5)))`,
          ),
        );
      }),
      (Mi = (e) => {
      ...
      (Li = (e) => `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`),
      (Ni = (e) => {
...
`),
      (cl = (e) => `quick_gelu_impl(${e})`),
      (Fi = (e, t) => {
        let n = de(e.inputs[0].dataType);
        e.compute(
          ee(e.inputs[0], 'QuickGelu', cl, ll(n, t.alpha), t.cacheKey, e.inputs[0].dataType),
        );
      }));
  });
var pl,
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset('global_idx', 'valueLeft * geluRight')}
      ...
      (Ki = (e) => {
        (pl(e.inputs), e.compute(ml(e.inputs)));
      }));
  });
var fl,
  hl,
  ...
  is = k(() => {
    ...
    ((fl = (e, t, n, r, o, i, s, a, u, d, l, c) => {
      ...
      (hl = (e, t, n, r, o, i, s = n.dataType) => {
        let a = n.dims.map(Number),
          u = r.dims.map(Number),
          d = !x.areEqual(a, u),
          l = a,
          c = x.size(a),
        ...
        return (
          m.push(p),
          {
            ...
            getShaderSource: (h) => fl(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
            getRunData: () => ({
      ...
      (Ue = (e, t, n, r, o, i) => {
        e.compute(hl(t, o ?? '', e.inputs[0], e.inputs[1], n, r, i));
      }),
      (Zi = (e) => {
        Ue(e, 'Add', (t, n) => `${t}+${n}`);
      }),
  ...
  ${h.mainStart()}
    ...
    ${_l(s, c)}
      ...
      (ss = (e, t) => {
        ...
        e.compute(wl(s, o, i, n[0].dataType), { inputs: s });
      }),
      (as = (e) => V({ axis: e.axis })));
  });
var Ce,
...
`;
      ...
      (dn = (e, t, n, r, o = !1, i) => {
        ...
        let w = (v) => {
          let $ = en('batch_dims', e[0].dataType, b.length),
            T = S('a', e[0].dataType, s.length, p),
            I = S('b', e[1].dataType, a.length, c),
            E = C('output', e[0].dataType, g.length, c),
            z = re(E.type.tensor),
            M = Ce(t, E.type.value, z),
            O = [T, I],
            W = '';
          if (h) {
            let R = o ? c : 1;
            (O.push(S('bias', e[2].dataType, e[2].dims.length, R)),
              (W = `${o ? `value += bias[col / ${R}];` : `value += ${E.type.value}(bias[row + i]);`}`));
          }
          let K = [
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      (tr = (e, t, n = 'f32', r, o = !1, i = 32, s = !1, a = 32, u = !1) => {
        let d = e[1] * t[1],
          l = e[0] * t[0],
          c = o ? d : i,
          p = o ? i : d;
    ...
    `;
      ...
      (wt = (e, t, n, r, o = !1, i) => {
        let s = e[0].dims,
          ...
          b = p <= 8 ? [4, 1, 1] : [4, 4, 1],
          y = [8, 8, 1],
          g = [Math.ceil(m / y[0] / b[0]), Math.ceil(p / y[1] / b[1]), Math.ceil(c / y[2] / b[2])],
          _ = h ? 4 : 1,
          w = [...u, p, f / _],
          v = w.length,
          $ = [...d, f, m / _],
        ...
        let O = (W) => {
          let K = l.length,
            U = en('batchDims', e[0].dataType, K, 1),
            R = re(e[0].dataType),
            G = S('a', e[0].dataType, v, _),
            N = S('b', e[1].dataType, T, _),
            j = C('result', e[0].dataType, I.length, _),
            Q = [G, N];
          if (M) {
            let D = o ? _ : 1;
          ...
          Ee(t, X);
          let Se = re(j.type.tensor),
            se = Ce(t, j.type.value, Se),
            A = Sl(_, M, se, [U, G, N, j], o);
          return `
  ${W.registerUniforms(X)
    .registerInternalVariables(U)
...
var Tl,
  ...
  fs = k(() => {
    ...
    cs();
    cn();
    ((Tl = (e, t, n, r, o = !1, i, s = 4, a = 4, u = 4, d = 'f32') => {
      let l = (z) => {
          switch (z) {
            case 1:
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      (ms = (e, t, n, r, o, i, s, a, u) => {
        let d = t.format === 'NHWC',
          ...
          g = [8, 8, 1],
          _ = r <= 8 ? [4, 1, 1] : [4, 4, 1],
          w = [Math.ceil(b / g[0] / _[0]), Math.ceil(y / g[1] / _[1]), Math.ceil(c / g[2] / _[2])];
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${j}>` : j}) {
        ...
        setOutputAtIndex(flatIndex ${h ? '/ 4' : ''}, value);
            ...
            X = S('x', e[0].dataType, e[0].dims.length, v === 3 ? 1 : v),
            Se = S('w', e[1].dataType, e[1].dims.length, N),
            se = [X, Se],
            A = C('result', e[0].dataType, n.length, N);
          if (s) {
...
var Il,
  ...
  _s = k(() => {
    ...
    ((Il = (e) => {
      ...
      (hs = (e) => (typeof e == 'number' ? [e, e, e] : e)),
      (pn = (e, t) => (t <= 1 ? e : e + (e - 1) * (t - 1))),
      (Cl = (e, t, n, r = 1) => {
        let o = pn(t, r);
        return Math.floor((e[0] * (n - 1) - n + o) / 2);
      }),
      (gs = (e, t, n, r, o) => {
        o == null && (o = Cl(e, t[0], r[0]));
        let i = [0, 0, 0, n];
        for (let s = 0; s < 3; s++)
      ...
      (Al = (e, t, n, r, o, i, s, a, u, d) => {
        ...
        if ((e === 'VALID' && (e = 0), typeof e == 'number')) {
          ...
          let m = gs([t, n, r, 1], [a, u, d], 1, [o, i, s], e);
          ((c = m[0]), (p = m[1]), (f = m[2]));
          ...
          let m = gs([t, n, r, 1], [a, u, d], 1, [o, i, s], e[0]);
          ((c = m[0]), (p = m[1]), (f = m[2]));
      ...
      (ys = (e, t, n, r, o, i = !1, s = 'channelsLast') => {
        ...
        let [p, , f, m, h] = t,
          ...
          T = pn(m, w),
          I = pn(h, v),
          { padInfo: E, outDepth: z, outHeight: M, outWidth: O } = Al(o, u, d, l, b, y, g, $, T, I),
          W = i ? p * c : p,
          K = [0, 0, 0, 0, 0];
        return (
          s === 'channelsFirst'
            ? (K = [a, W, z, M, O])
            : s === 'channelsLast' && (K = [a, z, M, O, W]),
          {
            batchSize: a,
            dataFormat: s,
            inDepth: u,
      ...
      (bs = (e, t, n, r, o, i) => {
        let s = i === 'channelsLast',
          ...
          d = [64, 1, 1],
          l = { x: n.map((g, _) => _) },
          c = [Math.ceil(Il(l.x.map((g) => n[g])) / d[0]), 1, 1];
        ...
        let y = (g) => {
          ...
          let w = u ? 4 : 1,
            ...
            I = [$, T],
            E = C('result', e[0].dataType, n.length, w),
            z = '';
          if (b) {
...
var El,
  ...
  Ss = k(() => {
    ...
    ((El = (e, t, n, r, o, i) => {
      ...
      (xs = (e, t, n, r) => {
        let o = n.format === 'NHWC',
          i = El(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
        if (n.group !== 1) {
          let $ = [t[0]];
          if (o) {
            let I =
              e.kernelCustomData.wT ??
              e.compute(me(t[1], nr), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          (t.length === 3 && $.push(t[2]),
            ...
            n.dilations[0] === 1 &&
            n.dilations[1] === 1
              ? e.compute($s($, n, i, r), { inputs: $ })
              : e.compute(ws($, n, i, r), { inputs: $ }));
          return;
        }
        let s = t.length === 3,
          a = t[0].dims[o ? 1 : 2],
        ...
        if (
          ...
          s && z.push(t[2]);
          let M = E[2],
            O = z[0].dims[z[0].dims.length - 1];
          M < 8 && O < 8
            ? e.compute(dn(z, n, i, E, o, r), { inputs: z })
            : e.compute(wt(z, n, i, E, o, r), { inputs: z });
          return;
        }
        let b = !0,
          y =
      ...
      (Pl = (e, t) => {
        let n = t.format === 'NHWC',
          r = [
            ...
            e.inputs[1].reshape([e.inputs[1].dims[0], e.inputs[1].dims[1], 1, e.inputs[1].dims[2]]),
          ];
        ...
        let o = [0, t.pads[0], 0, t.pads[1]],
          ...
          u = rr({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
        xs(e, r, u, (d) => (n ? [d[0], d[2], d[3]] : [d[0], d[1], d[3]]));
      }),
      (zl = (e, t, n) => {
        let r = n.format === 'NHWC' ? 'channelsLast' : 'channelsFirst',
          o = rr(n, t),
          i = n.autoPad === 'NOTSET' ? n.pads : n.autoPad,
          s = ys(t[0].dims, t[1].dims, n.strides, n.dilations, i, !1, r);
        e.compute(
          bs(
            t,
            o,
      ...
      (ir = (e, t) => {
        if ((kl(e.inputs, t), e.inputs[0].dims.length === 3)) Pl(e, t);
        else if (e.inputs[0].dims.length === 5) zl(e, e.inputs, t);
        else {
          let n = rr(t, e.inputs);
          xs(e, e.inputs, n);
        }
  ...
  Is = k(() => {
    ...
    Ts = (e, t, n) => {
      ...
      let g = ['rank', 'rank'],
        ...
        $ = [
          w[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)),
          w[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1)),
        ],
        T = [
      ...
      let E = (z) => {
        let M = [
          ...
          K = i ? 2 : 3,
          U = i ? 3 : 1,
          R = S('W', e[1].dataType, e[1].dims.length, h),
          G = S('Dy', e[0].dataType, e[0].dims.length, l),
          N = [G, R];
        r && N.push(S('bias', e[2].dataType, [o[U]].length, m));
        let j = C('result', e[0].dataType, o.length, m),
          Q = () => {
            let se = '';
            if (c)
              l === 4
...
var Dl,
  ...
  Ps = k(() => {
    ...
    qe();
    Re();
    ((Dl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
      (Bl = (e, t, n, r, o) => {
      ...
      (Cs = (e, t) => {
        ...
        Ol(a, n, u, e.autoPad, e.group, o, d, r, s, i);
      ...
      (Es = (e, t, n, r) => {
        let o =
          e.kernelCustomData.wT ??
          e.compute(me(t[1], [2, 3, 0, 1]), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
      ...
      (Ul = (e, t) => {
        ...
        Es(e, r, d, (l) => (n ? [l[0], l[2], l[3]] : [l[0], l[1], l[3]]));
      }),
      (ks = (e, t) => {
        if ((Ml(e.inputs, t), e.inputs[0].dims.length === 3)) Ul(e, t);
        else {
          let n = Cs(t, e.inputs);
          Es(e, e.inputs, n);
        }
...
`)
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset('global_idx', m.getByIndices('aIndices'))}
        ...
        return {
          name: 'DepthToSpace',
          shaderCache: { hint: `${e.dims};${t.blocksize};${t.mode}`, inputDependencies: ['rank'] },
          getRunData: (y) => {
      ...
      (Os = (e, t) => {
        (Vl(e.inputs), e.compute(Nl(e.inputs[0], t)));
      }),
      (Ms = (e) => V({ blocksize: e.blocksize, mode: e.mode, format: e.format })));
  });
var Ke,
  mn,
  sr,
  ...
  Fs = k(() => {
    ...
    ((Ke = 256),
      ...
      (Vs = (e) => {
        let t = [],
          n = e;
        for (let r of [4, 2, 3, 5]) for (; n % r === 0;) (t.push(r), (n /= r));
        return n === 1 ? t : void 0;
      }),
      (nt = (e) => {
      ...
      (Wl = (e, t, n, r, o) => {
        let i = n / e,
          s = mn - r,
          a = (d) => `smem[${s}u + base + ${d * t}u]`,
          u = `  for (var t = local_idx; t < ${i}u; t += ${Ke}u) {
`;
...
`;
        ...
        if (
          ((u += `    let base = (t / ${t}u) * ${t * e}u + twiddleIndex;
`),
          e === 2)
        )
          u += `    ${a(0)} = leg[0] + leg[1];
          ...
          for (let d = 0; d < e; d++) {
            ...
            for (let c = 1; c < e; c++) {
              let p = (o * sr * (c * d)) / e,
                ...
                m = nt(Math.sin(p));
              l.push(
                `vec2<f32>(leg[${c}].x*${f} - leg[${c}].y*${m}, leg[${c}].x*${m} + leg[${c}].y*${f})`,
              );
            }
            u += `    ${a(d)} = ${l.join(' + ')};
`;
...
`;
      ...
      (Gl = (e, t, n) => {
        let r = '',
          o = 1,
          i = 0;
        for (let s of e) ((r += Wl(s, o, t, i, n)), (o *= s), (i = mn - i));
        return { code: r, resultOffset: i };
      }),
      (Hl = (e, t, n, r, o) => {
        let i = e.dims,
          s = i.length,
      ...
      (Ls = (e, t) =>
        [t, e.length, e.inputComponents, e.outputComponents, e.inverse, e.onesided].join(';')),
      (Ns = (e) => [
        { type: 12, data: e.batch },
        { type: 12, data: e.signalLength },
        { type: 12, data: e.inner },
        { type: 12, data: e.outputLength },
      ]),
      (Ws = (e, t, n) =>
        e
            ...
            let f = S('x', t, [1]),
              ...
              h = (v) => {
                let $ = `inBase + (${v}) * uniforms.inner * ${r}u`,
                  T = `f32(${f.getByOffset($)})`,
                  I = r === 2 ? `f32(${f.getByOffset(`${$} + 1u`)})` : '0.0';
                return `vec2<f32>(${T}, ${I})`;
              },
              b;
            if (i && s) {
              let v = Math.floor(n / 2) + 1,
                $ = n % 2 === 0 ? `select(provided, provided - 1u, provided == ${v}u)` : 'provided';
              b = `
    ...
    workgroupBarrier();
    for (var k = local_idx + 1u; k < ${$}; k += ${Ke}u) {
      let h = smem[k];
    ...
    workgroupBarrier();`;
            let { code: y, resultOffset: g } = Gl(l, n, u),
              _ = d === 1 ? `smem[${g}u + i]` : `smem[${g}u + i] * ${nt(d)}`,
              w = o === 2 ? m.setByOffset('off + 1u', `${a}(v.y)`) : '';
            return `
  ${Ws(p, f, m)}
...
${y}    for (var i = local_idx; i < uniforms.outputLength; i += ${Ke}u) {
      ...
      ${w}
        ...
        return {
          name: 'DFT',
          shaderCache: { hint: Ls(e, 'fft'), inputDependencies: ['type'] },
          getShaderSource: c,
          getRunData: () => ({
            outputs: [{ dims: e.outputDims, dataType: t }],
            ...
            let p = S('x', t, [1]),
              ...
              m = (_) => {
                let w = `inBase + (${_}) * uniforms.inner * ${r}u`,
                  v = `f32(${p.getByOffset(w)})`,
                  $ = r === 2 ? `f32(${p.getByOffset(`${w} + 1u`)})` : '0.0';
                return `vec2<f32>(${v}, ${$})`;
              },
              h =
                i && s
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      knMod += k;
      if (knMod >= ${n}u) { knMod -= ${n}u; }`,
              y = o === 2 ? f.setByOffset('off + 1u', `${a}(v.y)`) : '',
              g = d === 1 ? 'acc' : `acc * ${nt(d)}`;
            return `
  ${Ws(c, p, f)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
  ...
  ${c.mainStart(Ke)}
    ...
    for (var k = local_idx; k < uniforms.outputLength; k += ${Ke}u) {
      ...
      ${y}
        ...
        return {
          name: 'DFT',
          shaderCache: { hint: Ls(e, 'direct'), inputDependencies: ['type'] },
          getShaderSource: l,
          getRunData: () => ({
            outputs: [{ dims: e.outputDims, dataType: t }],
            programUniforms: Ns(e),
      ...
      (Gs = (e, t) => {
        ...
        let l = u.length <= mn && Vs(u.length) !== void 0 ? Fl(u) : ql(u);
        e.compute(l, { inputs: [0] });
      }),
      (Hs = (e) => V({ axis: e.axis ?? 1, inverse: e.inverse ?? 0, onesided: e.onesided ?? 0 })));
  });
var ar,
  fn,
  qs,
    ...
    ((ar = '[a-zA-Z]|\\.\\.\\.'),
      ...
      (dr = class {
        constructor(t, n) {
          ...
          if (!r.match(RegExp(Zl))) throw new Error('Invalid LHS term');
          if (
            (r.split(',').forEach((a, u) => {
      ...
      (Ql = (e, t, n, r) => {
        let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)),
          ...
          d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              if (n.rhs.symbolToIndices.has($)) {
                ...
                T !== void 0 &&
                  n.lhs.forEach((I, E) => {
                    if (v.inputIndices.includes(E)) {
                      ...
                      z.forEach((M) => {
                        c.push(
                          `${i[E].indicesSet(`input${E}Indices`, M, a.indicesGet('outputIndices', T))}`,
                        );
                      });
                    }
                  });
                ...
                (n.lhs.forEach((T, I) => {
                  ...
                  b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${Ks($)}; ${$}++) {`),
                  y.push('}'));
            });
            let w = _
              ? [
            ...
            return `
            ${l
              .registerUniforms(u.map((v) => ({ name: `${Ks(v)}`, type: 'u32' })))
...
`)};
      ...
      (js = (e, t) => {
        let n = new dr(e.inputs, t.equation),
          r = n.outputDims,
          o = e.inputs.map((i, s) => i.dims);
        e.compute(Ql(o, e.inputs[0].dataType, n, r));
      }),
      (Zs = (e) => {
...
var Xl,
  ...
  Js = k(() => {
    ...
    ((Xl = (e) => {
      ...
      (Yl = (e, t) => (e.length > t.length ? Xs(e, t) : Xs(t, e))),
      (Jl = (e) => {
        let t = e[0].dims,
          n = Array.from(e[1].getBigInt64Array(), Number),
          r = Yl(t, n),
    ...
    ${m}`;
      ...
      (Ys = (e) => {
        (Xl(e.inputs), e.compute(Jl(e.inputs), { inputs: [0] }));
      }));
  });
var ec,
  ea,
  ta = k(() => {
    ...
    ${s.mainStart(et)}
      ...
      (ea = (e) => {
        e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Wi(e) : e.compute(ec(e.inputs));
      }));
  });
var tc,
  nc,
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      (ia = (e, t) => {
        ...
        let m = rc(e, n[1], p, t.batchDims, r, a, c, l, s),
          h = t.batchDims + s;
        if (h > r.length)
...
var oc,
  ...
  la = k(() => {
    ...
    ((oc = (e, t) => {
      ...
      (ua = (e, t) => {
        let n = e.inputs;
        (oc(n, t), e.compute(ic(e.inputs, t)));
      }),
      (da = (e) =>
        V({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis })));
  });
var sc,
  ac,
  ca,
...
var uc,
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      (ha = (e, t) => {
        (uc(e.inputs), e.compute(dc(e.inputs, t)));
      }));
  });
var Ve,
  je,
...
`),
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
      ...
      (ya = (e, t) => {
        (lc(e.inputs), e.compute(yc(e.inputs, t)));
      }),
      (ba = (e) =>
        V({
...
var be,
  ...
  lr = k(() => {
    ...
    q();
    Re();
    ((be = (e, t) => (e.length > t && e[t].dims.length > 0 ? e[t] : void 0)),
      (wc = (e, t) => {
        let n = e[0],
          r = be(e, 1),
          o = be(e, 2),
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      ($t = (e, t, n, r, o, i, s, a) => {
        ...
        if (s && x.size(s.dims) > 0) {
          ...
          return (
            (u = $c(e, i, s, t, r, n * o, a)),
            (u = u.reshape([t, r, n, o])),
            n === 1 || r === 1 ? u : e.compute(me(u, wa.perm), { inputs: [u], outputs: [-1] })[0]
          );
        } else
          return (
      ...
      (va = (e, t) => {
        ...
        let c = o && i && o.dims.length === 4 && i.dims.length === 4,
          p = $t(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
        if (c) return at(e, p, o, i, a, void 0, d, l, u, n);
        if (!o || !i) throw new Error('key and value must be provided');
        let f = $t(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize),
          m = $t(
            e,
            n.batchSize,
            n.numHeads,
    ...
    ((vc = (e) => {
      ...
      (xc = (e, t) => {
        ...
        return (
          ...
          V({ numOutputs: r, axis: t.axis, splitSizes: n })
        );
      }),
      (Sc = (e) => `
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      (xa = (e, t) => {
        vc(e.inputs);
        let n = e.inputs.length === 1 ? t : xc(e.inputs, t);
...
var Ic,
  ...
  mr = k(() => {
    ...
    ((Ic = (e, t) => {
      ...
      (Ta = (e, t) => {
        (Ic(e.inputs, t), e.compute(hn(e.inputs, t)));
      }));
  });
var Cc,
  Ac,
      ...
      if ($) {
        ...
        for (let M = 0; M < $.dims.length; M++)
          if ($.dims[M] !== 1 && $.dims[M] !== u)
            throw new Error(
              `seqlens_k has unexpected shape. Each dimension must be 1 or batch_size (${u}), got dims[${M}] = ${$.dims[M]}.`,
            );
      }
      return {
        batchSize: u,
      ...
      (Ia = (e, t, n) => {
        ...
        return (
          t.dims.length === 3 &&
            ...
            (r = e.compute(me(r, Ac.perm), { inputs: [r], outputs: [-1] })[0])),
          r
        );
      }),
      (Ec = (e, t, n, r) => {
  ...
  `;
      ...
      (Ca = (e, t) => {
        if ((e.inputs.length > 14 && e.inputs[14]) || (e.inputs.length > 15 && e.inputs[15]))
          throw new Error(
        ...
        let r = e.inputs[0],
          ...
          [p, f, m] =
            !o && !i ? e.compute(cr([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i],
          h,
          b;
        if (t.doRotary) {
          let w = e.compute(Ec(n.batchSize, n.sequenceLength, u, d), {
              inputs: [u, d],
              outputs: [-1],
            })[0],
            v = e.inputs[7],
            ...
            I = [p, w, v, $],
            E = [-1];
          ((h = e.compute(hn(I, T), { inputs: I, outputs: E })[0]), I.splice(0, 1, f));
          let z = V({
            interleaved: t.rotaryInterleaved !== 0,
          ...
          b = e.compute(hn(I, z), { inputs: I, outputs: E })[0];
        }
        let y = $t(
            e,
            n.batchSize,
          ...
          g = Ia(e, t.doRotary ? b : f, n),
          _ = Ia(e, m, n);
        at(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
      }));
  });
var Ea,
  kc,
    ...
    if (local_idx == 0) {
      ...
      (kc = (e, t, n) => {
        let r = t[0].dims,
          ...
          d = J(u),
          l = x.size(o) / d,
          c = Ea(e, t[0], t[1], t[2], s, u, a, n.epsilon),
          p = [s, a, u / d],
          f = [s, a],
          m = ['type', 'none'],
          h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes('uniforms.output_size')}
      ...
      (Pc = (e, t, n) => {
        ...
        p = p && r[r.length - 1] !== 1;
        let m = p
            ? e.compute(me(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0]
            : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])),
          h = Ea(e, m, t[1], t[2], i, a, s, n.epsilon),
          b = (y) => {
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${w(0)}, ${w(1)});
      ...
      (ka = (e, t) => {
        t.format === 'NHWC' ? Pc(e, e.inputs, t) : kc(e, e.inputs, t);
      }));
  });
var zc,
  Dc,
  ...
  ${v.mainStart()}
    ...
    ${g ? 'inv_std_output[global_idx] = inv_std_dev' : ''};
      ...
      (za = (e, t) => {
        (zc(e.inputs), e.compute(Dc(e.inputs, t, e.outputCount)));
      }));
  });
var Bc,
  Ba,
  ...
  Ra = k(() => {
    ...
    ((Oc = (e, t) => {
      ...
      (Mc = (e, t) => {
        ...
        let T = (I) => {
          let E = w.length,
            z = S('a', e[0].dataType, E, p),
            M = S('b', 12, v.length, f),
            O = S('scales', e[2].dataType, e[2].dims.length),
            W = [z, M, O],
            K = e.length === 4 ? S('zero_points', 12, e[3].dims.length) : void 0;
          K && W.push(K);
          let U = $.length,
            R = C('output', e[0].dataType, U, m),
            G = re(e[0].dataType),
            N = (() => {
              switch (p) {
                case 1:
          ...
          `;
            ...
            b_dequantized_values = ${
              p === 1
                ? `${N}(${Array.from({ length: 8 }, (ge, ie) => `(b_quantized_values[${ie}] - ${K ? `zero_point${ae}` : 'zero_point'}) * scale${ae}`).join(', ')});`
                : `(b_quantized_values - ${N}(${Array(8)
                    .fill(`${K ? `zero_point${ae}` : 'zero_point'}`)
                    .join(',')})) * scale${ae};`
            };
      ...
      (Uc = (e, t) => {
        ...
        (E.splice(-1, 1, l / f),
          ...
          T.push(...P(E)),
          T.push(...P(e[2].dims)),
          e.length === 4 && T.push(...P(x.convertShape(e[3].dims))));
        let z = [u, o, s];
        T.push(...P(z));
        let M = (O) => {
          let W = I.length,
            K = S('a', e[0].dataType, W, p),
            U = S('b', 12, E.length, f),
      ...
      (Ma = (e, t) => {
        (Oc(e.inputs, t),
          ...
          e.adapterInfo.isArchitecture('gen-12lp')
            ? e.compute(Uc(e.inputs, t))
            : e.compute(Mc(e.inputs, t)));
      }),
      (Ua = (e) => V(e)));
  });
var Rc,
    ...
    ((Rc = (e) => {
      ...
      (Gc = (e, t, n) => {
        switch (n.mode) {
          ...
          case 1:
            return Lc(e, t, n.pads.length);
          case 2:
            return Nc(e, t, n.pads.length);
          case 3:
      ...
      (Va = (e, t) => {
        Rc(e.inputs);
        let n = Fc(e.inputs, t);
        e.compute(Hc(e.inputs, n), { inputs: [0] });
      }));
  });
var gn,
  Na,
  ...
  ru = k(() => {
    ...
    ((gn = (e) => {
      ...
      (Na = (e, t, n) => {
        ...
        let l = Je.computePoolOutputShape(n, o, a, u, s, d, t.autoPad, t.ceilMode),
          c = Object.assign({}, t);
        i
          ? Object.assign(c, {
              kernelShape: s,
      ...
      (Wa = (e, t) => {
        ...
        if (t.kernelShape.length <= 2) {
          ...
          (i.push({ type: 12, data: a }, { type: 12, data: t.pads }, { type: 12, data: t.strides }),
            s.push(
      ...
      (Ha = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`),
      (qc = (e) => `${Ha(e)};${e.countIncludePad}`),
      (Kc = (e) => `${Ha(e)};${e.storageOrder};${e.dilations}`),
      (Fa = (e) => ({
        format: e.format,
  ...
  su = k(() => {
    ...
    ((Zc = (e, t) => {
      ...
      if (t.blockSize > 0) {
        ...
        if (
          !e[1].dims.map((o, i) => i === t.axis || o === e[0].dims[i]).reduce((o, i) => o && i, !0)
        )
          throw new Error(
      ...
      (ou = (e, t) => {
        (Zc(e.inputs, t), e.compute(Qc(e.inputs, t)));
      }),
      (iu = (e) => V({ axis: e.axis, blockSize: e.blockSize })));
  });
var Xc,
  Yc,
  au,
    ...
    ((Xc = (e, t, n) => {
      ...
      (au = (e) => {
        ...
        (e.inputs[0].dataType === 6
          ...
          ne.webgpu.validateInputContent && Xc(t, n, r),
          e.compute(Yc(t, n, r, e.inputs[0].dataType), { inputs: [] }));
      }));
  });
var Jc,
  ep,
            ...
            let p = S('indices', e[1].dataType, e[1].dims.length),
              ...
              m =
                t.reduction !== 'none' && t.reduction !== ''
                  ? Ao('output', e[0].dataType, o.length)
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Jc(t.reduction, 'output[data_offset + i]', 'value', m.type.value)}
      ...
      (du = (e) => V({ reduction: e.reduction })),
      (lu = (e, t) => {
        e.compute(ep(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
      }));
  });
var tp,
  np,
    ...
    ((tp = (e, t) => {
      ...
      (rp = (e, t, n, r, o, i) => {
        ...
        if (a > 0 && e.length > a && e[a].dims.length === 1 && e[a].dims[0] > 0) {
          ...
          (tp(r, t), t.axes.length > 0 && np(r, t.axes, d).forEach((l, c) => (r[c] = l)));
        }
        if (
          u > 0 &&
          e.length > u &&
...
`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      (hp = (e, t, n, r, o, i) => {
        let s = e.dims,
          a = sp(i, t.axes, s.length),
          u = ap(s, r, o, t.axes),
          d = r.slice();
        r.length === 0 &&
          ((d = s.map((g, _) => (g === 0 ? 1 : u[_] / g))),
          t.keepAspectRatioPolicy !== 'stretch' && (u = up(s, d, t)));
        ...
        switch (t.mode) {
          ...
          case 'linear':
            return `
              ...
              ${(() => {
                if (s.length === 2 || s.length === 4) return `${pp(c, l, s, m, h)}`;
                if (s.length === 3 || s.length === 5) return `${fp(c, l, s, m, h)}`;
                throw Error(
          ...
          case 'cubic':
            ...
            ${(() => {
              if (s.length === 2 || s.length === 4)
                return `${mp(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
              throw Error(
...
`
      ...
      (fu = (e, t) => {
        ...
        (rp(e.inputs, t, i, n, r, o), e.compute(hp(e.inputs[0], t, i, n, r, o), { inputs: [0] }));
      }),
      (hu = (e) => {
        let t = e.antialias,
          n = e.axes,
    ...
    ((yp = (e) => {
      ...
      (yu = (e, t) => {
        ...
        (e.outputCount > 1 && r.push(-3),
          ...
          e.compute(bp(e.inputs, t, e.outputCount, !1), { outputs: r }));
      }));
  });
var _p,
  yn,
  ...
  vu = k(() => {
    ...
    ((_p = (e, t) => {
      ...
      (vp = (e, t) => {
        ...
        let s = t.starts.map((y, g) => _u(y, g, n, o, i)),
          a = t.ends.map((y, g) => _u(y, g, n, o, i));
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
        ...
        return {
          name: 'Slice',
          shaderCache: { hint: `${u.length}_${s.length}_${i.length}`, inputDependencies: ['rank'] },
          getShaderSource: b,
          getRunData: () => ({
            outputs: [l],
            dispatchGroup: { x: Math.ceil(r / 64) },
      ...
      (wu = (e, t) => {
        _p(e.inputs, t);
        let n = wp(e.inputs, t);
        e.compute(vp(e.inputs, n), { inputs: [0] });
      }),
      ($u = (e) => {
        let t = e.starts,
          n = e.ends,
      ...
      (Sp = (e, t) => {
        ...
        a
          ? ((d = Array.from({ length: i }, (T, I) => I)),
            (d[s] = i - 1),
            (d[i - 1] = s),
            (u = e.compute(me(n, d), { inputs: [n], outputs: [-1] })[0]))
          : (u = n);
        let l = u.dims,
          c = l[i - 1],
          p = o / c,
        ...
        let b = (T, I) =>
          ...
          w =
            re(u.dataType) === 'f32'
              ? `var threadMax = ${_}(-3.4028234663852886e+38f);`
...
var Iu,
  ...
  Au = k(() => {
    ...
    H();
    q();
    ((Iu = (e) => Array.from(e.getBigInt64Array(), Number)),
      (Tp = (e) => {
        ...
        if (Iu(e[1]).length !== e[0].dims.length)
          throw new Error(
      ...
      (Cu = (e) => {
        (Tp(e.inputs), e.compute(Cp(e.inputs), { inputs: [0] }));
      }));
  });
var Ap,
  Ep,
  ...
  Du = k(() => {
    ...
    bn = class {
      ...
      build(t, n) {
        ...
        let s = Eo(n, this.backend.device.limits),
      ...
      (Pp = (e, t, n) => {
        ...
        return (
          ...
          (r +=
            ':' +
            n +
            `:${kp(t, e.shaderCache?.inputDependencies ?? new Array(t.length).fill('dims'))}`),
          r
        );
      }),
      (fr = class {
      ...
      (hr = class {
        ...
        async initialize(t, n) {
          ...
          let s = n,
            a =
              n.info ??
              (typeof s.requestAdapterInfo == 'function' ? await s.requestAdapterInfo() : void 0);
          ((this.adapterInfo = new fr(a)),
            (this.gpuDataManager = Io(this)),
            (this.programManager = new bn(this)),
            (this.kernels = new Map()),
            (this.kernelPersistentData = new Map()),
            (this.kernelCustomData = new Map()),
            Ft(t.logLevel, !!t.debug),
            (this.device.onuncapturederror = (u) => {
              u.error instanceof GPUValidationError &&
                console.error(`An uncaught WebGPU validation error was raised: ${u.error.message}`);
            }),
                ...
                for (let o = 0; o < n.length / 2; o++) {
                  ...
                  if (this.env.webgpu.profiling?.ondata)
                    ...
                    (p.forEach((_, w) => {
                      ...
                      console.log(
                        `[profiling] kernel "${s}|${u}|${d}|${l}" ${y}${g}start time: ${h} ns, execution time: ${b - h} ns`,
                      ));
                  }
                  At('GPU', `${l}::${f}::${m}`);
                }
        ...
        run(t, n, r, o, i, s) {
          ...
          if (l) {
            ...
            l.forEach((I) => {
              ...
              let z = I.type === 10 ? 2 : 4,
                ...
                O;
              (I.type === 10
                ? ((O = E.length > 4 ? 16 : E.length > 2 ? 8 : E.length * z),
                  (M = E.length > 4 ? 16 : z * E.length))
                : ((O = E.length <= 2 ? E.length * z : 16), (M = 16)),
                (_ = Math.ceil(_ / O) * O),
                w.push(_));
              let W = I.type === 10 ? 8 : 4;
          ...
          if (
            (g ||
              ...
              Z('info', () => `[artifact] key: ${y}, programName: ${t.name}`)),
        ...
        computeKernel(t, n, r) {
          ...
          ((this.currentKernelId = t),
            ...
            Z('info', () => `[WebGPU] Start to run kernel "[${i}] ${s}"...`));
  ...
  Uu = k(() => {
    ...
    ((vt = class e {
      ...
      (gr = class {
        ...
        compute(t, n) {
          let r = n?.inputs?.map((a) => (typeof a == 'number' ? this.inputs[a] : a)) ?? this.inputs,
            o = n?.outputs ?? [],
            i = (a, u, d) => new vt(this.module, u, this.output(a, d), d),
            s = (a, u) => {
              let d = Fe(a, u);
...
var Dp,
  ...
  zn = k(() => {
    ...
    ((Dp = (e, t) => {
      ...
      (Dt = async (e) => {
        Dp(e.wasm.numThreads, gt(e.logLevel));
      }),
      (Bt = async (e, t) => {
        te().asyncInit?.();
      ...
      (Ot = async (e, t) => {
        ...
        try {
          ...
          (o._free(n),
            s !== 0 && o._OrtReleaseSessionOptions(s) !== 0 && Y("Can't release session options."),
      ...
      (Vu = async (e, t, n, r, o, i, s = !1) => {
        ...
        try {
          ...
          let y = a._OrtCreateTensor(He(d), f, m, b, l.length, Mn(p));
      ...
      (Ut = async (e, t, n, r, o, i) => {
        ...
        let d = u[0],
          ...
          M = s.stackAlloc(b * a);
        try {
          (([y, g] = ao(i)), Ne('wasm prepareInputOutputTensor'));
          ...
          for (let U = 0; U < h; U++)
            (s.setValue(I + U * a, _[U], '*'), s.setValue(E + U * a, l[t[U]], '*'));
          for (let U = 0; U < b; U++)
          ...
          if (p && !m) {
            ...
            for (let N = 0; N < h; N++) {
              let j = t[N];
              (await s._OrtBindInput(U, l[j], _[N])) !== 0 &&
                Y(`Can't bind input[${N}] for session=${e}.`);
            }
            for (let N = 0; N < b; N++) {
              let j = r[N];
              o[N]?.[3]
                ? ($.push(w[N]),
                  s._OrtBindOutput(U, c[j], w[N], 0) !== 0 &&
                    Y(`Can't bind pre-allocated output[${N}] for session=${e}.`))
                : s._OrtBindOutput(U, c[j], 0, G[j]) !== 0 &&
                  Y(`Can't bind output[${N}] to ${R[N]} for session=${e}.`);
            }
            (We('wasm bindInputsOutputs'), rt.set(e, [d, l, c, p, f, !0]));
          }
          (s.jsepOnRunStart?.(d), s.webnnOnRunStart?.(d));
          let O;
          (p
            ? (O = await s._OrtRunWithBinding(d, p.handle, b, z, y))
            : (O = await s._OrtRun(d, E, I, h, M, b, z, y)),
            O !== 0 && Y('failed to call OrtRun().'));
          let W = [],
            K = [];
          ...
          for (let U = 0; U < b; U++) {
            ...
            if (R === w[U] || $.includes(w[U])) {
              (W.push(o[U]),
                R !== w[U] && s._OrtReleaseTensor(R) !== 0 && Y("Can't release tensor."));
              continue;
            }
            let G = s.stackSave(),
              N = s.stackAlloc(4 * a),
              ...
              X = 0;
            try {
              s._OrtGetTensorData(R, N, N + a, N + 2 * a, N + 3 * a) !== 0 &&
                Y(`Can't access output tensor data on index ${U}.`);
              let se = a === 4 ? 'i32' : 'i64',
                A = Number(s.getValue(N, se));
              X = s.getValue(N + a, '*');
              let D = s.getValue(N + a * 2, '*'),
                oe = Number(s.getValue(N + a * 3, se)),
                he = [];
              ...
              if (Q === 'string') {
                ...
                for (let le = 0; le < ae; le++) {
                  let Le = s.getValue(X + le * a, '*'),
                    St = s.getValue(X + (le + 1) * a, '*'),
                    wr = le === ae - 1 ? void 0 : St - Le;
                  ie.push(s.UTF8ToString(Le, wr));
                }
                W.push([Q, he, ie, 'cpu']);
                ...
                let le = ie(X),
                  Le = Fe(A, ae);
                if (Le === void 0 || !Gt(Q)) throw new Error(`Unsupported data type: ${Q}`);
                ((j = !0),
                  W.push([
                    Q,
                    he,
                    {
                      gpuBuffer: le,
                      download: s.jsepCreateDownloader(le, Le, Q),
                      dispose: () => {
                ...
                let ie = s.webnnEnsureTensor,
                  le = s.webnnIsGraphInputOutputTypeSupported;
                if (!ie || !le)
                  throw new Error(
                    'preferredLocation "ml-tensor" is not supported without using WebNN.',
                  );
                if (Fe(A, ae) === void 0 || !Ht(Q)) throw new Error(`Unsupported data type: ${Q}`);
                if (!le(e, Q, !1))
                  throw new Error(
                    `preferredLocation "ml-tensor" for ${Q} output is not supported by current WebNN Context.`,
                  );
                ...
                let ie = s.webnnCreateMLTensorDownloader(X, Q)(),
                  le = W.length;
                ((j = !0),
                  K.push(
                    (async () => {
                      let Le = [le, await ie];
                      return (s.webnnReleaseTensorId(X), s._OrtReleaseTensor(R), Le);
                    })(),
                  ),
                  W.push([Q, he, [], 'cpu']));
              } else {
                let ie = st(Q),
                  le = new ie(ae);
                (new Uint8Array(le.buffer, le.byteOffset, le.byteLength).set(
                  s.HEAPU8.subarray(X, X + le.byteLength),
                ),
                  W.push([Q, he, le, 'cpu']));
              }
            } finally {
          ...
          p &&
            ...
            rt.set(e, [d, l, c, p, f, !1]));
          for (let [U, R] of await Promise.all(K)) W[U][2] = R;
          return (We('wasm ProcessOutputTensor'), W);
        } finally {
          (s.webnnOnRunEnd?.(d),
            s.stackRestore(T),
            _.forEach((O) => s._OrtReleaseTensor(O)),
            w.forEach((O) => s._OrtReleaseTensor(O)),
            v.forEach((O) => s._free(O)),
            y !== 0 && s._OrtReleaseRunOptions(y),
            g.forEach((O) => s._free(O)));
        }
      }),
      (Rt = (e) => {
        let t = te(),
...
var ot,
  ...
  _r = k(() => {
    ...
    Ge();
    Pt();
    ((ot = () => !!ne.wasm.proxy && typeof document < 'u'),
      (xt = !1),
      (wn = !1),
      ($n = !1),
      (br = new Map()),
      ...
      (ct = () => {
        if (xt || !wn || $n || !xe) throw new Error('worker not ready');
      }),
      (Mp = (e) => {
        switch (e.data.type) {
          case 'init-wasm':
            ((xt = !1),
              e.data.err ? (($n = !0), yr[1](e.data.err)) : ((wn = !0), yr[0]()),
              _n && (URL.revokeObjectURL(_n), (_n = void 0)));
            break;
          case 'init-ep':
          case 'copy-from':
          case 'create':
      ...
      (Lu = async () => {
        if (!wn) {
          ...
          try {
            (await zt(ne.wasm), await Dt(ne), (wn = !0));
          } catch (e) {
            throw (($n = !0), e);
          } finally {
            xt = !1;
    ...
    ((Ku = (e, t) => {
      ...
      (vn = class {
        ...
        async run(t, n, r) {
          ...
          let u = o.map((p, f) => Ku(p, () => `input "${this.inputNames[i[f]]}"`)),
            d = s.map((p, f) => (p ? Ku(p, () => `output "${this.outputNames[a[f]]}"`) : null)),
            l = await Fu(this.sessionId, i, u, a, d, r),
            c = {};
          for (let p = 0; p < l.length; p++) c[this.outputNames[a[p]]] = s[p] ?? Up(l[p]);
          return (ye(), c);
        }
        startProfiling() {}
        endProfiling() {
  ...
  Xu = k(() => {
    ...
    ((Zu = () => {
      ...
      if (
        ...
        if (typeof self < 'u' && !self.crossOriginIsolated) ne.wasm.numThreads = 1;
        else {
          let t =
            typeof navigator > 'u' ? Tn('node:os').cpus().length : navigator.hardwareConcurrency;
...
var nx = Pn;
{
  let e = (Xu(), Tt(Qu)).wasmBackend;
  (Qe('webgpu', e, 5), Qe('webnn', e, 5), Qe('cpu', e, 10), Qe('wasm', e, 10));
}
Object.defineProperty(ne.versions, 'web', { value: Zr, enumerable: !0 });
export {
  rd as InferenceSession,
  At as TRACE,
  Ne as TRACE_EVENT_BEGIN,
  We as TRACE_EVENT_END,
