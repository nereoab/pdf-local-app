  ...
  It = (e, t, n, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let r of St(t))
        !ht.call(e, r) &&
          r !== n &&
          pe(e, r, { get: () => t[r], enumerable: !(o = Et(t, r)) || o.enumerable });
    return e;
  };
...
var Ae,
  ...
  me = C(() => {
    'use strict';
    ne();
    ((Ae = j || typeof location > 'u' ? void 0 : location.origin),
      (Lt = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (Bt = () => {
        if (!j) {
          if (Lt) {
            let e = URL;
      ...
      (vt = async (e) => (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ e)).default),
      (Ue = void 0),
      (Ce = async (e, t, n, o) => {
        let r = Ue && !(e || t);
        if (r)
    ...
    ke = (e) => {
      ...
      try {
        ...
        return (
          ...
          (n = t._OrtCreateRunOptions(r.logSeverityLevel, r.logVerbosityLevel, !!r.terminate, a)),
          n === 0 && g("Can't create run options."),
          e?.extra !== void 0 &&
            Q(e.extra, '', new WeakSet(), (s, i) => {
              let u = A(s, o),
                l = A(i, o);
  ...
  Ne = C(() => {
    ...
    ((Ct = (e) => {
      ...
      (q = (e, t, n, o) => {
        let r = A(t, o),
          a = A(n, o);
        E()._OrtAddSessionConfigEntry(e, r, a) !== 0 &&
          g(`Can't set a session config entry: ${t} - ${n}.`);
      }),
      (kt = async (e, t, n) => {
        let o = t.executionProviders;
        for (let r of o) {
          let a = typeof r == 'string' ? r : r.name,
            s = [];
          switch (a) {
            case 'webnn':
              if (
                ((a = 'WEBNN'),
                q(e, 'session.disable_quant_qdq', '1', n),
                q(e, 'session.disable_qdq_constant_folding', '1', n),
                typeof r != 'string')
              ) {
                let c = r?.deviceType;
            ...
            case 'webgpu':
              if (((a = 'JS'), typeof r != 'string')) {
                ...
                if (f?.preferredLayout) {
                  if (f.preferredLayout !== 'NCHW' && f.preferredLayout !== 'NHWC')
                    throw new Error(
          ...
          let i = A(a, n),
            ...
            w = 0;
          if (u > 0) {
            ((l = E()._malloc(u * E().PTR_SIZE)),
              n.push(l),
              (w = E()._malloc(u * E().PTR_SIZE)),
              n.push(w));
            for (let f = 0; f < u; f++)
              (E().setValue(l + f * E().PTR_SIZE, s[f][0], '*'),
                E().setValue(w + f * E().PTR_SIZE, s[f][1], '*'));
          }
          (await E()._OrtAppendExecutionProvider(e, i, l, w, u)) !== 0 &&
            g(`Can't append execution provider: ${a}.`);
        }
      }),
      (Re = async (e) => {
        let t = E(),
        ...
        Wt(r);
        try {
          let a = Ct(r.graphOptimizationLevel ?? 'all'),
          ...
          if (
            ...
            r.executionProviders && (await kt(n, r, o)),
          ...
          if (r.freeDimensionOverrides)
            for (let [f, c] of Object.entries(r.freeDimensionOverrides)) {
              if (typeof f != 'string')
                throw new Error(`free dimension override name must be a string: ${f}`);
              ...
              t._OrtAddFreeDimensionOverride(n, p, c) !== 0 &&
                g(`Can't set a free dimension override: ${f} - ${c}.`);
            }
          return (
            r.extra !== void 0 &&
              Q(r.extra, '', new WeakSet(), (f, c) => {
                q(n, f, c, o);
              }),
            [n, o]
          );
          ...
          throw (
            n !== 0 && t._OrtReleaseSessionOptions(n) !== 0 && g("Can't release session options."),
...
import { TRACE_EVENT_BEGIN as ze, TRACE_EVENT_END as He } from 'onnxruntime-common';
var Ft,
  Je,
  Ye,
  Z,
  ...
  et = C(() => {
    ...
    ((Ft = (e, t) => {
        ...
        try {
          if ((([s, u] = await Re(t)), t?.externalData && r.mountExternalData)) {
            ...
            for (let O of t.externalData) {
              let _ = typeof O == 'string' ? O : O.path,
                U = typeof O == 'string' ? O : O.data;
              y.push(
                ee(U).then((L) => {
          ...
          for (let y of t?.executionProviders ?? [])
            if ((typeof y == 'string' ? y : y.name) === 'webnn') {
          ...
          for (let y = 0; y < f; y++) {
            ...
            (S.push(L),
              P.push(
                _ === 0
                  ? { name: L, isTensor: !1 }
                  : { name: L, isTensor: !0, type: ae(_), shape: U },
              ));
          }
          for (let y = 0; y < c; y++) {
            let [O, _, U] = Ve(a, y + f);
          ...
          return (Z.set(a, [a, l, w, null, p, !1]), [a, S, h, P, m]);
        } catch (f) {
          throw (
            l.forEach((c) => r._OrtFree(c)),
            w.forEach((c) => r._OrtFree(c)),
            i !== 0 && r._OrtReleaseBinding(i) !== 0 && g("Can't release IO binding."),
            a !== 0 && r._OrtReleaseSession(a) !== 0 && g("Can't release session."),
            f
          );
        } finally {
          (r._free(n),
            s !== 0 && r._OrtReleaseSessionOptions(s) !== 0 && g("Can't release session options."),
            u.forEach((f) => r._free(f)),
      ...
      (Xe = (e) => {
        ...
        let [o, r, a, s, i] = n;
        (s &&
          (i && t._OrtClearBoundOutputs(s.handle) !== 0 && g("Can't clear bound outputs."),
          t._OrtReleaseBinding(s.handle) !== 0 && g("Can't release IO binding.")),
          ...
          if (Array.isArray(m)) {
            ...
            if (l !== 'string' && b && M) {
              ...
              if (b(o, y) || M(o, y)) {
                let O = J(l);
                ((S = Y(O, w)), (c = 'ml-tensor'));
                let _ = i.webnnCreateTemporaryTensor,
                ...
                ((S = m.byteLength),
                  (p = i._malloc(S)),
                  n.push(p),
                  i.HEAPU8.set(new Uint8Array(m.buffer, m.byteOffset, S), p));
            } else
              ((S = m.byteLength),
                (p = i._malloc(S)),
                n.push(p),
      ...
      (Ke = async (e, t, n, o, r, a) => {
        ...
        let l = u[0],
          ...
          Te = s.stackAlloc(P * i);
        try {
          (([m, b] = ke(a)), ze('wasm prepareInputOutputTensor'));
          for (let d = 0; d < h; d++) await qe(n[d], M, O, e, w[t[d]], t[d], p);
          for (let d = 0; d < P; d++) await qe(r[d], y, O, e, f[o[d]], h + o[d], p);
          He('wasm prepareInputOutputTensor');
          for (let d = 0; d < h; d++)
            (s.setValue(L + d * i, M[d], '*'), s.setValue(X + d * i, w[t[d]], '*'));
          for (let d = 0; d < P; d++)
            (s.setValue(z + d * i, y[d], '*'), s.setValue(Te + d * i, f[o[d]], '*'));
          (s.jsepOnRunStart?.(l), s.webnnOnRunStart?.(l));
          let x;
          ((x = await s._OrtRun(l, X, L, h, Te, P, z, m)),
            x !== 0 && g('failed to call OrtRun().'));
          let F = [],
            Le = [];
          ze('wasm ProcessOutputTensor');
          for (let d = 0; d < P; d++) {
            let W = Number(s.getValue(z + d * i, '*'));
            if (W === y[d] || _.includes(y[d])) {
              (F.push(r[d]),
                W !== y[d] && s._OrtReleaseTensor(W) !== 0 && g("Can't release tensor."));
              continue;
            }
            let Be = s.stackSave(),
              k = s.stackAlloc(4 * i),
              ...
              D = 0;
            try {
              s._OrtGetTensorData(W, k, k + i, k + 2 * i, k + 3 * i) !== 0 &&
                g(`Can't access output tensor data on index ${d}.`);
              let le = i === 4 ? 'i32' : 'i64',
                te = Number(s.getValue(k, le));
              D = s.getValue(k + i, '*');
              let _e = s.getValue(k + i * 2, '*'),
                yt = Number(s.getValue(k + i * 3, le)),
                R = [];
              ...
              if (T === 'string') {
                if (K === 'gpu-buffer' || K === 'ml-tensor')
                  throw new Error('String tensor is not supported on GPU.');
                let B = [];
                for (let I = 0; I < N; I++) {
                  let G = s.getValue(D + I * i, '*'),
                    re = s.getValue(D + (I + 1) * i, '*'),
                    Pe = I === N - 1 ? void 0 : re - G;
                ...
                let B = s.webnnEnsureTensor,
                  I = s.webnnIsGraphInputOutputTypeSupported;
                if (!B || !I)
                  throw new Error(
                ...
                if (!I(e, T, !1))
                  throw new Error(
                    `preferredLocation "ml-tensor" for ${T} output is not supported by current WebNN Context.`,
                  );
                ...
                let B = s.webnnCreateMLTensorDownloader(D, T)(),
                  I = F.length;
                ((H = !0),
                  Le.push(
                    (async () => {
                ...
                let B = Ge(T),
                  I = new B(N);
                (new Uint8Array(I.buffer, I.byteOffset, I.byteLength).set(
                  s.HEAPU8.subarray(D, D + I.byteLength),
                ),
                  F.push([T, R, I, 'cpu']));
              }
            } finally {
          ...
          c &&
            !p &&
            (s._OrtClearBoundOutputs(c.handle) !== 0 && g("Can't clear bound outputs."),
            Z.set(e, [l, w, f, c, p, !1]));
          for (let [d, W] of await Promise.all(Le)) F[d][2] = W;
          return (He('wasm ProcessOutputTensor'), F);
        } finally {
          (s.webnnOnRunEnd?.(l),
            s.stackRestore(U),
            M.forEach((x) => s._OrtReleaseTensor(x)),
            y.forEach((x) => s._OrtReleaseTensor(x)),
            O.forEach((x) => s._free(x)),
            m !== 0 && s._OrtReleaseRunOptions(m),
            b.forEach((x) => s._free(x)));
        }
      }),
      (Qe = (e) => {
        let t = E(),
    ...
    ((Se = !1),
      ...
      (nt = async () => {
        if (!tt) {
          ...
          Se = !0;
          try {
            (await We(he.wasm), await Je(he), (tt = !0));
          } catch (e) {
            throw ((rt = !0), e);
          } finally {
            Se = !1;
      ...
      (ut = async (e, t, n, o, r, a) => Ke(e, t, n, o, r, a)),
      (ct = async (e) => {
        Qe(e);
      }));
  });
import { Tensor as Ie, TRACE_FUNC_BEGIN as ft, TRACE_FUNC_END as lt } from 'onnxruntime-common';
var pt,
  Gt,
  ce,
  dt = C(() => {
      ...
      (Gt = (e) => {
        switch (e[3]) {
          ...
          case 'ml-tensor': {
            ...
            return Ie.fromMLTensor(n, { dataType: t, dims: e[1], download: o, dispose: r });
          }
          default:
      ...
      (ce = class {
        ...
        async run(t, n, o) {
          ...
          Object.entries(n).forEach((c) => {
            let p = c[0],
              S = c[1],
              h = this.outputNames.indexOf(p);
            if (h === -1) throw new Error(`invalid output '${p}'`);
            (s.push(S), i.push(h));
          });
          let u = r.map((c, p) => pt(c, () => `input "${this.inputNames[a[p]]}"`)),
            l = s.map((c, p) => (c ? pt(c, () => `output "${this.outputNames[i[p]]}"`) : null)),
            w = await ut(this.sessionId, a, u, i, l, o),
            f = {};
...
import { env as v } from 'onnxruntime-common';
var mt,
  fe,
  jt,
  wt = C(() => {
    ...
    ((mt = () => {
      ...
      if (
        ...
        if (typeof self < 'u' && !self.crossOriginIsolated) v.wasm.numThreads = 1;
          ...
          let t =
            typeof navigator > 'u' ? de('node:os').cpus().length : navigator.hardwareConcurrency;
          v.wasm.numThreads = Math.min(4, Math.ceil((t || 1) / 2));
        }
    }),
      (fe = class {
        async init(t) {
...
import { registerBackend as gt, env as zt } from 'onnxruntime-common';
var De = '1.29.0';
var Hr = $t;
{
  let e = (wt(), Tt(bt)).wasmBackend;
  (gt('cpu', e, 10), gt('wasm', e, 10));
}
Object.defineProperty(zt.versions, 'web', { value: De, enumerable: !0 });
