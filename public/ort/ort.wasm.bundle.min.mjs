...
var qt = ((n) =>
  typeof require < 'u'
    ? require
    : typeof Proxy < 'u'
      ? new Proxy(n, { get: (t, a) => (typeof require < 'u' ? require : t)[a] })
      : n)(function (n) {
...
var ut = (n, t) => {
    for (var a in t) Jt(n, a, { get: t[a], enumerable: !0 });
  },
  Ka = (n, t, a, u) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let o of Qa(t))
        !Za.call(n, o) &&
          o !== a &&
          Jt(n, o, { get: () => t[o], enumerable: !(u = Xa(t, o)) || u.enumerable });
    return n;
  };
    ...
    ((ft = new Map()),
        ...
        if (
          ...
          if (u === void 0) ft.set(n, { backend: t, priority: a });
            ...
            if (u.priority === a && u.backend !== t)
              throw new Error(`cannot register backend "${n}" using priority ${a}`);
          }
          if (a >= 0) {
            let o = Be.indexOf(n);
            o !== -1 && Be.splice(o, 1);
            for (let d = 0; d < Be.length; d++)
              if (ft.get(Be[d]).priority <= a) {
                Be.splice(d, 0, n);
                return;
              }
            Be.push(n);
      ...
      (es = async (n) => {
        ...
        if (t.aborted) return t.error;
        {
          ...
          try {
            return (
              a || (t.initPromise = t.backend.init(n)),
              await t.initPromise,
              (t.initialized = !0),
              t.backend
            );
      ...
      (dr = async (n) => {
        let t = n.executionProviders || [],
          a = t.map((m) => (typeof m == 'string' ? m : m.name)),
          u = a.length === 0 ? Be : a,
          o,
          d = [],
          c = new Set();
        ...
        if (!o)
          throw new Error(
            `no available backend found. ERR: ${d.map((m) => `[${m.name}] ${m.err}`).join(', ')}`,
          );
        for (let { name: m, err: h } of d)
          a.includes(m) &&
            console.warn(
              `removing requested execution provider "${m}" from session options because it is not available: ${h}`,
            );
        let l = t.filter((m) => c.has(typeof m == 'string' ? m : m.name));
        return [
          o,
          new Proxy(n, { get: (m, h) => (h === 'executionProviders' ? l : Reflect.get(m, h)) }),
        ];
      }));
  });
var pr = F(() => {
      ...
      (J = {
        ...
        set logLevel(n) {
          if (n !== void 0) {
            if (
              typeof n != 'string' ||
              ['verbose', 'info', 'warning', 'error', 'fatal'].indexOf(n) === -1
            )
    ...
    ((yr = (n, t) => {
      ...
      if (u != null) {
        ...
        t?.tensorLayout !== void 0 && t.tensorLayout === 'NHWC'
          ? ((o = n.dims[2]), (d = n.dims[3]))
          : ((o = n.dims[3]), (d = n.dims[2]));
        let c = t?.format !== void 0 ? t.format : 'RGB',
          l = t?.norm,
          m,
          h;
        (l === void 0 || l.mean === void 0
          ...
          : typeof l.mean == 'number'
            ? (m = [l.mean, l.mean, l.mean, l.mean])
            : ((m = [l.mean[0], l.mean[1], l.mean[2], 0]),
              l.mean[3] !== void 0 && (m[3] = l.mean[3])),
          l === void 0 || l.bias === void 0
            ? (h = [0, 0, 0, 0])
            : typeof l.bias == 'number'
              ? (h = [l.bias, l.bias, l.bias, l.bias])
              : ((h = [l.bias[0], l.bias[1], l.bias[2], 0]),
        ...
        for (let _ = 0; _ < d; _++)
          for (let $ = 0; $ < o; $++) {
            let v = (n.data[b++] - h[0]) * m[0],
              O = (n.data[y++] - h[1]) * m[1],
              N = (n.data[T++] - h[2]) * m[2],
              D = I === -1 ? 255 : (n.data[I++] - h[3]) * m[3];
            ((u.fillStyle = 'rgba(' + v + ',' + O + ',' + N + ',' + D + ')'),
              u.fillRect($, _, 1, 1));
          }
      ...
      (gr = (n, t) => {
        ...
        if (a != null) {
          let o, d, c;
          t?.tensorLayout !== void 0 && t.tensorLayout === 'NHWC'
            ? ((o = n.dims[2]), (d = n.dims[1]), (c = n.dims[3]))
            : ((o = n.dims[3]), (d = n.dims[2]), (c = n.dims[1]));
          let l = t !== void 0 && t.format !== void 0 ? t.format : 'RGB',
            m = t?.norm,
            h,
            g;
          (m === void 0 || m.mean === void 0
            ...
            : typeof m.mean == 'number'
              ...
              : ((h = [m.mean[0], m.mean[1], m.mean[2], 255]),
                m.mean[3] !== void 0 && (h[3] = m.mean[3])),
            m === void 0 || m.bias === void 0
              ? (g = [0, 0, 0, 0])
              : typeof m.bias == 'number'
                ? (g = [m.bias, m.bias, m.bias, m.bias])
                : ((g = [m.bias[0], m.bias[1], m.bias[2], 0]),
                  m.bias[3] !== void 0 && (g[3] = m.bias[3])));
          let b = d * o;
          if (
            t !== void 0 &&
            ((t.format !== void 0 && c === 4 && t.format !== 'RGBA') ||
              (c === 3 && t.format !== 'RGB' && t.format !== 'BGR'))
          )
          ...
          (l === 'RGBA'
            ...
            : l === 'RGB'
              ? ((v = 0), (O = b), (N = b * 2))
              : l === 'RBG' && ((v = 0), (N = b), (O = b * 2)),
            (u = a.createImageData(o, d)));
          for (let k = 0; k < d * o; T += y, I += y, _ += y, $ += y, k++)
            ((u.data[T] = (n.data[v++] - g[0]) * h[0]),
              (u.data[I] = (n.data[O++] - g[1]) * h[1]),
              (u.data[_] = (n.data[N++] - g[2]) * h[2]),
              (u.data[$] = D === -1 ? 255 : (n.data[D++] - g[3]) * h[3]));
        } else throw new Error('Can not access image data');
        return u;
      }));
  });
  ...
  Ir = F(() => {
    ...
    ((Kt = (n, t) => {
      ...
      (typeof o.mean == 'number'
        ? (d = [o.mean, o.mean, o.mean, o.mean])
        : (d = [o.mean[0], o.mean[1], o.mean[2], o.mean[3] ?? 255]),
        typeof o.bias == 'number'
          ? (c = [o.bias, o.bias, o.bias, o.bias])
          : (c = [o.bias[0], o.bias[1], o.bias[2], o.bias[3] ?? 0]));
      let l = t.format !== void 0 ? t.format : 'RGBA',
        m = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : 'RGB',
        h = a * u,
        g = m === 'RGBA' ? new Float32Array(h * 4) : new Float32Array(h * 3),
        b = 4,
        y = 0,
        T = 1,
        I = 2,
        ...
        O = h * 2,
        N = -1;
      (l === 'RGB' && ((b = 3), (y = 0), (T = 1), (I = 2), (_ = -1)),
        m === 'RGBA'
          ? (N = h * 3)
          : m === 'RBG'
            ? (($ = 0), (O = h), (v = h * 2))
            : m === 'BGR' && ((O = 0), (v = h), ($ = h * 2)));
      for (let k = 0; k < h; k++, y += b, I += b, T += b, _ += b)
        ((g[$++] = (n[y] + c[0]) / d[0]),
          (g[v++] = (n[T] + c[1]) / d[1]),
          (g[O++] = (n[I] + c[2]) / d[2]),
          N !== -1 && _ !== -1 && (g[N++] = (n[_] + c[3]) / d[3]));
      return m === 'RGBA' ? new Q('float32', g, [1, 4, a, u]) : new Q('float32', g, [1, 3, a, u]);
    }),
      (Tr = async (n, t) => {
        let a = typeof HTMLImageElement < 'u' && n instanceof HTMLImageElement,
          u = typeof ImageData < 'u' && n instanceof ImageData,
          o = typeof ImageBitmap < 'u' && n instanceof ImageBitmap,
          d = typeof n == 'string',
          c,
          l = t ?? {},
          m = () => {
        ...
        if (a) {
          ...
          if (b != null) {
            ...
            if (
              (t !== void 0 &&
                ...
                ((y = t.resizedHeight), (T = t.resizedWidth)),
              t !== void 0)
            ) {
              if (((l = t), t.tensorFormat !== void 0))
          ...
          if (
            (t !== void 0 && t.resizedWidth !== void 0 && t.resizedHeight !== void 0
              ? ((g = t.resizedHeight), (b = t.resizedWidth))
              : ((g = n.height), (b = n.width)),
            t !== void 0 && (l = t),
            (l.format = 'RGBA'),
            (l.height = g),
            (l.width = b),
          ...
          if (b != null) {
            let y = n.height,
              T = n.width;
            return (
              b.drawImage(n, 0, 0, T, y),
              (c = b.getImageData(0, 0, T, y).data),
              (l.height = y),
              (l.width = T),
              Kt(c, l)
            );
            ...
            return new Promise((g, b) => {
              ...
              ((I.crossOrigin = 'Anonymous'),
                ...
                (I.onload = () => {
                  ((y.width = I.width),
                    (y.height = I.height),
                    T.drawImage(I, 0, 0, y.width, y.height));
      ...
      (Ar = (n, t, a) =>
        new Q({ location: 'cpu-pinned', type: n, data: t, dims: a ?? [t.length] })));
  });
var Le,
  Xe,
  Br,
  ...
  _r = F(() => {
    ...
    ((Le = new Map([
      ...
      (Lr = () => {
        if (!Br) {
          Br = !0;
          let n = typeof BigInt64Array < 'u' && BigInt64Array.from,
            t = typeof BigUint64Array < 'u' && BigUint64Array.from,
            a = globalThis.Float16Array,
            u = typeof a < 'u' && a.from;
          (n && (Le.set('int64', BigInt64Array), Xe.set(BigInt64Array, 'int64')),
            t && (Le.set('uint64', BigUint64Array), Xe.set(BigUint64Array, 'uint64')),
            u ? (Le.set('float16', a), Xe.set(a, 'float16')) : Le.set('float16', Uint16Array));
        }
      }));
  });
var Dr,
    ...
    Q = class {
      constructor(t, a, u) {
        ...
        if (typeof t == 'object' && 'location' in t)
          switch (((this.dataLocation = t.location), (o = t.type), (d = t.dims), t.location)) {
            case 'cpu-pinned': {
              let l = Le.get(o);
              if (!l)
          ...
          if (typeof t == 'string')
            if (((o = t), (m = u), t === 'string')) {
              ...
              if (Array.isArray(a)) {
                if ((t === 'float16' && h === Uint16Array) || t === 'uint4' || t === 'int4')
                  throw new TypeError(
                    `Creating a ${t} tensor from number array is not supported. Please use ${h.name} as data.`,
                  );
                t === 'uint64' || t === 'int64' ? (l = h.from(a, BigInt)) : (l = h.from(a));
              } else if (a instanceof h) l = a;
              else if (a instanceof Uint8ClampedArray)
                if (t === 'uint8') l = Uint8Array.from(a);
                else throw new TypeError("A Uint8ClampedArray tensor's data must be type of uint8");
              else if (t === 'float16' && a instanceof Uint16Array && h !== Uint16Array)
                l = new globalThis.Float16Array(a.buffer, a.byteOffset, a.length);
        ...
        if (
          this.cpuData &&
          c !== this.cpuData.length &&
          !((o === 'uint4' || o === 'int4') && Math.ceil(c / 2) === this.cpuData.length)
        )
          throw new Error(
            `Tensor's size(${c}) does not match data length(${this.cpuData.length}).`,
          );
  ...
  Mr = F(() => {
    ...
    lt = class n {
      ...
      async run(t, a, u) {
        ...
        if (typeof a == 'object') {
          ...
          if (Array.isArray(a)) {
            ...
            for (let h of a) {
              ...
              if (this.outputNames.indexOf(h) === -1)
                throw new RangeError(`'fetches' contains invalid output name: ${h}.`);
              o[h] = null;
            }
        ...
        for (let h of this.inputNames)
          if (typeof t[h] > 'u') throw new Error(`input '${h}' is missing in 'feeds'.`);
        if (c) for (let h of this.outputNames) o[h] = null;
        let l = await this.handler.run(t, o, d),
          m = {};
        for (let h in l)
          if (Object.hasOwnProperty.call(l, h)) {
            let g = l[h];
      ...
      static async create(t, a, u, o) {
        ...
        if (typeof t == 'string') {
          ...
          if (typeof a == 'object' && a !== null) c = a;
            ...
            if (((b = a), !Number.isSafeInteger(b)))
              throw new RangeError("'byteOffset' must be an integer.");
            if (b < 0 || b >= g.byteLength)
              throw new RangeError(`'byteOffset' is out of range [0, ${g.byteLength}).`);
            if (((y = t.byteLength - b), typeof u == 'number')) {
              if (((y = u), !Number.isSafeInteger(y)))
                throw new RangeError("'byteLength' must be an integer.");
              if (y <= 0 || b + y > g.byteLength)
                throw new RangeError(`'byteLength' is out of range (0, ${g.byteLength - b}].`);
        ...
        let [l, m] = await dr(c),
          h = await l.createInferenceSessionHandler(d, m);
        ...
        try {
          switch (t) {
            ...
            case 'run': {
              ...
              gt(u, o, d, c, new Array(c.length).fill(null), l).then(
                (m) => {
                  m.some((h) => h[3] !== 'cpu')
                    ? postMessage({
                        type: t,
                    ...
                    : postMessage({ type: t, out: m }, Tt([...d, ...m]));
                },
                (m) => {
...
async function Vr(n = {}) {
  var t = n,
    ...
    o = u && self.name?.startsWith('em-pthread');
  ((t.mountExternalData = (e, r) => {
    (e.startsWith('./') && (e = e.substring(2)), (t.Rb || (t.Rb = new Map())).set(e, r));
  }),
      ...
      try {
        ...
        if (s === 'load') {
          ...
          i.target !== 'setimmediate' &&
            (s === 'checkMailbox'
              ? Z && rt()
              : s && (N(`worker: received unknown command ${s}`), N(i)));
      } catch (f) {
        throw (tr(), f);
      }
    };
  ...
  function ee() {
    ...
    ((t.HEAP8 = H = new Int8Array(e)),
      (pe = new Int16Array(e)),
      (t.HEAPU8 = ne = new Uint8Array(e)),
      new Uint16Array(e),
      (t.HEAP32 = B = new Int32Array(e)),
      (t.HEAPU32 = W = new Uint32Array(e)),
      (re = new Float32Array(e)),
      (me = new Float64Array(e)),
      (A = new BigInt64Array(e)),
  ...
  async function Ut() {
    function e(s, f) {
      return (
        ...
        (s = Ee),
        (t._OrtInit = s.Ua),
        (t._OrtGetLastError = s.Va),
        (t._OrtCreateSessionOptions = s.Wa),
        (t._OrtAppendExecutionProvider = s.Xa),
        (t._OrtAddFreeDimensionOverride = s.Ya),
        (t._OrtAddSessionConfigEntry = s.Za),
        (t._OrtReleaseSessionOptions = s._a),
        (t._OrtCreateSession = s.$a),
        (t._OrtReleaseSession = s.ab),
        (t._OrtGetInputOutputCount = s.bb),
        (t._OrtGetInputOutputMetadata = s.cb),
        (t._OrtFree = s.db),
        (t._OrtCreateTensor = s.eb),
        (t._OrtGetTensorData = s.fb),
        (t._OrtReleaseTensor = s.gb),
        (t._OrtCreateRunOptions = s.hb),
        (t._OrtAddRunConfigEntry = s.ib),
        (t._OrtReleaseRunOptions = s.jb),
        (t._OrtCreateBinding = s.kb),
        (t._OrtBindInput = s.lb),
        (t._OrtBindOutput = s.mb),
        (t._OrtClearBoundOutputs = s.nb),
        (t._OrtReleaseBinding = s.ob),
        (t._OrtRunWithBinding = s.pb),
        (t._OrtRun = s.qb),
        (t._OrtEndProfiling = s.rb),
        (st = s.sb),
        (Kn = t._free = s.tb),
        (er = t._malloc = s.ub),
        (zt = s.xb),
    ...
    return t.instantiateWasm
      ...
      : o
        ? e(new WebAssembly.Instance(b, q()), b)
        : ((K ??= t.locateFile
            ? t.locateFile
              ? t.locateFile('ort-wasm-simd-threaded.wasm', h)
              : h + 'ort-wasm-simd-threaded.wasm'
  ...
  var ve = (e) => {
    ...
    L = (e, r, ...i) => {
      ...
      for (s of i)
        typeof s == 'bigint'
          ? (((w(), A)[S++ >>> 0] = 1n), ((w(), A)[S++ >>> 0] = s))
          : (((w(), A)[S++ >>> 0] = 0n), ((w(), me)[S++ >>> 0] = s));
    ...
    new Promise((r) => {
      ((e.onmessage = (f) => {
        ...
        if (((f = p.Pb), p.Sb && p.Sb != st())) {
          var E = Oe[p.Sb];
          E
            ? E.postMessage(p, p.Xb)
            : N(
                `Internal error! Worker sent a message "${f}" to target pthread ${p.Sb}, but that thread no longer exists!`,
              );
        } else
          f === 'checkMailbox'
            ? rt()
                ...
                : f === 'loaded'
                  ...
                  : p.target === 'setimmediate'
                    ...
                    : f === 'uncaughtException'
                      ...
                      : f === 'callHandler'
                        ? t[p.Yb](...p.args)
                        : f && N(`worker sent an unknown command ${f}`);
      }),
        (e.onerror = (f) => {
    ...
    var e = new Worker(
      (() => {
        ...
        return import.meta.url > 'file:' && import.meta.url < 'file;'
          ? new r('ort.wasm.bundle.min.mjs', import.meta.url)
  ...
  var Po = () => {
    ...
    var r = e.Ub;
    throw (
      (w(), H)[(e.Qb + 13) >>> 0] == 0 && (tt.push(e), Tn(e, !0), En(e, !1), nt++),
      Vt(r),
      (Fe = r)
    );
  };
  ...
  function vn(e, r, i, s) {
    ...
    return o && f.length === 0
      ? Sn(e, r, i, s)
      : ((e = { ac: i, Ob: e, Tb: s, Xb: f }),
        o ? ((e.Pb = 'spawnThread'), postMessage(e, f), 0) : ue(e));
  }
  function Co(e) {
    throw ((Fe ||= e >>> 0), Fe);
  }
  var On = globalThis.TextDecoder && new TextDecoder(),
    An = (e, r = 0, i, s) => {
      var f = (r >>>= 0);
      if (((i = f + i), s)) s = i;
      else {
      ...
      if (16 < s - r && e.buffer && On)
        return On.decode(e.buffer instanceof ArrayBuffer ? e.subarray(r, s) : e.slice(r, s));
      for (f = ''; r < s;)
        if (128 & (i = e[r++])) {
          var p = 63 & e[r++];
          if ((224 & i) == 192) f += String.fromCharCode(((31 & i) << 6) | p);
            ...
            (i =
              (240 & i) == 224
                ? ((15 & i) << 12) | (p << 6) | E
                : ((7 & i) << 18) | (p << 12) | (E << 6) | (63 & e[r++]))
              ? (f += String.fromCharCode(i))
              : ((i -= 65536), (f += String.fromCharCode(55296 | (i >> 10), 56320 | (1023 & i))));
          }
  ...
  function Nt(e) {
    ((e >>>= 0),
      No ||
        (Atomics.waitAsync((w(), B), e >>> 2, e).value.then(rt),
        (e += 128),
        Atomics.store((w(), B), e >>> 2, 1)));
  }
  var rt = () =>
    Rt(() => {
      var e = st();
  ...
  function Fo(e, r) {
    (e >>>= 0) == r >>> 0
      ? setTimeout(rt)
      : o
        ? postMessage({ Sb: e, Pb: 'checkMailbox' })
  ...
  function zo(e, r) {
    ((e = -9007199254740992 > e || 9007199254740992 < e ? NaN : Number(e)),
      (r >>>= 0),
      (e = new Date(1e3 * e)),
      ((w(), B)[(r >>> 2) >>> 0] = e.getUTCSeconds()),
      ((w(), B)[((r + 4) >>> 2) >>> 0] = e.getUTCMinutes()),
      ((w(), B)[((r + 8) >>> 2) >>> 0] = e.getUTCHours()),
      ((w(), B)[((r + 12) >>> 2) >>> 0] = e.getUTCDate()),
      ((w(), B)[((r + 16) >>> 2) >>> 0] = e.getUTCMonth()),
      ((w(), B)[((r + 20) >>> 2) >>> 0] = e.getUTCFullYear() - 1900),
      ((w(), B)[((r + 24) >>> 2) >>> 0] = e.getUTCDay()),
      (e = ((e.getTime() - Date.UTC(e.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) | 0),
      ((w(), B)[((r + 28) >>> 2) >>> 0] = e));
  }
  var kn = (e) => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0),
    Wn = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
    Gn = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
  function Ho(e, r) {
    ((e = -9007199254740992 > e || 9007199254740992 < e ? NaN : Number(e)),
      (r >>>= 0),
      (e = new Date(1e3 * e)),
      ((w(), B)[(r >>> 2) >>> 0] = e.getSeconds()),
      ((w(), B)[((r + 4) >>> 2) >>> 0] = e.getMinutes()),
      ((w(), B)[((r + 8) >>> 2) >>> 0] = e.getHours()),
      ((w(), B)[((r + 12) >>> 2) >>> 0] = e.getDate()),
      ((w(), B)[((r + 16) >>> 2) >>> 0] = e.getMonth()),
      ((w(), B)[((r + 20) >>> 2) >>> 0] = e.getFullYear() - 1900),
      ((w(), B)[((r + 24) >>> 2) >>> 0] = e.getDay()));
    var i = ((kn(e.getFullYear()) ? Wn : Gn)[e.getMonth()] + e.getDate() - 1) | 0;
    (((w(), B)[((r + 28) >>> 2) >>> 0] = i),
      ((w(), B)[((r + 36) >>> 2) >>> 0] = -60 * e.getTimezoneOffset()),
      (i = new Date(e.getFullYear(), 6, 1).getTimezoneOffset()));
    var s = new Date(e.getFullYear(), 0, 1).getTimezoneOffset();
    ((e = 0 | (i != s && e.getTimezoneOffset() == Math.min(s, i))),
      ((w(), B)[((r + 32) >>> 2) >>> 0] = e));
  }
  function jo(e) {
    e >>>= 0;
    var r = new Date(
      ...
      p = new Date(r.getFullYear(), 0, 1).getTimezoneOffset(),
      E = Math.min(p, f);
    return (
      0 > i
        ? ((w(), B)[((e + 32) >>> 2) >>> 0] = +(f != p && E == s))
        : 0 < i != (E == s) &&
          ((f = Math.max(p, f)), r.setTime(r.getTime() + 6e4 * ((0 < i ? E : f) - s))),
      ((w(), B)[((e + 24) >>> 2) >>> 0] = r.getDay()),
      (i = ((kn(r.getFullYear()) ? Wn : Gn)[r.getMonth()] + r.getDate() - 1) | 0),
      ((w(), B)[((e + 28) >>> 2) >>> 0] = i),
      ((w(), B)[(e >>> 2) >>> 0] = r.getSeconds()),
      ((w(), B)[((e + 4) >>> 2) >>> 0] = r.getMinutes()),
      ((w(), B)[((e + 8) >>> 2) >>> 0] = r.getHours()),
      ((w(), B)[((e + 12) >>> 2) >>> 0] = r.getDate()),
      ((w(), B)[((e + 16) >>> 2) >>> 0] = r.getMonth()),
      ((w(), B)[((e + 20) >>> 2) >>> 0] = r.getYear()),
      (e = r.getTime()),
  ...
  var Ye = {},
    Vo = () => performance.timeOrigin + performance.now();
  function Hn(e, r) {
  ...
  function Yo(e, r, i, s) {
    ...
    (((w(), W)[(e >>> 2) >>> 0] = 60 * E),
      ...
      (r = r(f)),
      f < p ? (Ae(e, i, 17), Ae(r, s, 17)) : (Ae(e, s, 17), Ae(r, i, 17)));
  }
  var Jo = () => Date.now(),
    qo = 1;
  function Xo(e, r, i) {
  ...
  var na = () => navigator.hardwareConcurrency,
    Ie = {},
    Wt = (e) => {
    ...
    ot = (e) => {
      var r;
      return (r = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(e))
        ? +r[1]
        : (r = /:(\d+):\d+(?:\)|$)/.exec(e))
          ? 2147483648 | +r[1]
          : 0;
...
`))[0] == 'Error' && s.shift(),
  ...
  (o ||
    ...
    o || ((ge = new WebAssembly.Memory({ initial: 256, maximum: 65536, shared: !0 })), ee()),
    t.wasmBinary && (g = t.wasmBinary),
    (t.stackSave = () => U()),
    (t.stackRestore = (e) => P(e)),
    (t.stackAlloc = (e) => jt(e)),
    (t.setValue = function (e, r, i = 'i8') {
  ...
  var st,
    ...
    lr = {
      1011284: (e, r, i, s, f) => {
        ...
        if (
          ((e = Mt(Number(e >>> 0))).startsWith('./') && (e = e.substring(2)), !(e = t.Rb.get(e)))
        )
          return 2;
        if (
          ((r = Number(r >>> 0)),
...
var Qr,
  ...
  pt = F(() => {
    'use strict';
    dt();
    ((Qr = typeof location > 'u' ? void 0 : location.origin),
      (an = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (as = () => {
        if (!!1) {
          if (an) {
            let n = URL;
      ...
      (to = async (n, t, a, u) => {
        ...
        {
          let d = 'ort-wasm-simd-threaded.mjs',
            c = n ?? ss(d, t),
            l = !!1 && a && c && !on(c, t),
            m = l ? await Kr(c) : (c ?? is(d, t));
    ...
    ((ae = (n, t) => {
      ...
      (G = (n) => {
        ...
        try {
          ...
          let d = Number(t.getValue(o, u === 4 ? 'i32' : 'i64')),
            c = t.getValue(o + u, '*'),
            l = c ? t.UTF8ToString(c) : '';
    ...
    ro = (n) => {
      ...
      try {
        if (n?.logSeverityLevel === void 0) o.logSeverityLevel = 2;
          ...
          throw new Error(`log severity level is not valid: ${n.logSeverityLevel}`);
        if (n?.logVerbosityLevel === void 0) o.logVerbosityLevel = 0;
        else if (typeof n.logVerbosityLevel != 'number' || !Number.isInteger(n.logVerbosityLevel))
          throw new Error(`log verbosity level is not valid: ${n.logVerbosityLevel}`);
        n?.terminate === void 0 && (o.terminate = !1);
        let d = 0;
        return (
          n?.tag !== void 0 && (d = ae(n.tag, u)),
          (a = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, d)),
          a === 0 && G("Can't create run options."),
          n?.extra !== void 0 &&
            Ze(n.extra, '', new WeakSet(), (c, l) => {
              let m = ae(c, u),
                h = ae(l, u);
              t._OrtAddRunConfigEntry(a, m, h) !== 0 &&
                G(`Can't set a run config entry: ${c} - ${l}.`);
            }),
          [a, u]
        );
      } catch (d) {
      ...
      (ms = (n) => {
        ...
        (t.use_ort_model_bytes_directly || (t.use_ort_model_bytes_directly = '1'),
          n.executionProviders &&
            n.executionProviders.some((a) => (typeof a == 'string' ? a : a.name) === 'webgpu') &&
            (n.enableMemPattern = !1));
      }),
      (ke = (n, t, a, u) => {
        let o = ae(t, u),
          d = ae(a, u);
        z()._OrtAddSessionConfigEntry(n, o, d) !== 0 &&
          G(`Can't set a session config entry: ${t} - ${a}.`);
      }),
      (hs = async (n, t, a) => {
        let u = t.executionProviders;
        for (let o of u) {
          let d = typeof o == 'string' ? o : o.name,
            c = [];
          switch (d) {
            case 'webnn':
              if (
                ((d = 'WEBNN'),
                ke(n, 'session.disable_quant_qdq', '1', a),
                ke(n, 'session.disable_qdq_constant_folding', '1', a),
                typeof o != 'string')
              ) {
                let y = o?.deviceType;
            ...
            case 'webgpu':
              if (((d = 'JS'), typeof o != 'string')) {
                ...
                if (b?.preferredLayout) {
                  if (b.preferredLayout !== 'NCHW' && b.preferredLayout !== 'NHWC')
                    throw new Error(
                      `preferredLayout must be either 'NCHW' or 'NHWC': ${b.preferredLayout}`,
                    );
          ...
          let l = ae(d, a),
            ...
            g = 0;
          if (m > 0) {
            ((h = z()._malloc(m * z().PTR_SIZE)),
              a.push(h),
              (g = z()._malloc(m * z().PTR_SIZE)),
              a.push(g));
            for (let b = 0; b < m; b++)
              (z().setValue(h + b * z().PTR_SIZE, c[b][0], '*'),
                z().setValue(g + b * z().PTR_SIZE, c[b][1], '*'));
          }
          (await z()._OrtAppendExecutionProvider(n, l, h, g, m)) !== 0 &&
            G(`Can't append execution provider: ${d}.`);
        }
      }),
      (ao = async (n) => {
        let t = z(),
        ...
        ms(o);
        try {
          let d = ds(o.graphOptimizationLevel ?? 'all'),
            c = ps(o.executionMode ?? 'sequential'),
            l = typeof o.logId == 'string' ? ae(o.logId, u) : 0,
            m = o.logSeverityLevel ?? 2;
          if (!Number.isInteger(m) || m < 0 || m > 4)
            throw new Error(`log severity level is not valid: ${m}`);
          ...
          if (
            ...
            o.executionProviders && (await hs(a, o, u)),
          ...
          if (o.freeDimensionOverrides)
            for (let [b, y] of Object.entries(o.freeDimensionOverrides)) {
              if (typeof b != 'string')
                throw new Error(`free dimension override name must be a string: ${b}`);
              if (typeof y != 'number' || !Number.isInteger(y) || y < 0)
                throw new Error(
                  `free dimension override value must be a non-negative integer: ${y}`,
                );
              let T = ae(b, u);
              t._OrtAddFreeDimensionOverride(a, T, y) !== 0 &&
                G(`Can't set a free dimension override: ${b} - ${y}.`);
            }
          return (
            o.extra !== void 0 &&
              Ze(o.extra, '', new WeakSet(), (b, y) => {
                ke(a, b, y, u);
              }),
            [a, u]
          );
    ...
    ((We = (n) => {
      ...
      (Ge = (n, t) => {
        let a = [-1, 4, 1, 1, 2, 2, 4, 8, -1, 1, 2, 8, 4, 8, -1, -1, -1, -1, -1, -1, -1, 0.5, 0.5][
          ...
          u = typeof t == 'number' ? t : t.reduce((o, d) => o * d, 1);
        ...
        if (!1)
          try {
            ...
            if (t.code === 'ERR_FS_FILE_TOO_LARGE') {
              let { createReadStream: a } = qt('node:fs'),
                u = a(n),
                o = [];
          ...
          {
            if (!t.body)
              throw new Error(`failed to load external data file: ${n}, no response body.`);
    ...
    ((ws = (n, t) => {
      ...
      (bs = (n) => {
        ...
        try {
          let u = t.PTR_SIZE,
            o = t.stackAlloc(2 * u);
          t._OrtGetInputOutputCount(n, o, o + u) !== 0 &&
      ...
      (bt = async (n, t) => {
        ...
        Array.isArray(n)
          ? ([a, u] = n)
          : n.buffer === o.HEAPU8.buffer
            ? ([a, u] = [n.byteOffset, n.byteLength])
            : ([a, u] = Qe(n));
        let d = 0,
          c = 0,
          l = 0,
        ...
        try {
          ...
          for (let D of t?.executionProviders ?? [])
            if ((typeof D == 'string' ? D : D.name) === 'webnn') {
              if (((o.shouldTransferToMLTensor = !1), typeof D != 'string')) {
                let w = D,
                  Z = w?.context,
                  H = w?.gpuDevice,
                  ne = w?.deviceType,
                  pe = w?.powerPreference;
                Z
                  ? (o.currentContext = Z)
                  : H
                    ? (o.currentContext = await o.webnnCreateMLContext(H))
          ...
          ((d = await o._OrtCreateSession(a, u, c)),
            o.webgpuOnCreateSession?.(d),
            d === 0 && G("Can't create a session."),
            o.jsepOnCreateSession?.(),
            o.currentContext &&
              (o.webnnRegisterMLContext(d, o.currentContext),
          ...
          for (let D = 0; D < b; D++) {
            ...
            (I.push(H),
              $.push(
                w === 0
                  ? { name: H, isTensor: !1 }
                  : { name: H, isTensor: !0, type: Ot(w), shape: Z },
              ));
          }
          for (let D = 0; D < y; D++) {
            let [k, w, Z] = co(d, D + b);
          ...
          return ($e.set(d, [d, h, g, null, T, !1]), [d, I, _, $, v]);
        } catch (b) {
          throw (
            h.forEach((y) => o._OrtFree(y)),
            g.forEach((y) => o._OrtFree(y)),
            l !== 0 && o._OrtReleaseBinding(l) !== 0 && G("Can't release IO binding."),
            d !== 0 && o._OrtReleaseSession(d) !== 0 && G("Can't release session."),
            b
          );
        } finally {
          (o._free(a),
            c !== 0 && o._OrtReleaseSessionOptions(c) !== 0 && G("Can't release session options."),
            m.forEach((b) => o._free(b)),
      ...
      (yt = (n) => {
        ...
        let [u, o, d, c, l] = a;
        (c &&
          (l && t._OrtClearBoundOutputs(c.handle) !== 0 && G("Can't clear bound outputs."),
          t._OrtReleaseBinding(c.handle) !== 0 && G("Can't release IO binding.")),
          t.jsepOnReleaseSession?.(n),
          t.webnnOnReleaseSession?.(n),
          t.webgpuOnReleaseSession?.(n),
          o.forEach((m) => t._OrtFree(m)),
          d.forEach((m) => t._OrtFree(m)),
      ...
      (lo = async (n, t, a, u, o, d, c = !1) => {
        ...
        let l = z(),
          ...
          T,
          I;
        if (h === 'string' && (b === 'gpu-buffer' || b === 'ml-tensor'))
          ...
          if (Array.isArray(v)) {
            ...
            for (let O = 0; O < v.length; O++) {
              if (typeof v[O] != 'string')
                throw new TypeError(`tensor data at index ${O} is not a string`);
              l.setValue(T + O * m, ae(v[O], a), '*');
            }
          } else {
            let O = l.webnnIsGraphInput,
              N = l.webnnIsGraphOutput;
            if (h !== 'string' && O && N) {
              let D = l.UTF8ToString(o);
              if (O(u, D) || N(u, D)) {
                let k = We(h);
                ((I = Ge(k, g)), (y = 'ml-tensor'));
                let w = l.webnnCreateTemporaryTensor,
                  Z = l.webnnUploadTensor;
                if (!w || !Z)
                  throw new Error(
                ...
                ((I = v.byteLength),
                  (T = l._malloc(I)),
                  a.push(T),
                  l.HEAPU8.set(new Uint8Array(v.buffer, v.byteOffset, I), T));
            } else
              ((I = v.byteLength),
                (T = l._malloc(I)),
                a.push(T),
      ...
      (gt = async (n, t, a, u, o, d) => {
        ...
        try {
          ...
          for (let A = 0; A < _; A++)
            (c.setValue(H + A * l, N[A], '*'), c.setValue(ne + A * l, g[t[A]], '*'));
          for (let A = 0; A < $; A++)
            (c.setValue(pe + A * l, D[A], '*'), c.setValue(B + A * l, b[u[A]], '*'));
          (c.jsepOnRunStart?.(h), c.webnnOnRunStart?.(h));
          let W;
          ((W = await c._OrtRun(h, ne, H, _, B, $, pe, v)),
            W !== 0 && G('failed to call OrtRun().'));
          let re = [],
            me = [];
          ...
          for (let A = 0; A < $; A++) {
            ...
            if (K === D[A] || w.includes(D[A])) {
              (re.push(o[A]),
                K !== D[A] && c._OrtReleaseTensor(K) !== 0 && G("Can't release tensor."));
              continue;
            }
            let je = c.stackSave(),
              ee = c.stackAlloc(4 * l),
              ...
              q = 0;
            try {
              c._OrtGetTensorData(K, ee, ee + l, ee + 2 * l, ee + 3 * l) !== 0 &&
                G(`Can't access output tensor data on index ${A}.`);
              let Se = l === 4 ? 'i32' : 'i64',
                ve = Number(c.getValue(ee, Se));
              q = c.getValue(ee + l, '*');
              let Ve = c.getValue(ee + l * 2, '*'),
                Re = Number(c.getValue(ee + l * 3, Se)),
                te = [];
              ...
              if (j === 'string') {
                ...
                let L = [];
                for (let V = 0; V < ue; V++) {
                  let fe = c.getValue(q + V * l, '*'),
                    ye = c.getValue(q + (V + 1) * l, '*'),
                    ce = V === ue - 1 ? void 0 : ye - fe;
                ...
                let L = c.webnnEnsureTensor,
                  V = c.webnnIsGraphInputOutputTypeSupported;
                if (!L || !V)
                  throw new Error(
                ...
                let L = c.webnnCreateMLTensorDownloader(q, j)(),
                  V = re.length;
                ((he = !0),
                  me.push(
                    (async () => {
                ...
                let L = io(j),
                  V = new L(ue);
                (new Uint8Array(V.buffer, V.byteOffset, V.byteLength).set(
                  c.HEAPU8.subarray(q, q + V.byteLength),
                ),
                  re.push([j, te, V, 'cpu']));
              }
            } finally {
          ...
          y &&
            !T &&
            (c._OrtClearBoundOutputs(y.handle) !== 0 && G("Can't clear bound outputs."),
            $e.set(n, [h, g, b, y, T, !1]));
          ...
          (c.webnnOnRunEnd?.(h),
            c.stackRestore(Z),
            N.forEach((W) => c._OrtReleaseTensor(W)),
            D.forEach((W) => c._OrtReleaseTensor(W)),
            k.forEach((W) => c._free(W)),
            v !== 0 && c._OrtReleaseRunOptions(v),
            O.forEach((W) => c._free(W)));
        }
      }),
      (Et = (n) => {
        let t = z(),
...
var Me,
  ...
  pn = F(() => {
    ...
    xe();
    pt();
    ((Me = () => !!Y.wasm.proxy && typeof document < 'u'),
      (et = !1),
      (Lt = !1),
      (_t = !1),
      (dn = new Map()),
      ...
      (gs = (n) => {
        switch (n.data.type) {
          case 'init-wasm':
            ((et = !1),
              n.data.err ? ((_t = !0), ln[1](n.data.err)) : ((Lt = !0), ln[0]()),
              Bt && (URL.revokeObjectURL(Bt), (Bt = void 0)));
            break;
          case 'init-ep':
          case 'copy-from':
          case 'create':
      ...
      (wo = async (n, t) => {
        if (Me()) {
          ...
          return (
            ...
            new Promise((a, u) => {
              ze('create', [a, u]);
              let o = { type: 'create', in: { model: n, options: { ...t } } },
                d = [];
          ...
          return (
            ...
            new Promise((c, l) => {
              ...
              let m = a,
                h = {
                  type: 'run',
                  in: { sessionId: n, inputIndices: t, inputs: m, outputIndices: u, options: d },
                };
      ...
      (Dt = class {
        ...
        async run(t, a, u) {
          ...
          Object.entries(a).forEach((y) => {
            let T = y[0],
              I = y[1],
              _ = this.outputNames.indexOf(T);
            if (_ === -1) throw new Error(`invalid output '${T}'`);
            (c.push(I), l.push(_));
          });
          let m = o.map((y, T) => Eo(y, () => `input "${this.inputNames[d[T]]}"`)),
            h = c.map((y, T) => (y ? Eo(y, () => `output "${this.outputNames[l[T]]}"`) : null)),
            g = await yo(this.sessionId, d, m, l, h, u),
            b = {};
    ...
    ((So = () => {
      ...
      if (
        (typeof n != 'boolean' &&
          ...
          (Y.wasm.simd = !1)),
        typeof Y.wasm.proxy != 'boolean' && (Y.wasm.proxy = !1),
        typeof Y.wasm.trace != 'boolean' && (Y.wasm.trace = !1),
        typeof Y.wasm.numThreads != 'number' ||
          !Number.isInteger(Y.wasm.numThreads) ||
          Y.wasm.numThreads <= 0)
      )
        if (typeof self < 'u' && !self.crossOriginIsolated) Y.wasm.numThreads = 1;
        else {
          let t =
            typeof navigator > 'u' ? qt('node:os').cpus().length : navigator.hardwareConcurrency;
...
Object.defineProperty(Y.versions, 'web', { value: Gr, enumerable: !0 });
export {
  ts as InferenceSession,
  xr as TRACE,
  Pe as TRACE_EVENT_BEGIN,
