...
var ort = (() => {
    ...
    Dn = (e, t, n, o) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let r of Ln(t))
          !Pn.call(e, r) &&
            r !== n &&
            Je(e, r, { get: () => t[r], enumerable: !(o = On(t, r)) || o.enumerable });
      return e;
    };
        ...
        (vt = () => {
          if (!xt) {
            ...
            let e = typeof BigInt64Array < 'u' && BigInt64Array.from,
              ...
              o = typeof n < 'u' && n.from;
            (e && (Q.set('int64', BigInt64Array), me.set(BigInt64Array, 'int64')),
              t && (Q.set('uint64', BigUint64Array), me.set(BigUint64Array, 'uint64')),
              o ? (Q.set('float16', n), me.set(n, 'float16')) : Q.set('float16', Uint16Array));
          }
        }));
    });
  var Mt,
          ...
          try {
            switch (t) {
              ...
              case 'run': {
                ...
                xe(o, r, i, s, new Array(s.length).fill(null), a).then(
                  (u) => {
                    u.some((f) => f[3] !== 'cpu')
                      ? postMessage({
                          type: t,
                      ...
                      : postMessage({ type: t, out: u }, Ce([...i, ...u]));
                  },
                  (u) => {
      ...
      ((Wn = (e) => {
          ...
          for (let r of o) {
            ...
            switch (i) {
              case 'webnn':
                if (
                  ((i = 'WEBNN'),
                  ie(e, 'session.disable_quant_qdq', '1', n),
                  ie(e, 'session.disable_qdq_constant_folding', '1', n),
                  typeof r != 'string')
                ) {
                  let d = r?.deviceType;
        ...
        (sn = async (e) => {
          ...
          try {
            ...
            let l =
              typeof r.optimizedModelFilePath == 'string' ? N(r.optimizedModelFilePath, o) : 0;
            if (
          ...
          if (!1)
            try {
              ...
              if (t.code === 'ERR_FS_FILE_TOO_LARGE') {
                let { createReadStream: n } = qe('node:fs'),
                  o = n(e),
                  r = [];
      ...
      ((Hn = (e, t) => {
        ...
        (_e = async (e, t) => {
          ...
          try {
            ...
            for (let g = 0; g < c; g++) {
              ...
              (h.push(_),
                A.push(
                  x === 0
                    ? { name: _, isTensor: !1 }
                    : { name: _, isTensor: !0, type: Fe(x), shape: M },
                ));
            }
            for (let g = 0; g < d; g++) {
              let [T, x, M] = dn(i, g + c);
            ...
            return (fe.set(i, [i, f, l, null, p, !1]), [i, h, b, A, m]);
          } catch (c) {
            throw (
        ...
        (xe = async (e, t, n, o, r, i) => {
          ...
          try {
            ...
            for (let y = 0; y < b; y++)
              (s.setValue(_ + y * a, O[y], '*'), s.setValue(le + y * a, l[t[y]], '*'));
            for (let y = 0; y < A; y++)
              (s.setValue(re + y * a, g[y], '*'), s.setValue(lt + y * a, c[o[y]], '*'));
            (s.jsepOnRunStart?.(f), s.webnnOnRunStart?.(f));
            let F;
            ((F = await s._OrtRun(f, le, _, b, lt, A, re, m)),
            ...
            for (let y = 0; y < A; y++) {
              ...
              if (G === g[y] || x.includes(g[y])) {
                (z.push(r[y]),
                  G !== g[y] && s._OrtReleaseTensor(G) !== 0 && S("Can't release tensor."));
                continue;
              }
              let mt = s.stackSave(),
                $ = s.stackAlloc(4 * a),
              ...
              try {
                ...
                let Ve = a === 4 ? 'i32' : 'i64',
                  ge = Number(s.getValue($, Ve));
                C = s.getValue($ + a, '*');
                let wt = s.getValue($ + a * 2, '*'),
                  Bn = Number(s.getValue($ + a * 3, Ve)),
                  H = [];
      ...
      ((Tn = () => {
        ...
        if (
          ...
          if (typeof self < 'u' && !self.crossOriginIsolated) B.wasm.numThreads = 1;
            ...
            let t =
              typeof navigator > 'u' ? qe('node:os').cpus().length : navigator.hardwareConcurrency;
  ...
  Object.defineProperty(B.versions, 'web', { value: Vt, enumerable: !0 });
  return Ye(Xn);
})();
