  ...
  Dn = (e, t, n, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let r of Ln(t))
        !Pn.call(e, r) &&
          r !== n &&
          Ve(e, r, { get: () => t[r], enumerable: !(o = On(t, r)) || o.enumerable });
    return e;
  };
var wt = (e) => Dn(Ve({}, '__esModule', { value: !0 }), e);
var Se,
  q,
  pe,
  _n,
    ...
    ((Tt = (e, t) => {
      ...
      (It = (e, t) => {
        ...
        if (n != null) {
          ...
          for (let T = 0; T < i * r; p += d, h += d, b += d, A += d, T++)
            ((o.data[p] = (e.data[m++] - l[0]) * f[0]),
              (o.data[h] = (e.data[w++] - l[1]) * f[1]),
              (o.data[b] = (e.data[O++] - l[2]) * f[2]),
              (o.data[A] = g === -1 ? 255 : (e.data[g++] - l[3]) * f[3]));
        } else throw new Error('Can not access image data');
        return o;
      }));
  });
  ...
  _t = E(() => {
    ...
    ((Xe = (e, t) => {
      ...
      let a = t.format !== void 0 ? t.format : 'RGBA',
        ...
        w = f * 2,
        O = -1;
      (a === 'RGB' && ((c = 3), (d = 0), (p = 1), (h = 2), (b = -1)),
        u === 'RGBA'
          ? (O = f * 3)
          : u === 'RBG'
            ? ((A = 0), (w = f), (m = f * 2))
            : u === 'BGR' && ((w = 0), (m = f), (A = f * 2)));
      for (let T = 0; T < f; T++, d += c, h += c, p += c, b += c)
        ((l[A++] = (e[d] + s[0]) / i[0]),
          (l[m++] = (e[p] + s[1]) / i[1]),
          (l[w++] = (e[h] + s[2]) / i[2]),
          O !== -1 && b !== -1 && (l[O++] = (e[b] + s[3]) / i[3]));
      ...
      (Dt = (e, t, n) =>
        new v({ location: 'cpu-pinned', type: e, data: t, dims: n ?? [t.length] })));
  });
var Y,
  me,
  Ut,
      ...
      (xt = () => {
        if (!Ut) {
          ...
          let e = typeof BigInt64Array < 'u' && BigInt64Array.from,
            ...
            o = typeof n < 'u' && n.from;
          (e && (Y.set('int64', BigInt64Array), me.set(BigInt64Array, 'int64')),
            t && (Y.set('uint64', BigUint64Array), me.set(BigUint64Array, 'uint64')),
            o ? (Y.set('float16', n), me.set(n, 'float16')) : Y.set('float16', Uint16Array));
        }
      }));
  });
var Ct,
  ...
  kt = E(() => {
    ...
    Ie = class e {
      ...
      async run(t, n, o) {
        ...
        let r = {},
          i = {};
        if (typeof t != 'object' || t === null || t instanceof G || Array.isArray(t))
          throw new TypeError(
        ...
        if (typeof n == 'object') {
          ...
          if (Array.isArray(n)) {
            ...
            for (let c of this.outputNames)
              if (l.indexOf(c) !== -1) {
                let d = n[c];
                (d === null || d instanceof G) && ((f = !0), (s = !1), (r[c] = d));
              }
            if (f) {
              if (typeof o == 'object' && o !== null) i = o;
              else if (typeof o < 'u') throw new TypeError("'options' must be an object.");
...
var Kt,
  ...
  Be = E(() => {
    'use strict';
    Ae();
    ((Kt = typeof location > 'u' ? void 0 : location.origin),
      (vn = import.meta.url > 'file:' && import.meta.url < 'file;'),
      (Cn = () => {
        if (!!1) {
          if (vn) {
            let e = URL;
      ...
      (Nn = async (e) => (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ e)).default),
      (Zt = (Yt(), wt(qt)).default),
      (en = async () => {
        if (!R)
        ...
        if (
          ...
          h.push(
            new Promise((b, A) => {
              ...
              d(m).then(
                (w) => {
                  ((Me = !1), (ot = !0), (rt = w), b(), c && URL.revokeObjectURL(c));
                },
                (w) => {
                  ((Me = !1), (nn = !0), A(w));
                },
  ...
  an = E(() => {
    ...
    ((Gn = (e) => {
        ...
        for (let r of o) {
          ...
          switch (i) {
            case 'webnn':
              if (
                ((i = 'WEBNN'),
                se(e, 'session.disable_quant_qdq', '1', n),
                se(e, 'session.disable_qdq_constant_folding', '1', n),
                typeof r != 'string')
              ) {
                let d = r?.deviceType;
      ...
      (sn = async (e) => {
        ...
        zn(r);
        try {
          let i = Gn(r.graphOptimizationLevel ?? 'all'),
            s = $n(r.executionMode ?? 'sequential'),
            a = typeof r.logId == 'string' ? N(r.logId, o) : 0,
          ...
          if (
            ...
            r.executionProviders && (await Hn(n, r, o)),
          ...
          throw (
            n !== 0 && t._OrtReleaseSessionOptions(n) !== 0 && S("Can't release session options."),
    ...
    ((jn = (e, t) => {
        ...
        try {
          if ((([s, u] = await sn(t)), t?.externalData && r.mountExternalData)) {
            ...
            for (let T of t.externalData) {
              let x = typeof T == 'string' ? T : T.path,
          ...
          for (let g = 0; g < c; g++) {
            ...
            (h.push(_),
              A.push(
                x === 0
                  ? { name: _, isTensor: !1 }
                  : { name: _, isTensor: !0, type: Ne(x), shape: M },
              ));
          }
          for (let g = 0; g < d; g++) {
            let [T, x, M] = dn(i, g + c);
          ...
          return (ue.set(i, [i, f, l, null, p, !1]), [i, h, b, A, m]);
        } catch (c) {
          throw (
          ...
          (r._free(n),
            s !== 0 && r._OrtReleaseSessionOptions(s) !== 0 && S("Can't release session options."),
        ...
        if (c === 'gpu-buffer') {
          ...
          if (Array.isArray(m)) {
            ...
            let w = a.webnnIsGraphInput,
              O = a.webnnIsGraphOutput;
            if (f !== 'string' && w && O) {
              let g = a.UTF8ToString(r);
              if (w(o, g) || O(o, g)) {
                let T = ie(f);
                ((h = ae(T, l)), (d = 'ml-tensor'));
                let x = a.webnnCreateTemporaryTensor,
      ...
      (Ue = async (e, t, n, o, r, i) => {
        ...
        try {
          ...
          for (let y = 0; y < b; y++)
            (s.setValue(_ + y * a, O[y], '*'), s.setValue(de + y * a, l[t[y]], '*'));
          for (let y = 0; y < A; y++)
            (s.setValue(re + y * a, g[y], '*'), s.setValue(ct + y * a, c[o[y]], '*'));
          (s.jsepOnRunStart?.(f), s.webnnOnRunStart?.(f));
          let F;
          ((F = await s._OrtRun(f, de, _, b, ct, A, re, m)),
            F !== 0 && S('failed to call OrtRun().'));
          let z = [],
            dt = [];
          ...
          for (let y = 0; y < A; y++) {
            ...
            if (W === g[y] || x.includes(g[y])) {
              (z.push(r[y]),
                W !== g[y] && s._OrtReleaseTensor(W) !== 0 && S("Can't release tensor."));
              continue;
            }
            let lt = s.stackSave(),
              $ = s.stackAlloc(4 * a),
              ...
              C = 0;
            try {
              s._OrtGetTensorData(W, $, $ + a, $ + 2 * a, $ + 3 * a) !== 0 &&
                S(`Can't access output tensor data on index ${y}.`);
              let je = a === 4 ? 'i32' : 'i64',
                ge = Number(s.getValue($, je));
              C = s.getValue($ + a, '*');
              let pt = s.getValue($ + a * 2, '*'),
                Bn = Number(s.getValue($ + a * 3, je)),
                H = [];
              ...
              if (P === 'string') {
                ...
                for (let L = 0; L < j; L++) {
                  let V = s.getValue(C + L * a, '*'),
                    Ee = s.getValue(C + (L + 1) * a, '*'),
                    mt = L === j - 1 ? void 0 : Ee - V;
                ...
                let U = s.webnnCreateMLTensorDownloader(C, P)(),
                  L = z.length;
                ((oe = !0),
                  dt.push(
                    (async () => {
          ...
          (s.webnnOnRunEnd?.(f),
            s.stackRestore(M),
            O.forEach((F) => s._OrtReleaseTensor(F)),
            g.forEach((F) => s._OrtReleaseTensor(F)),
            T.forEach((F) => s._free(F)),
            m !== 0 && s._OrtReleaseRunOptions(m),
            w.forEach((F) => s._free(F)));
        }
      }),
      (xe = (e) => {
        let t = I(),
    ...
    ((ne = () => !!B.wasm.proxy && typeof document < 'u'),
      ...
      (qn = (e) => {
        switch (e.data.type) {
          case 'init-wasm':
            ((ye = !1),
              e.data.err ? (($e = !0), at[1](e.data.err)) : ((Ge = !0), at[0]()),
      ...
      (pn = async () => {
        if (!Ge) {
          ...
          try {
            (await Oe(B.wasm), await Le(B), (Ge = !0));
          } catch (e) {
            throw (($e = !0), e);
          } finally {
            ye = !1;
  ...
  An = E(() => {
    ...
    ((Tn = () => {
      ...
      if (
        ...
        if (typeof self < 'u' && !self.crossOriginIsolated) B.wasm.numThreads = 1;
        else {
          let t =
            typeof navigator > 'u' ? Je('node:os').cpus().length : navigator.hardwareConcurrency;
...
Object.defineProperty(B.versions, 'web', { value: jt, enumerable: !0 });
export {
