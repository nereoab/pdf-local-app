    ...
    'common/dist/esm/tensor-conversion-impl.js'() {
      ...
      tensorToImageData = (tensor, options) => {
        ...
        if (pixels2DContext != null) {
          ...
          const inputformat =
            options !== void 0 ? (options.format !== void 0 ? options.format : 'RGB') : 'RGB';
          const norm = options?.norm;
          let normMean;
          let normBias;
          if (norm === void 0 || norm.mean === void 0) {
          ...
          if (options !== void 0) {
            if (
              (options.format !== void 0 && channels === 4 && options.format !== 'RGBA') ||
  ...
  var init_tensor_factory_impl = __esm({
    'common/dist/esm/tensor-factory-impl.js'() {
      ...
      bufferToTensor = (buffer, options) => {
        ...
        const stride = height * width;
        const float32Data =
          outputformat === 'RGBA' ? new Float32Array(stride * 4) : new Float32Array(stride * 3);
        let step = 4,
          rImagePointer = 0,
          gImagePointer = 1,
          bImagePointer = 2,
          ...
          if (typeof arg0 === 'object' && 'location' in arg0) {
            ...
            if (typeof arg0 === 'string') {
              ...
              if (arg0 === 'string') {
                ...
                if (Array.isArray(arg1)) {
                  if (
                    (arg0 === 'float16' && typedArrayConstructor === Uint16Array) ||
                    arg0 === 'uint4' ||
                    arg0 === 'int4'
                  ) {
                    throw new TypeError(
      ...
      isMultiThreadSupported = () => {
        ...
        try {
          ...
          return WebAssembly.validate(
            new Uint8Array([
              0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 4, 1, 3, 1, 1, 10, 11,
              1, 9, 0, 65, 0, 254, 16, 2, 0, 26, 11,
            ]),
          );
        } catch {
          return false;
        ...
        try {
          ...
          if (options?.extra !== void 0) {
            iterateExtraOptions(options.extra, '', /* @__PURE__ */ new WeakSet(), (key, value) => {
              ...
              if (
                wasm2._OrtAddRunConfigEntry(runOptionsHandle, keyDataOffset, valueDataOffset) !== 0
              ) {
                ...
                if (typeof ep !== 'string') {
                  ...
                  if (webgpuOptions.device) {
                    if (
                      ...
                      webgpuOptions.device instanceof GPUDevice
                    ) {
                  ...
                  for (const key of [
                    ...
                    if (mode) {
                      if (
                        ...
                        throw new Error(
                          `${key} must be one of 'disabled', 'lazyRelease', 'simple' or 'bucket': ${mode}`,
                        );
                      }
        ...
        try {
          ...
          if (sessionOptions.freeDimensionOverrides) {
            for (const [name, value] of Object.entries(sessionOptions.freeDimensionOverrides)) {
              ...
              if (
                wasm2._OrtAddFreeDimensionOverride(sessionOptionsHandle, nameOffset, value) !== 0
              ) {
  ...
  var init_wasm_common = __esm({
    'web/lib/wasm/wasm-common.ts'() {
      ...
      calculateTensorSizeInBytes = (dateType, dimsOrSize) => {
        ...
        const size =
          typeof dimsOrSize === 'number' ? dimsOrSize : dimsOrSize.reduce((a, b) => a * b, 1);
    ...
    'web/lib/wasm/jsep/webnn/tensor-manager.ts'() {
      ...
      TensorIdTracker = class {
        ...
        async ensureTensor(sessionId, dataType, shape, copyOld) {
          ...
          const usage =
            typeof MLTensorUsage == 'undefined' ? void 0 : MLTensorUsage.READ | MLTensorUsage.WRITE;
          ...
          if (this.activeUpload) {
            ...
            if (dstBuffer) {
              if (dstBuffer instanceof ArrayBuffer) {
                ...
                new Uint8Array(dstBuffer.buffer, dstBuffer.byteOffset, dstBuffer.byteLength).set(
                  dstData,
                );
              }
              return;
          ...
          for (let i = 0; i < dimsCount; i++) {
            ...
            dims.push(
              symbolicDimNameOffset !== 0
                ...
                : Number(wasm2.getValue(metadataOffset + 8 + (i + dimsCount) * ptrSize, '*')),
            );
          }
      ...
      createSession = async (modelData, options) => {
        ...
        try {
          ...
          for (let i = 0; i < inputCount; i++) {
            const [nameOffset, elementType, shape] = getSessionInputOutputMetadata(
              sessionHandle,
              i,
            );
            if (nameOffset === 0) {
          ...
          if (
            outputPreferredLocations.some(
              (l) => l === 'gpu-buffer' || l === 'ml-tensor' || l === 'ml-tensor-cpu-output',
            )
          ) {
      ...
      prepareInputOutputTensor = async (
        ...
        try {
          dims.forEach((d, index2) =>
            wasm2.setValue(dimsOffset + index2 * ptrSize, d, ptrSize === 4 ? 'i32' : 'i64'),
          );
      ...
      run = async (
        ...
        try {
          ...
          if (ioBindingState && !inputOutputBound) {
            const { handle, outputPreferredLocations, outputPreferredLocationsEncoded } =
              ioBindingState;
          ...
          for (let i = 0; i < outputCount; i++) {
            ...
            if (
              tensor === outputTensorHandles[i] ||
              preAllocatedOutputs.includes(outputTensorHandles[i])
            ) {
                ...
                if (false) {
                  message.in.wasm.wasmPaths = {
                    wasm: false
                      ...
                      : false
                        ? new URL('ort-wasm-simd-threaded.jspi.wasm', void 0).href
                        : true
                          ? new URL('ort-wasm-simd-threaded.asyncify.wasm', void 0).href
      ...
      OnnxruntimeWebAssemblySessionHandler = class {
        ...
        async run(feeds, fetches, options) {
          ...
          const outputs = outputArray.map((t, i) =>
            t
              ? encodeTensorMetadata(t, () => `output "${this.outputNames[outputIndices[i]]}"`)
              : null,
          );
