...
declare module lt.Document.SheetEditor {
   ...
   enum SheetEditorHistoryType {
      undo = 0,
      redo = 1
   }

   interface SheetEditorHistoryUserActionEventHandler extends LeadEventHandler {
      (sender: any, e: SheetEditorHistoryUserActionEventArgs): void;
   }

   class SheetEditorHistoryUserActionEventType extends LeadEvent {
      add(value: SheetEditorHistoryUserActionEventHandler): SheetEditorHistoryUserActionEventHandler;
      remove(value: SheetEditorHistoryUserActionEventHandler): void;
   }

   class SheetEditorHistoryUserActionEventArgs extends LeadEventArgs {
      get_historyType(): SheetEditorHistoryType;
      get_sheetIndex(): number;
      get_userAction(): any;
      historyType: SheetEditorHistoryType; // read-only
      sheetIndex: number; // read-only
      userAction: any; // read-only
   }
   ...
   class SheetEditorHistory {
      ...
      undo(): void;
      redo(): void;
      pushCustomUserAction(sheetIndex: number, userAction: any): boolean;
      add_historyUserActionEvent(value: SheetEditorHistoryUserActionEventHandler): void;
      remove_historyUserActionEvent(value: SheetEditorHistoryUserActionEventHandler): void;
      historyUserActionEvent: SheetEditorHistoryUserActionEventType; // read-only
   }
